...
if(is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0) {
	...
	?><div class="<?if($arParams['RSMONOPOLY_USE_OWL']=='Y'):?>owl<?else:?>row<?endif;?> staff<?if($arParams['RSMONOPOLY_SHOW_BUTTON']=='Y'):?> withbuttons<?endif;?>" <?
