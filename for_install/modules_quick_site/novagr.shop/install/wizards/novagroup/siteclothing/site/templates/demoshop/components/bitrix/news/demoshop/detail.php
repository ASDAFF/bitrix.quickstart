...
ob_end_clean();
if($ElementID>0): echo $ob_content; ?>
<p class="back-demo"><a class="lsnn" href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></p>
...
<?
// ставим в хлебных крошках название новости
