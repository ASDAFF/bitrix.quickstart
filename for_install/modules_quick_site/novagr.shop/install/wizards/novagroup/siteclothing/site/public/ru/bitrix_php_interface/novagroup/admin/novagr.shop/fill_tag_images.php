...
$arSelect = array(
    ...
    'PROPERTY_GENDER', 'PROPERTY_EVENT.NAME', 'PROPERTY_SEAZON.NAME',
    'PROPERTY_PRODUCTS'
    //, 'PROPERTY_MODEL'
);
//deb($arFilter);
...
if (intval($rsSubElement->SelectedRowsCount())>0) {
    ...
    if (count($images)) {
        ...
        foreach ($images as $key => $value) {
            ...
            if (!empty($value["PROPERTY_SEAZON_NAME"])) $tagsContent[] = $value["PROPERTY_SEAZON_NAME"];
