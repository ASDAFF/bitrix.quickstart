...
if(COption::GetOptionString("eshop", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "main_slider_".WIZARD_SITE_ID;
		$iblockType = "services";
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/main_banner_big.php", array("MAIN_BANNER_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/main_slider.xml"; 
$iblockCode = "main_slider_".WIZARD_SITE_ID;
$iblockType = "services"; 
