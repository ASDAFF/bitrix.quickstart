...
<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
	<p class="tal">
		...
		<noindex>
			<span class="forgotpassword" style="padding-left:75px;"><a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a></span>
		</noindex>
		<?endif?>
		<br><br><input type="submit" name="Login" class="orange-but" value="<?=GetMessage("AUTH_AUTHORIZE")?>" />
	</p>
</form>
