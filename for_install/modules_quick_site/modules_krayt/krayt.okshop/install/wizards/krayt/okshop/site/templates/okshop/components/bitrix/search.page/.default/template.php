...
<?endif;?>
	&nbsp;<input type="submit" class="btn_green" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?elseif(count($arResult["SEARCH"])>0):?>
    ...
    <div class="search-result-wrapper">
    	...
    	<?foreach($arResult["SEARCH"] as $arItem):?>
    		...
    		<div class="search-result-item-title"><a href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a></div>
    		...
    		<?endif;?>
    		<div class="date"><?=GetMessage("SEARCH_MODIFIED")?> <?=$arItem["DATE_CHANGE"]?></div><?
