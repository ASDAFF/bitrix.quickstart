...
if(is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0) {
	?><div class="owl_banners2 banners2 owl_banners_colors" <?
		...
		foreach($arResult["ITEMS"] as $arItem) {
			...
			if($arItem['PROPERTIES'][$arParams['RSMONOPOLY_BANNER_TYPE']]['VALUE_XML_ID']=='text') {
				$bannerType = 'text';
            } elseif($arItem['PROPERTIES'][$arParams['RSMONOPOLY_BANNER_TYPE']]['VALUE_XML_ID']=='superbanner') {
                $bannerType = 'superbanner';
			} elseif(
			...
			if( $bannerType!='video' ) {
				?><div class="item <?=$bannerType?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>"><?
					?><a href="<?=$arItem['PROPERTIES'][$arParams['RSMONOPOLY_LINK']]['VALUE']?>" <?
						?><?if($arItem['PROPERTIES'][$arParams['RSMONOPOLY_BLANK']]['VALUE']!=''):?> target="_blank"<?endif;?> <?
						...
						if( $bannerType=='product' ) {
							?><div class="container heighter"><?
								?><div class="row"><?
									?><div class="col col-xs-6 hidden-xs"><?
										?><div class="info"><?
											if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE'])) {
												?><div class="name robotolight hidden-xs"><p><span class="aprimary"><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE']?></p></span></div><?
											}
											if($arItem['PREVIEW_TEXT']!='') {
												?><div class="descr robotolight"><p><span><?=$arItem['PREVIEW_TEXT']?></p></span></div><?
											}
											if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PRICE']]['DISPLAY_VALUE'])) {
										...
										?></div><?
									?></div><?
									?><div class="col col-xs-12 col-sm-6 text-center img"><?
								...
								?></div><?
								if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE'])) {
									?><div class="row visible-xs mobiletext robotolight text-center"><?
										?><div class="col col-xs-12"><?
											?><span class="aprimary text-nowrap text-fadeout"><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE']?></span><?
										?></div><?
									?></div><?
								}
							?></div><?
						} elseif($bannerType=='superbanner') {
                            var_dump(123123);
                        } else {
							?><div class="image" style="background-image: url('<?=$arItem['PREVIEW_PICTURE']['SRC']?>');"><?
								?><div class="container heighter"><?
									?><div class="info hidden-xs"><?
										if( $bannerType=='text' ) {
											...
											if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_2']]['DISPLAY_VALUE'])) {
									...
									if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE'])) {
										?><div class="mobilename"><?
											?><p class="robotolight"><span class="aprimary"><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE']?></span></p><?
										?></div><?
									}
								?></div><?
							?></div><?
				...
				?><a href="<?=$arItem['PROPERTIES'][$arParams['RSMONOPOLY_LINK']]['VALUE']?>"<?if($arItem['PROPERTIES'][$arParams['RSMONOPOLY_BLANK']]['VALUE']!=''):?> target="_blank"<?endif;?>><?
					if( $bannerType=='text' ) {
						...
						?><div class="container abs"><?
							?><div class="info"><?
								if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['VALUE'])) {
									?><div class="name robotolight"><p><span><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE']?></span></p></div><br /><?
								}
						...
						?><div class="container"><?
							?><div class="info"><?
								if(isset($arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['VALUE'])) {
									?><div class="name robotolight"><p><span><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_TEXT_1']]['DISPLAY_VALUE']?></p></span></div><?
								}
								if($arItem['PREVIEW_TEXT']!='') {
									?><div class="descr robotolight"><p><span><?=$arItem['PREVIEW_TEXT']?></p></span></div><?
								}
