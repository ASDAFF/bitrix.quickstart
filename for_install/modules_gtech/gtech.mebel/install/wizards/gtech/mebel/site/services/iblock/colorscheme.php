...
$iblockType = "catalog";
$ABS_FILE_NAME = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/colorscheme.xml";
...
$NS = array(
			...
			"URL_DATA_FILE" => $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/colorscheme.xml",
			"ACTION" => "D",
			"PREVIEW" => "N",
		);
