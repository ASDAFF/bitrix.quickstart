...
else
{
	...
	?><div id="sls-<?=$arResult['RANDOM_TAG']?>" class="bx-sls grid-cell <?if(strlen($arResult['MODE_CLASSES'])):?> <?=$arResult['MODE_CLASSES']?><?endif?>"><?
		...
		?><div class="dropdown-block bx-ui-sls-input-block textinput40 back1"><?
