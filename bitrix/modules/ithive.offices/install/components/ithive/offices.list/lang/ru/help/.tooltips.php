<?
$MESS ['ITHIVE_OFFICES_INCLUDE_JQUERY'] = "Если у Вас в шаблоне сайта подключена уже библиотека скриптов jQuery, то отключите эту опцию.";
...
$MESS ['PAGER_TITLE_TIP'] = "В данном поле указывается название категорий, по которым происходит перемещение по списку (например, офисы, магазины и др.)";
