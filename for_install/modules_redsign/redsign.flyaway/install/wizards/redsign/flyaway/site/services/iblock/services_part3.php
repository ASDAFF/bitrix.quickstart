...
if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "flyaway_brands_".WIZARD_SITE_ID;
		$iblockType = "services";
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/brands/index.php', array('IBLOCK_ID_services_brands' => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/services/brands.xml'; 
$iblockCode = "flyaway_brands_".WIZARD_SITE_ID;
$iblockType = "services"; 
