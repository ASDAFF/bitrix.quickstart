          ...
          if ($.fancybox.isOpen) {
			...
			transverse : function(event)
			{
				if (BX.hasClass(document.documentElement, 'bx-no-touch') && appSLine.pageWidth >= appSLine.grid.sm) {
					...
					$.fancybox(this.form.parentNode, $.extend(
...
*/
    ...
    var arNote = BX.findChild(formWrap, { className : 'reviews-note-box'} , true, true), i;
		...
		if ($.fancybox.isOpen) {
			...
			var msgBox = BX.findChild(formWrap, { className : 'reviews-reply-form' } , true);
