...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sertificats.xml"; 
	$iblockCode = "sertificats"; //simvolnii kod infobloka
    $iblockType = "avtoservice"; //simvolnii kod tipainfobloka
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sertifikaty/index.php", array("SERTIFICATE_IBLOCK_ID" => $iblockID));
