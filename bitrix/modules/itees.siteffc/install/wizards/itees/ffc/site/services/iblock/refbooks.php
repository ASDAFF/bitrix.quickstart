...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/refbooks.xml";

$iblockCode = "refbooks_".WIZARD_SITE_ID; 
$iblockType = "info"; 
$iblockID = false; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/info/refbooks/index.php", array("REFBOOKS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/info/refbooks/detail.php", array("REFBOOKS_IBLOCK_ID" => $iblockID));
?>