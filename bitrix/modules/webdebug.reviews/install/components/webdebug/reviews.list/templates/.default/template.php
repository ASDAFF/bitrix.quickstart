		...
		<?foreach ($arResult["ITEMS"] as $arItem):?>
			<div class="webdebug-reviews-item">
				...
				<div class="webdebug-reviews-item-text">
					...
					<?if(in_array("TEXT_PLUS",$arParams["DISPLAY_FIELDS"]) && trim($arItem["TEXT_PLUS"])!=""):?><div class="webdebug-reviews-item-text-plus"><?=$arItem["TEXT_PLUS"]?></div><?endif?>
					<?if(in_array("TEXT_MINUS",$arParams["DISPLAY_FIELDS"]) && trim($arItem["TEXT_MINUS"])!=""):?><div class="webdebug-reviews-item-text-minus"><?=$arItem["TEXT_MINUS"]?></div><?endif?>
					<?if(in_array("TEXT_COMMENTS",$arParams["DISPLAY_FIELDS"]) && trim($arItem["TEXT_COMMENTS"])!=""):?><div class="webdebug-reviews-item-text-comments"><?=$arItem["TEXT_COMMENTS"]?></div><?endif?>
				</div>
