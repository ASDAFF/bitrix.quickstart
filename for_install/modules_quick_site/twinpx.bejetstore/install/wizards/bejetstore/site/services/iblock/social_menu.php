...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/social_menu.xml"; 
$iblockCode = "bejetstore_social_menu_".WIZARD_SITE_ID;
$iblockType = "menu"; 
...
WizardServices::IncludeServiceLang("social_menu.php", $lang);
?>