<?
$MESS ['ASD_CMP_PARAM_TYPES'] = "Типы событий для вывода";
$MESS ['ASD_CMP_PARAM_NOT_SHOW_USER'] = "Не показывать пользователя, совершившего событие";
$MESS ['ASD_CMP_PARAM_COUNT'] = "Количество на странице";
$MESS ['ASD_CMP_PARAM_PAGER_TEMPLATE'] = "Шаблон постраничной навигации";
$MESS ['ASD_CMP_PARAM_USER_LINK'] = "Ссылка на пользователя (маркер #ID#)";
$MESS ['ASD_CMP_PARAM_FILTER_USER'] = "Показывать фильтр по пользователям";
$MESS ['ASD_CMP_PARAM_SITE_ID'] = "Сайт";
