<?
$MESS["PRICEFILE"] = "Прайс";
$MESS["PRICEFILE_FILENAME"] = "Имя файла для скачивания";
$MESS["PRICEFILE_PRICE_ID"] = "ID прайса";
$MESS["PRICEFILE_PRICE_ID_TIP"] = "Если вы хотите разместить на одной странице несколько кнопок, укажите для них разные ID";
$MESS["PRICEFILE_CAPTION"] = "Название прайса";
$MESS["PRICEFILE_CAPTION_DEFAULT"] = "Цены на товары и услуги";
$MESS["PRICEFILE_CAPTION_TIP"] = "Название будет выведено первой строкой в прайсе";
$MESS["PRICEFILE_SHOW_DETAIL_TEXT"] = "Отображать детальное описание";
$MESS["PRICEFILE_SHOW_PREVIEW_TEXT"] = "Отображать краткое описание";
$MESS["SWITCH_OFF_IF_INCORRECT"] = "Если прайс отображается некорректно, отключите эту опцию";
