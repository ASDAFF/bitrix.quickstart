...
$arComponentParameters = array(
	'PARAMETERS' => array(
		...
		"MATERIALS_IBLOCK_CODE"	=> array(
			"PARENT"	=> "BASE",
			"NAME"		=> GetMessage("CATALOG_ELEM_IB_MATERIALS_CODE"),
			"TYPE"		=> "TEXT",
			"VALUES"	=> '',
			"DEFAULT"	=> "",
			"REFRESH"	=> "N",
		...
		"CATALOG_COMMENTS_ENABLE" => array(
				"NAME" => GetMessage("CATALOG_COMMENTS_ENABLE"),
				"TYPE" => "CHECKBOX",
				"DEFAULT" => "N",
				"PARENT" => "BASE",
		),
