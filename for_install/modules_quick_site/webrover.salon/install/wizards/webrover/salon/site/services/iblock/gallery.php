...
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/".LANGUAGE_ID."/gallery.xml"; 
$iblockCode = "GALLERY"; 
$iblockType = "salon_content"; 
...
$arReplace = array('GALLERY_ID' => $iblockID);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/galleries.php", $arReplace);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/detail.php", $arReplace);
