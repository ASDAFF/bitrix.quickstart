...
if (!empty($arResult['ITEMS']))
{
	...
	<div class="bj-hr-heading">
		<div class="bj-hr-heading__content"><span><? echo GetMessage('CVP_TPL_MESS_RCM') ?></span></div>
	</div>
	<hr class="i-size-L">

	<div class="bx_item_list_section">
	<div class="bx_item_list_slide active bx_catalog_top_home" >
	 <div class="row">
	<?
        ...
        <div class="bj-table-row">
          <div class="bj-table-cell">
            <span class="bj-product-card__title__wrapper">
              <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_rcm_view_link1" data-product-id="<?=$arItem['ID']?>" title="<? echo $arItem['NAME']; ?>"><? echo $arItem['NAME']; ?></a>
            </span>
          </div>
        </div>
      </div>
