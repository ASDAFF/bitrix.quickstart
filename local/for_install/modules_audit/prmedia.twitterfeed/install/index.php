...
if(class_exists("prmedia_twitterfeed")) return;

Class prmedia_twitterfeed extends CModule
{
	var $MODULE_ID = "prmedia.twitterfeed";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;
	
	function prmedia_twitterfeed()
	{
	...
	{
		DeleteDirFilesEx('/bitrix/components/prmedia/twitter.feed');
