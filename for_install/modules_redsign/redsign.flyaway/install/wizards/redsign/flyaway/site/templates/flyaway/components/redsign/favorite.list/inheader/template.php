...
<div class="hidden-xs">
    <div class="loss-menu-right loss-menu-right_count pull-right inheadfavorite">
        <a id="inheadfavorite" class="selected" href="<?=SITE_DIR?>personal/favorite/" title="<?=GetMessage('RS.MONOPOLY.TITLE')?>">
                <?$frame = $this->createFrame('inheadfavorite', false)->begin(); ?>
                <i class="fa fa-heart"></i>
                <div id="favorinfo" class="js-favorinfo">
                    <span class="count js-favorinfo_count"><?=$arResult['COUNT']?></span>
                </div>
                <?$frame->beginStub(); ?>
                <i class="fa fa-heart"></i>
                <div id="favorinfo" class="js-favorinfo">
...
<?php $this->SetViewTarget('inheadfavorite_mobile'); ?>
    <a id="inheadfavorite_mobile" class="inmenufavorite" href="<?=SITE_DIR?>personal/favorite/" title="<?=GetMessage('RS.MONOPOLY.TITLE')?>">
    <?php $frame = $this->createFrame('inheadfavorite_mobile', false)->begin(); ?>
        <i class="fa fa-heart"></i>
