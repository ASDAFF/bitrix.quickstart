...
?><br>
<h1 class="mb-30"><?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS")?> (<span id="comments-quantity">0</span>)</h1>
<div id="results-comments">
	<div class="alert alert-danger" id="beforesend-comments">
		<?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_BEFORESEND")?>
	</div>
	<div class="alert alert-danger" id="error-comments">
		<?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_ERROR")?>
	</div>
	<div class="alert alert-success" id="success-comments">
		<?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_SUCCESS")?>
	</div>
</div>
		...
		<form name="COMMENTS" action="<?=SITE_DIR?>include/" method="POST" role="form">
			...
			<div class="col-sm-6">
				<div class="form-group has-feedback">
					<label><?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_NAME_PLACEHOLDER")?></label>
			...
			<div class="col-sm-6">
				<div class="form-group has-feedback">
					<label><?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_EMAIL_PLACEHOLDER")?></label>
			...
			<div class="col-sm-12">
				<div class="form-group has-feedback">
					<label><?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_COMMENT_PLACEHOLDER")?></label>
					<textarea name="COMMENTS[COMMENT]" class="form-control req" rows="8"></textarea>
					<i class="fa fa-envelope-o form-control-feedback"></i>
				</div>
			</div>
			<div class="col-sm-12">
				<input type="submit" value="<?=GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENTS_SEND")?>" class="btn btn-default pull-right">
			</div>
		</form>
	</div>
</div>
