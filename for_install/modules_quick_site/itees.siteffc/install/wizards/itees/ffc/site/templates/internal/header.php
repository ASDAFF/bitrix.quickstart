...
<div id = "wrapper">
<div id = "header">
<div id = "logo"><div class = "vert_align_block" style = "width: 106px; text-align: right;"><span><a href = "<?=SITE_DIR?>"><img src = "<?=SITE_TEMPLATE_PATH?>/images/logo.gif" alt = "" title = "" height = "" width = "" /></a></span></div></div>
