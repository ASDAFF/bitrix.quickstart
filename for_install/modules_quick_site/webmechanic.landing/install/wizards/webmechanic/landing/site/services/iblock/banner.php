...
//$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/".WIZARD_TEMPLATE_ID."/banner.xml"; 
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/ru/".WIZARD_TEMPLATE_ID."/banner.xml"; 

//$iblockCode = "banner_".WIZARD_SITE_ID; 
$iblockCode = "credit_banner"; 
$iblockCodeOriginal = "credit_banner"; 
$iblockType = "actions"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "banner"';
        return;
    }
