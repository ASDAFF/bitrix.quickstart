    ...
    <tr>
        <td width="60%">
            ...
            if ($_REQUEST["filter_history"] == "Y") {
                ?><a class="b-button" href="<?= $arResult["CURRENT_PAGE"] ?>?filter_history=N"><? echo GetMessage("STPOL_CUR_ORDERS") ?></a><?
            } else {
                ?><a class="b-button" href="<?= $arResult["CURRENT_PAGE"] ?>?filter_history=Y&filter_status=F"><? echo GetMessage("STPOL_ORDERS_HISTORY") ?></a><?
            }
            echo "<br /><br />";
            $bNoOrder = true;
            foreach ($arResult["ORDER_BY_STATUS"] as $key => $val) {
                ...
                foreach ($val as $vval) {
                    ...
                    $bShowStatus = false;
                    ?>
                        <div class="b-order-items__item">
                    <table class="sale_personal_order_list ">
                        <tr>
                            <td>
                                <div class="b-order-items__item-title">
