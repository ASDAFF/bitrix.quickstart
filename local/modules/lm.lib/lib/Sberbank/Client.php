...
namespace Lm\Sberbank;

use \Lm\Sberbank\Exception\ActionException;
use \Lm\Sberbank\Exception\BadResponseException;
use \Lm\Sberbank\Exception\NetworkException;
use \Lm\Sberbank\Exception\ResponseParsingException;
use \Lm\Sberbank\HttpClient\CurlClient;
use \Lm\Sberbank\HttpClient\HttpClientInterface;
use \Lm\Sberbank\OrderStatus;
...
class Client
{
    ...
    public function getLastOrdersForMerchants(\DateTime $from, \DateTime $to = null, array $data = array())
    {
        ...
        $data['transactionStates'] = array_map('\Lm\Sberbank\OrderStatus::statusToString', $data['transactionStates']);
