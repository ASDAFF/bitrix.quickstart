<?
$MESS["T_IBLOCK_DESC_LIST_KEYPARS"] = "Ключ шаблона";
$MESS["T_IBLOCK_DESC_IMG_ANONS_ADD"] = "Загружать изображение анонса";
$MESS["T_IBLOCK_DESC_IMG_DETAIL_ADD"] = "Загружать изображение подробного описания";
$MESS["T_IBLOCK_DESC_IMG_DETAIL_CREATE_FROM_ANONS"] = "Создавать изображение подробного описания из изображения анонса";
$MESS["T_IBLOCK_DESC_IMG_ANONS_CREATE_FROM_DETAIL"] = "Создавать изображение анонса из изображения подробного описания";
$MESS["T_IBLOCK_DESC_SOURCE_ADD"] = "Сохранять ссылку на источник в свойство";
$MESS["T_IBLOCK_DESC_DEL_HREF"] = "Удалить все ссылки в тексте Анонса и Подробного описания";
$MESS["T_IBLOCK_DESC_CONVERTTEXT"] = "Конвертировать полученный текст";
$MESS["T_GET_COUNT_NEWS"] = "Количество страниц за 1 запрос";
$MESS["T_IBLOCK_DESC_TXTANONS_FROMTXTDETAIL"] = "Создавать текст Анонса из Детального описания если текст анонса отсутствует";
$MESS["T_IBLOCK_DESC_IMG_ANONS_CREATE_FROM_DETAILTEXT"] = "Создавать картинку Анонса из первой встретившейся в Детальном описании";
