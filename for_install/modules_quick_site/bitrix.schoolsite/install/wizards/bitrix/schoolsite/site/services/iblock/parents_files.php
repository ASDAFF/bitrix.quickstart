...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/parents_files.xml"; 
$iblockCode = "parents_files_".WIZARD_SITE_ID; 
$iblockCodeOriginal = "parents_files"; 
$iblockType = "library"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "parents_files"';
        return;
    }
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/parents/documents/index.php", Array("PARENTS_FILES_IBLOCK_ID" => $iblockID));
?>
