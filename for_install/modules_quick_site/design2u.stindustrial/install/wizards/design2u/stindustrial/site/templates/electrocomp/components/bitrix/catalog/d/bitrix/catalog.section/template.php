...
<!--
	                ...
	                <div class="top">
					 <h2 class="f14 f"><?=GetMessage("MYCOMPANY_REMO_NAZVANIE")?></h2>
					 <h2 class="f14 r"><?=GetMessage("MYCOMPANY_REMO_PROIZVODITELQ")?></h2>
					</div>
...
foreach($arResult["ITEMS"] as $cell=>$arElement):
    ?>
						...
						<div class="df">
                            ...
                            <img src="<?=$arElement["DETAIL_PICTURE"]["SRC"]?>" width="98" height="87px" border="0">
                            </a>
                            </div>
						     <div class="crr">
						 <a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a>
                                      ...
                                      <div class="name">
                                <?=$arElement["PROPERTIES"]["MAKER"]["VALUE"]?>
...
<h2 class="secname"><?=$arResult["NAME"]?></h2>
<div class="top">
    <h2 class="f14 f"><?=GetMessage("MYCOMPANY_REMO_NAZVANIE")?></h2>
    <h2 class="f14 r"><?=GetMessage("MYCOMPANY_REMO_PROIZVODITELQ")?></h2>
</div>
   ...
   <div class="imgbox">
    ...
    <img border="0" src="<?=$arElement["PREVIEW_PICTURE"]["SRC"]?>" width="<?=$arElement[  "PREVIEW_PICTURE"]["WIDTH"]?>" height="<?=$arElement["PREVIEW_PICTURE"]["HEIGHT"]?>" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" />
         ...
         <div class="new-art-info">
             ...
             <p><?=GetMessage("MYCOMPANY_REMO_ANONSOVYY_TEKST_DLA")?></p>
             <div class="news-art-price"><b><?=GetMessage("MYCOMPANY_REMO_CENA")?></b> 1119 <?=GetMessage("MYCOMPANY_REMO_RUB")?></div>
             <a href="#" class="new-art-buy"></a>
             <span><b><?=GetMessage("MYCOMPANY_REMO_OPISANIE")?></b> <?=GetMessage("MYCOMPANY_REMO_OPISANIE_DANNOGO_TOV")?></span>
           </div>
 </div>
 -->
