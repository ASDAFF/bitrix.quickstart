...
<div class="step">
    <span class="current"><a href="<?=SITE_DIR?>personal/"><?=GetMessage("TITLE")?></a>&nbsp;|</span>&nbsp;<?=GetMessage("TITLE_ORDER")?>&nbsp;|&nbsp;<span class="current"><a href="<?=SITE_DIR?>wishlist/"><?=GetMessage("TITLE_WISH")?></a>
</div>
