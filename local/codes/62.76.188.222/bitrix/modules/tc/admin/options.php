...
$RIGHT = $APPLICATION->GetGroupRight("properties");
if($RIGHT == "D")
...
$adminPage->ShowSectionIndex($show, "mfilter");
...
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/mfilter/include.php"); // инициализация модуля
