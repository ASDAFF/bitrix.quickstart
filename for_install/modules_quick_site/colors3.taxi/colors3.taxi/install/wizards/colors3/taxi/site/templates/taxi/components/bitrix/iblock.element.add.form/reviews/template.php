...
?>
<div class="widget form_widget">
    <div class="clearfix cont">
        <h2><?=GetMessage("COLORS3_TAXI_VAS_OTZYV")?></h2>
			...
			<?if ($arParams["MAX_FILE_SIZE"] > 0):?><input type="hidden" name="MAX_FILE_SIZE" value="<?=$arParams["MAX_FILE_SIZE"]?>" /><?endif?>
				...
				<?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
					...
					<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
						<div class="control-group" <?if ($arResult['PROPERTY_LIST_FULL'][$propertyID]['CODE'] == 'RATING') echo 'style="display: none;"';?>>
							<label for="fio" class="control-label">
							...
							<div class="controls">
								...
								<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
									...
									case "N":
										...
										?>
										<input <?if ($arResult['PROPERTY_LIST_FULL'][$propertyID]['CODE'] == 'RATING') echo 'id="rating_value"';?> type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="25" value="<?=$value?>" />
										<?
				...
				<div class="control-group">
                    <label class="control-label">
                        <?=GetMessage("COLORS3_TAXI_OCENITE_NASU_RABOTU")?>
                    </label>
                    <div class="controls">
				...
				<div class="control-group">
		            <div class="controls submit_controls">
		            	<button style="display: none; width: 143px;" class="btn rel call_me" type="button" name="iblock_submit"><?=GetMessage("COLORS3_TAXI_DOBAVITQ_OTZYV")?></button>
						<input class="btn call_me" type="submit" name="iblock_submit" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" />
