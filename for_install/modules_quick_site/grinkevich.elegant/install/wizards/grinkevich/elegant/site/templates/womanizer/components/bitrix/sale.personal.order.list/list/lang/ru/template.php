...
$MESS ['STPOL_F_NAME_CANC'] = 'Отмененные заказы';
$MESS ['STPOL_F_NAME_EX'] = 'Выполненные заказы';
$MESS ['STPOL_F_NAME_ALL'] = 'Все заказы';
$MESS ['STPOL_F_NAME_ACT'] = 'Активные заказы';

$MESS ['STPOL_F_NAME_TNUM'] = 'Номер';
$MESS ['STPOL_F_NAME_TSTA'] = 'Состояние';
$MESS ['STPOL_F_NAME_TDAT'] = 'Дата';

$MESS ['STPOL_F_NAME_POLU'] = 'Получатель';
$MESS ['STPOL_F_NAME_STOI'] = 'Стоимость доставки:';
$MESS ['STPOL_F_NAME_COMM'] = 'Комментарий';
$MESS ['STPOL_F_NAME_ITOG'] = 'Итого с учетом доставки:';
$MESS ['STPOL_F_NAME_DETA'] = 'Детали заказа';
