...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Интернет-магазин ActiveLife";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; ActiveLife. Информация сайта защищена законом об авторских правах.";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"ActiveLife\"";
$MESS["WIZ_SHOP_OF_NAME_DEF_UA"] = "ТОВ \"ActiveLife\"";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"ActiveLife\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
