...
Class asdaff_favorite extends CModule
{
	...
	function asdaff_favorite()
	{
		...
		$this->MODULE_NAME = GetMessage("API.FAVORITE.INSTALL_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("API.FAVORITE.INSTALL_DESCRIPTION");
		$this->PARTNER_NAME = GetMessage("API.FAVORITE.INSTALL_COPMPANY_NAME");
