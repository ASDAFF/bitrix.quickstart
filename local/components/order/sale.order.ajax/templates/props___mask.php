	...
	<div class="row recipient-info">
		<div class="col col-1">
			<fieldset>
				<legend>
					Получатель
					<a class="js-link" href="javascript:void(0)"><span>Это я!</span></a>
				</legend>
				<div class="form-item">
					<label for="">Имя</label>
					#F_NAME#
			...
			<fieldset>
				...
				<div class="row">
					<div class="col col-1">
						<div class="form-item">
							<label for="">&nbsp;</label>
							<input name="" id="" type="text" data-placeholder="Новый адрес">
						</div>
					</div>
					<div class="col col-1">
						<div class="form-item yandex-item">
							<a class="yandex-profile-link" href="javascript:void(0)"></a>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col col-1">
						<div class="form-item index-item">
	...
	if (!empty($arSource))
	{
		foreach($arSource as $arProperties)
		{
			if($arProperties['TYPE'] == 'TEXT') {
				$props = str_replace(
									'#'.$arProperties['CODE'].'#',
									'<input type="text" value="'.$arProperties['VALUE'].'" name="'.$arProperties['FIELD_NAME'].'" id="'.$arProperties["FIELD_NAME"].'" placeholder="'.$arProperties['DESCRIPTION'].'">',
									$props);
			} elseif($arProperties['TYPE'] == 'TEXTAREA') {
				$props = str_replace(
									'#'.$arProperties['CODE'].'#',
									'<textarea name="'.$arProperties['FIELD_NAME'].'" id="'.$arProperties["FIELD_NAME"].'" placeholder="'.$arProperties['DESCRIPTION'].'">'.$arProperties['VALUE'].'</textarea>',
									$props);
			}
			continue;
			?>
