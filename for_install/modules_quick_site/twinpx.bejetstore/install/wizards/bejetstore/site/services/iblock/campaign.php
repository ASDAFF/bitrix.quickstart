...
if(COption::GetOptionString("bejetstore", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "bejetstore_campaign_".WIZARD_SITE_ID;
		$iblockType = "campaign";
...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/campaign.xml"; 
$iblockCode = "bejetstore_campaign_".WIZARD_SITE_ID;
$iblockType = "campaign"; 
...
WizardServices::IncludeServiceLang("campaign.php", $lang);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/campaign/index.php", array("CAMPAIGN_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/campaign/index.php", array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/campaign/detail.php", array("CAMPAIGN_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/news.php", array("CAMPAIGN_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("CAMPAIGN_IBLOCK_ID" => $iblockID));
?>