...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/personal.xml"; 
$iblockCode = "personal_".WIZARD_SITE_ID; 
$iblockType = "service"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_personal.php", array("PERSONAL_IBLOCK_ID" => $iblockID));
?>
