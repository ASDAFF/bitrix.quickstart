...
if(COption::GetOptionString("iarga.shopplus100", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	COption::SetOptionString("iarga.shopplus100", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
	$shopLocation = $wizard->GetVar("shopLocation");
	COption::SetOptionString("iarga.shopplus100", "shopLocation", $shopLocation, false, WIZARD_SITE_ID);
	$shopOfName = $wizard->GetVar("shopOfName");
	COption::SetOptionString("iarga.shopplus100", "shopOfName", $shopOfName, false, WIZARD_SITE_ID);
...
//	if ($shopLocalization == "ru")
	//{
		...
		COption::SetOptionString("iarga.shopplus100", "shopINN", $shopINN, false, WIZARD_SITE_ID);
		$shopKPP = $wizard->GetVar("shopKPP");
		COption::SetOptionString("iarga.shopplus100", "shopKPP", $shopKPP, false, WIZARD_SITE_ID);
		$shopNS = $wizard->GetVar("shopNS");
		COption::SetOptionString("iarga.shopplus100", "shopNS", $shopNS, false, WIZARD_SITE_ID);
		$shopBANK = $wizard->GetVar("shopBANK");
		COption::SetOptionString("iarga.shopplus100", "shopBANK", $shopBANK, false, WIZARD_SITE_ID);
		$shopBANKREKV = $wizard->GetVar("shopBANKREKV");
		COption::SetOptionString("iarga.shopplus100", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID);
		$shopKS = $wizard->GetVar("shopKS");
		COption::SetOptionString("iarga.shopplus100", "shopKS", $shopKS, false, WIZARD_SITE_ID);
		$siteStamp = $wizard->GetVar("siteStamp");
		COption::SetOptionString("iarga.shopplus100", "siteStamp", $siteStamp, false, WIZARD_SITE_ID);
	/*}
	elseif ($shopLocalization == "ua")
	{
		$shopCompany_ua = $wizard->GetVar("shopCompany_ua");
		COption::SetOptionString("iarga.shopplus100", "shopCompany_ua", $shopCompany_ua, false, WIZARD_SITE_ID);
		$shopEGRPU_ua = $wizard->GetVar("shopEGRPU_ua");
		COption::SetOptionString("iarga.shopplus100", "shopCompany_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID);
		$shopINN_ua = $wizard->GetVar("shopINN_ua");
		COption::SetOptionString("iarga.shopplus100", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID);
		$shopNDS_ua = $wizard->GetVar("shopNDS_ua");
		COption::SetOptionString("iarga.shopplus100", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID);
		$shopNS_ua = $wizard->GetVar("shopNS_ua");
		COption::SetOptionString("iarga.shopplus100", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID);
		$shopBank_ua = $wizard->GetVar("shopBank_ua");
		COption::SetOptionString("iarga.shopplus100", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID);
		$shopMFO_ua = $wizard->GetVar("shopMFO_ua");
		COption::SetOptionString("iarga.shopplus100", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID);
		$shopPlace_ua = $wizard->GetVar("shopPlace_ua");
		COption::SetOptionString("iarga.shopplus100", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID);
		$shopFIO_ua = $wizard->GetVar("shopFIO_ua");
		COption::SetOptionString("iarga.shopplus100", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID);
		$shopTax_ua = $wizard->GetVar("shopTax_ua");
		COption::SetOptionString("iarga.shopplus100", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID);
	}    */

	$shopAdr = $wizard->GetVar("shopAdr");
	COption::SetOptionString("iarga.shopplus100", "shopAdr", $shopAdr, false, WIZARD_SITE_ID);
	$siteTelephone = $wizard->GetVar("siteTelephone");
	COption::SetOptionString("iarga.shopplus100", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID);
	$shopEmail = $wizard->GetVar("shopEmail");
	COption::SetOptionString("iarga.shopplus100", "shopEmail", $shopEmail, false, WIZARD_SITE_ID);
	$siteName = $wizard->GetVar("siteName");
	COption::SetOptionString("iarga.shopplus100", "siteName", $siteName, false, WIZARD_SITE_ID);
//SocNets
	$shopFacebook = $wizard->GetVar("shopFacebook");
	COption::SetOptionString("iarga.shopplus100", "shopFacebook", $shopFacebook, false, WIZARD_SITE_ID);
	$shopTwitter = $wizard->GetVar("shopTwitter");
	COption::SetOptionString("iarga.shopplus100", "shopTwitter", $shopTwitter, false, WIZARD_SITE_ID);
	$shopGooglePlus= $wizard->GetVar("shopGooglePlus");
	COption::SetOptionString("iarga.shopplus100", "shopGooglePlus", $shopGooglePlus, false, WIZARD_SITE_ID);
	if (LANGUAGE_ID == "ru")
	{
		$shopVk = $wizard->GetVar("shopVk");	
		COption::SetOptionString("iarga.shopplus100", "shopVk", $shopVk, false, WIZARD_SITE_ID);
	}
