...
function ShowSort(){
	...
	$str .= "<li><a  class='".($sort_order=='asc' ? 'selected' : '')."' href='".$APPLICATION->GetCurPageParam('order=asc', array('order'))."' >".GetMessage("CATALOG_SORT_PRICE_LESS")."</a></li>";
	$str .= "<li><a  class='".($sort_order=='desc' ? 'selected' : '')."'  href='".$APPLICATION->GetCurPageParam('order=desc', array('order'))."'>".GetMessage("CATALOG_SORT_PRICE_MORE")."</a></li>";       
