...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/uslugi.xml"; 
$iblockCode = "bd_services_".WIZARD_SITE_ID; 
$iblockType = "lpdobra"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."include/services_include.php", array("SERVICES_IBLOCK_ID" => $iblockID));
?>
