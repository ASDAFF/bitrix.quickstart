/*!
 * _jQuery formBuilder: https://formbuilder.online/
 * Version: 3.1.3
	...
	! function(e) {
		...
		var s = function() {
			function e(t, r) {
				...
				}(this, e), this.rawConfig = _jQuery.extend({}, t), t = _jQuery.extend({}, t), this.preview = r, delete t.isPreview, this.preview && delete t.required;
				...
				this.classConfig = _jQuery.extend({}, e.controlConfig[s] || {}), this.subtype && (t.type = this.subtype), this.required && (t.required = "required", t["aria-required"] = "true"), this.disabled && (t.disabled = "disabled"), this.config = t, this.configure()
			}
		...
		var y = r.parseAttrs = function(e) {
			...
			S = r.getScripts = function(e, t) {
				var r, o = _jQuery,
					n = [];
				return Array.isArray(e) || (e = [e]), T(e) || (n = _jQuery.map(e, function(e) {
					var r = {
						dataType: "script",
						cache: !0,
						url: (t || "") + e
					};
					return _jQuery.ajax(r).done(function() {
						return window.fbLoaded.js.push(e)
					})
				})), n.push(_jQuery.Deferred(function(e) {
					return o(e.resolve)
				})), (r = _jQuery).when.apply(r, n)
			},
			...
			return function(e, t) {
				...
				for (a = l ? a : a[Symbol.iterator]();;) {
					...
					if (!e[c]) {
						...
						d = f.datatype ? f.datatype : c + "-" + Math.floor(9e3 * Math.random() + 1e3), t.customRegister[d] = _jQuery.extend(f, {
							type: c,
							class: p
						})
					}
		...
		var n = function(e) {
			...
			return function(e, t) {
				...
				var t = _jQuery.extend(this.editorOptions, this.classConfig);
		...
		var a = function(t) {
			...
			return function(e, t) {
				...
				var t = this;
				this.js = this.classConfig.js || "//cdnjs.cloudflare.com/ajax/libs/file-uploader/5.14.2/_jquery.fine-uploader/_jquery.fine-uploader.min.js", this.css = [this.classConfig.css || "//cdnjs.cloudflare.com/ajax/libs/file-uploader/5.14.2/_jquery.fine-uploader/fine-uploader-gallery.min.css", {
					type: "inline",
		...
		var i = function() {
			function e(t, r) {
				...
				}, t && (this.templates = _jQuery.extend(this.templates, t)), this.configure()
			}
			return e.prototype.configure = function() {}, e.prototype.build = function(e, t, r) {
				this.preview && (t.name ? t.name = t.name + "-preview" : t.name = n.default.nameAttr(t) + "-preview"), t.id = t.name, this.data = _jQuery.extend({}, t);
		...
		var s = function() {
			...
			return e.prototype.init = function() {
				...
				a && _jQuery.merge(r, a), t.sortableControls && this.dom.classList.add("sort-enabled"), this.controlList = [], this.allControls = {};
		...
		! function(e) {
			var t = {
				init: function(r, o) {
					var n = _jQuery.extend({}, m.defaultOptions, r, !0),
						i = n.i18n,
						a = v(n, ["i18n"]);
					m.config.opts = a;
					var l = _jQuery.extend({}, m.defaultI18n, i, !0);
					return t.instance = {
						actions: {
							getFieldTypes: null,
							addField: null,
			...
			_jQuery.fn.formBuilder = function() {
				var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				if (t[e]) {
