...
if(!CModule::IncludeModule("iblock"))
	...
	$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/TEMPLATE_GALERY.xml"; 
	$iblockCode = "GALERY_".WIZARD_SITE_ID; 
	$iblockType = "other"; 
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_area_9.php", array("GALERY_IBLOCK_ID" => $iblockID));
