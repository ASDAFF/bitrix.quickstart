...
$iblockType = "innet_catalog_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/index.php", array("INNET_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/.left.menu.php", array("INNET_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/.top_child.menu.php", array("INNET_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array("INNET_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array("INNET_IBLOCK_ID_CATALOG" => $iblockID));
