	...
	case 2://set
		if (this.basketData.useProps && !this.basketData.emptyProps)
		{
			...
			this.obPopupWin.setButtons([
				new BasketButton({
					ownerClass: 'col-sm-3',//this.obProduct.parentNode.parentNode.parentNode.className,
...
window.JCCatalogBigdataProducts.prototype.BasketResult = function(arResult)
{
    ...
    if ( strName.length > 50 ) {
      var h1Title = '<h1 title="' + strName + '">' + strName.substr(0, 50) + '&#8230;</h1>';
    } else {
      h1Title = '<h1>' + strName + '</h1>';
    }
    
    strContent = '<table><tr><td class="popup-window-td-img"><img src="'+strPict+'"></td><td class="popup-window-td-text text-center">' + h1Title + '<p>' + BX.message('TITLE_SUCCESSFUL') + '</p></td></tr></table>';
