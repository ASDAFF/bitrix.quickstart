...
<td valign=top style='width:160.0pt;border:none;border-right:solid windowtext 1.0pt;
...
<p class=Normal align=center style='margin-top:1.0pt;margin-right:0cm;
margin-bottom:0cm;margin-left:0cm;margin-bottom:.0001pt;text-align:center;
line-height:133%'><?//echo SaleFormatCurrency($total_sum, $arOrder["CURRENCY"], true)?><?echo SaleFormatCurrency($arOrder["PRICE"], $arOrder["CURRENCY"], true)?></p>
</td>
</tr>
<?
