...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "bejetstore";
	}
}
...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		{
			$arTemplates = array("bejet_seller");
	...
	function ShowStep()
	{
		...
		$arTemplateOrder = array("bejet_seller");


		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "bejetstore", $wizard->GetVar("siteID"));
		...
		$arTemplateInfo = array(
			...
			"bejetstore" => array(
				...
				"DESCRIPTION" => GetMessage("WIZ_TEMPLATE_VERTICAL_POPUP_DESCRIPTION"),
				"PREVIEW" => $wizard->GetPath()."/site/templates/ru/bejetstore/lang/".LANGUAGE_ID."/preview.png",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/ru/bejetstore/lang/".LANGUAGE_ID."/screen.png",
			),		
			"bejet_seller" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_BEJET_SELLER"),
				"DESCRIPTION" => GetMessage("WIZ_TEMPLATE_BEJET_SELLER_DESCRIPTION"),
				"PREVIEW" => $wizard->GetPath()."/site/templates/ru/bejet_seller/lang/".LANGUAGE_ID."/small.png",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/ru/bejet_seller/lang/".LANGUAGE_ID."/big.png",
			),
		);
	...
	//	$this->content .= "<input type='hidden' value='eshop' name='templateID' id='templateID'>";//$this->ShowInputField('hidden', 'templateID', array("id" => "templateID", "value" => "eshop"));
		...
		foreach ($arTemplateOrder as $templateID)
		{
			...
			$this->content .= '<label for="'.$templateID.'" class="inst-template-list-label">'.$arTemplate["NAME"].'<br><span style="font-size:14px;font-weight:normal">'.$arTemplate["DESCRIPTION"]."</span></label><br>";
			//$this->content .= '<label for="'.$templateID.'" class="inst-template-list">'.$arTemplate["DESCRIPTION"]."</label>";
			$this->content .= "</div>";
		}
...
#solution-preview .solution-inner-item {
	padding: 0 !important;
	background: none;
}

#solution-preview .solution-inner-item img {
	width: 100% !important;
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		if(COption::GetOptionString("bejetstore", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
	...
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"catalogView" => COption::GetOptionString("bejetstore", "catalogView", "list", $siteID),
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("bejetstore", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("bejetstore", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("bejetstore", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("bejetstore", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("bejetstore", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("bejetstore", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("bejetstore", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("bejetstore", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("bejetstore", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("bejetstore", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("bejetstore", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("bejetstore", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("eshop", "shopCompany_ua", "", $siteID),
				/*"shopOfName_ua" => COption::GetOptionString("bejetstore", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("bejetstore", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("bejetstore", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("bejetstore", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("bejetstore", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("bejetstore", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("bejetstore", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("bejetstore", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("bejetstore", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("bejetstore", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("bejetstore", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("bejetstore", "shopTax_ua", "", $siteID),*/

				"installPriceBASE" => COption::GetOptionString("bejetstore", "installPriceBASE", "Y", $siteID),
			)
		);
	}
