				...
				?><div class="webform clearfix"><?
					...
					?><div class="row"><?
						if($arParams["USE_CAPTCHA"]=="Y") {
							?><div class="col col-md-12 field-wrap"><?
								?><div class="row"><?
									?><span class="col col-md-12"><?=GetMessage("MSG_CAPTHA")?>: <span class="required">*</span><br /></span><?
									?><img class="col col-md-6" src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["CATPCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA"><br /><?
									?><div class="col col-md-6"><input class="form-control" type="text" name="captcha_word" size="30" maxlength="50" value=""></div><?
									?><input type="hidden" class="req-input" name="captcha_sid" value="<?=$arResult["CATPCHA_CODE"]?>"><?
								?></div><?
							?></div><?
						}
