...
<td class="b-basket-table__price">
    
   <span class="b-price m-no_margin"><?=$arBasketItems["PRICE_FORMATED"]?></span>
 <?if($arBasketItems["PR"]){?><br><span class="b-price__small"><?=$arBasketItems["PR"]?></span><?}?>
