...
<?$frame->beginStub();?>
    <div class="title3"><?=GetMessage("INNET_FORM_TEMPLATE_HEADER_CALLBACK")?></div>
    ...
    <form action="<?=POST_FORM_ACTION_URI?>" method="POST">
        ...
        <textarea placeholder="<?=GetMessage("INNET_FORM_TEMPLATE_COMMENT")?>" name="comment"><?=$arResult["AUTHOR_MESSAGE"]?></textarea>
