...
<div class="login_page">
    ...
    <? if ($arResult["AUTH_SERVICES"]): ?>
        <div class="b-form__fieldset__caption"><? echo GetMessage("AUTH_TITLE") ?></div>
    <? endif ?>
    <?
    if ($arResult["AUTH_SERVICES"]):
    ...
    ?>
    <form name="form_auth" method="post" target="_top" action="<?= SITE_DIR ?>auth/<? //=$arResult["AUTH_URL"]   ?>" class="b-form b-profile__form">
        ...
        <div class="b-form__field">
            <div class="b-form__field__label"><?= GetMessage("AUTH_LOGIN") ?></div>
        ...
        <div class="b-form__field">
            <div class="b-form__field__label"><?= GetMessage("AUTH_PASSWORD") ?></div>
            <div class="b-form__field__input">
        ...
        <div class="b-form__field">
            <div class="b-form__field__label">&nbsp;</div>
            <div class="b-form__field__input">
        ...
        <div class="b-form__field">
            <div class="b-form__field__label">&nbsp;</div>
            <div class="b-form__field__input">
                <input type="submit" name="Login" class="b-button" value="<?= GetMessage("AUTH_AUTHORIZE") ?>" />
            </div>
        </div>
    </form>
</div>
