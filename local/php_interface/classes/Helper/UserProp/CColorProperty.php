...
class CColorProperty
{
    public static function GetUserTypeDescription()
    {
        return array(
            ...
            'GetPropertyFieldHtml' => array('Helper\\UserProp\\CColorProperty', 'GetPropertyFieldHtml'),
            'GetPropertyFieldHtmlMulty' => array('Helper\\UserProp\\CColorProperty', 'GetPropertyFieldHtmlMulty'),
        );
    }

    public static function GetPropertyFieldHtml($arProperty, $value, $control)
    {
        \Bitrix\Main\Page\Asset::getInstance()->addCss(__DIR__ . '/js/lastworld.props/LWColor.css');
        \Bitrix\Main\Page\Asset::getInstance()->addJs(__DIR__ . '/css/lastworld.props/LWColor.js');
