...
<table class="profile-table data-table">	
	...
	<tr>
		<td><span class="starrequired">*</span><?=GetMessage('EMAIL')?></td>
		<td><input type="text" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" /></td>
	</tr>
	<tr>
		<td><span class="starrequired">*</span><?=GetMessage('LOGIN')?></td>
		<td><input type="text" name="LOGIN" maxlength="50" value="<? echo $arResult["arUser"]["LOGIN"]?>" /></td>
	</tr>
    <!--<tr>
		<td><span class="starrequired">*</span><?=GetMessage('USER_PHONE')?></td>
		<td><input type="text" name="PERSONAL_PHONE" maxlength="50" value="<? echo $arResult["arUser"]["PERSONAL_PHONE"]?>" /></td>
	</tr>-->
    </tbody>
</table>
<div class="separator"></div>
...
<table class="data-table profile-table">
  ...
  <?endif;?>  
	...
	<p><input style="float: right;margin-left: 20px;" class="btn_all btn_green" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;
    <!--<input style="float: right;" class="btn_all" type="reset" value="<?=GetMessage('MAIN_RESET');?>">--></p>
</form>
</div>
