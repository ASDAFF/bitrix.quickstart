...
<table id="asd_social_likes<?= $arParams['ASD_ID']>0 ? $arParams['ASD_ID'] : ''?>">
	<tr>
		...
		<td>
			...
			<a rel="nofollow" href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-via="<?= $arParams['TW_DATA_VIA']?>" data-lang="<?= LANGUAGE_ID?>">Tweet</a>
		</td>
		<?endif;?>
		<?if (in_array("VK_LIKE", $arParams["ASD_INCLUDE_SCRIPTS"])):?>
		<td>
