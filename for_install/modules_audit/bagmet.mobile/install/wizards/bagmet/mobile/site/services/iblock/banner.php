...
if(COption::GetOptionString("shoes", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
	return;
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' =>
//'edit1--#--'.GetMessage("WZD_OPTION_NEWS_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_NEWS_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_NEWS_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_NEWS_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_NEWS_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_NEWS_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_NEWS_10").'--;--'
'edit1--#--'.GetMessage('WZD_OPTION_BANNER_1').'--,--NAME--#--'.GetMessage('WZD_OPTION_BANNER_2').'--,--DETAIL_PICTURE--#--'.GetMessage('WZD_OPTION_BANNER_3').'--,--PROPERTY_'.$arProperty['BANNER_LINK'].'--#--'.GetMessage('WZD_OPTION_BANNER_9').'--,--ACTIVE--#--'.GetMessage('WZD_OPTION_BANNER_4').'--,--ACTIVE_FROM--#--'.GetMessage('WZD_OPTION_BANNER_5').'--,--ACTIVE_TO--#--'.GetMessage('WZD_OPTION_BANNER_6').'--,--SORT--#--'.GetMessage('WZD_OPTION_BANNER_7').'--;--'
, ));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_banner.php", array("BANNER_IBLOCK_ID" => $iblockID));
