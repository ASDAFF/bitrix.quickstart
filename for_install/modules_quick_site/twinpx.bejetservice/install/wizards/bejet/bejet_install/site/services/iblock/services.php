...
$arFields = Array(
	...
	'IN_RSS'=>'N',
	'SORT'=>100,
	"LANG" => array ("ru" => array ( "NAME" => GetMessage("SERVICE_IBLOCK_SERVICES")))
);
...
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/index.php", array("SERVICES_IBLOCK_ID" => $iblockID));
