...
class Lm_Lib extends \CModule
{
    ...
    public function __construct()
    {
        ...
        $this->MODULE_ID = 'lm.lib';
        $this->MODULE_NAME = Loc::getMessage('LM_LIB_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('LM_LIB_MODULE_DESCRIPTION');
        $this->MODULE_GROUP_RIGHTS = 'N';
        $this->PARTNER_NAME = Loc::getMessage('LM_LIB_MODULE_PARTNER_NAME');
