...
<div class="news_preview">
	<div class="news_block_title">
		<h3><a href="<?=SITE_DIR?>news/"><?=GetMessage("NEWS_TITLE")?></a></h3>
	</div>
	<?foreach($arResult["ITEMS"] as $arItem):?>
		<div class="news_preview_item">
			...
			<div class="news_preview_item_date_line">
...
<script>
	...
	$('.news_preview_item').height( getMaxHeightNews($('.news_preview_item')) );
</script>