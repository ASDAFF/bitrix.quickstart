...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "redsign.flyaway";
	}
}
...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		if ($wizard->IsNextButtonClick())
		{
			...
			if (in_array($templateID,  array("flyaway")))
				$wizard->SetVar("templateID", "flyaway");
		}
	}
	...
	function ShowStep()
	{
		...
		if (in_array("flyaway", array_keys($arTemplates)))
		{
			$arTemplateOrder[] = "flyaway";
		}

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "flyaway", $wizard->GetVar("siteID"));
		if (!in_array($defaultTemplateID, array("flyaway"))) $defaultTemplateID = "flyaway";
		...
		$arTemplateInfo = array(
			"flyaway" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/flyaway//preview.gif",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/flyaway/screen.gif",
			),
		);

	//	$this->content .= "<input type='hidden' value='flyaway' name='templateID' id='templateID'>";//$this->ShowInputField('hidden', 'templateID', array("id" => "templateID", "value" => "flyaway"));
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$isWizardInstalled = COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", $siteID) == "Y";

		if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		$wizard->SetDefaultVars(Array(
			"siteLogo" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/flyaway/site/templates/flyaway/images/logo.png"),
			"siteLogoRetina" => file_exists(WIZARD_SITE_PATH."include/logo_retina.png") ? WIZARD_SITE_DIR."include/logo_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/flyaway/site/templates/flyaway/images/logo.png"),
			//"siteLogoMobile" => file_exists(WIZARD_SITE_PATH."include/logo_mobile.png") ? WIZARD_SITE_DIR."include/logo_mobile.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/flyaway/site/templates/flyaway/themes/".$themeID."/images/logo_mobile.png"),
			//"siteLogoMobileRetina" => file_exists(WIZARD_SITE_PATH."include/logo_mobile_retina.png") ? WIZARD_SITE_DIR."include/logo_mobile_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/flyaway/site/templates/flyaway/themes/".$themeID."/images/logo_mobile_retina.png")
		));
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("redsign.flyaway", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"siteMetaDescription" => GetMessage("wiz_site_desc"),
				"siteMetaKeywords" => GetMessage("wiz_keywords"),
				//"installEshopApp" => COption::GetOptionString("redsign.flyaway", "installEshopApp", "Y", $siteID),
			)
		);
...
class CatalogSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"catalogSubscribe" => (isset($arSubscribe[$siteID])) ? ($arSubscribe[$siteID]['use'] == "Y" ? "Y" : false) : "Y",//COption::GetOptionString("redsign.flyaway", "catalogSubscribe", "Y", $siteID),
				"catalogView" => COption::GetOptionString("redsign.flyaway", "catalogView", "list", $siteID),
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("redsign.flyaway", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("redsign.flyaway", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("redsign.flyaway", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("redsign.flyaway", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("redsign.flyaway", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("redsign.flyaway", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("redsign.flyaway", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("redsign.flyaway", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("redsign.flyaway", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("redsign.flyaway", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("redsign.flyaway", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("redsign.flyaway", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("redsign.flyaway", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("redsign.flyaway", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("redsign.flyaway", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("redsign.flyaway", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("redsign.flyaway", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("redsign.flyaway", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("redsign.flyaway", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("redsign.flyaway", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("redsign.flyaway", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("redsign.flyaway", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("redsign.flyaway", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("redsign.flyaway", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("redsign.flyaway", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("redsign.flyaway", "installPriceBASE", "Y", $siteID),
			)
		);
	}
	...
	function InitStep()
	{
		...
		if ($shopLocalization == "ua")
			...
			$wizard->SetDefaultVars(
				Array(
					"personType" => Array(
						"fiz" =>  COption::GetOptionString("redsign.flyaway", "personTypeFiz", "Y", $siteID),
						"ur" => COption::GetOptionString("redsign.flyaway", "personTypeUr", "Y", $siteID),
					)
				)
			);
	}
...
===*/
	...
	function ShowStep()
	{
		...
		if (
			...
			LANGUAGE_ID == "ru" &&
			(
				COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", $siteID) != "Y"
			...
			<div class="wizard-input-form-block">
				...
				<div>
					<div class="wizard-input-form-field wizard-input-form-field-checkbox">';
						...
						if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", $siteID) != "Y")
						{
...
class FinishStep extends CFinishWizardStep
{
	...
	//	$this->content .= "<br clear=\"all\"><a href=\"/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&site_id=".$siteID."&wizardName=redsign:flyaway.mobile&".bitrix_sessid_get()."\" class=\"button-next\"><span id=\"next-button-caption\">".GetMessage("wizard_store_mobile")."</span></a><br>";
