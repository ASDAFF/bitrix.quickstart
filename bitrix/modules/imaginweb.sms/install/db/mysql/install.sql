CREATE TABLE iwebsms_list_rubric
(
	ID		int(11)		NOT NULL auto_increment,
	LID		CHAR(2)		NOT NULL REFERENCES iwebsms_lang (LID),
...
CREATE TABLE iwebsms_subscription
(
	ID		int(11)		NOT NULL auto_increment,
	DATE_INSERT	DATETIME	NOT NULL,
	DATE_UPDATE	DATETIME	NULL,
	USER_ID		int(11)		NULL REFERENCES iwebsms_user (ID),
	ACTIVE		CHAR(1)		DEFAULT 'Y' NOT NULL,
	...
	PRIMARY KEY (ID),
	UNIQUE UK_SUBSCRIPTION_PHONE (PHONE),
	index IX_DATE_CONFIRM(CONFIRMED, DATE_CONFIRM)
);
CREATE TABLE iwebsms_subscription_rubric
(
	SUBSCRIPTION_ID	int(11) NOT NULL REFERENCES iwebsms_subscription (ID),
	LIST_RUBRIC_ID	int(11) NOT NULL REFERENCES iwebsms_list_rubric (ID),
	UNIQUE UK_SUBSCRIPTION_RUBRIC (SUBSCRIPTION_ID,LIST_RUBRIC_ID)
);
CREATE TABLE iwebsms_posting
(
	ID		INT(11)		NOT NULL auto_increment,
	...
	ERROR_PHONE	mediumtext	NULL,
	AUTO_SEND_TIME	DATETIME	NULL,
	BCC_TO_SEND	mediumtext	NULL,
	PRIMARY KEY (ID)
);
CREATE TABLE iwebsms_posting_sms
(
	ID INT(11) NOT NULL auto_increment,
	...
	USER_ID INT(11),
	PRIMARY KEY (ID),
	INDEX ix_posting_sms_status (POSTING_ID, STATUS),
	INDEX ix_posting_sms_phone (POSTING_ID, PHONE)
);
CREATE TABLE iwebsms_posting_rubric
(
	POSTING_ID	INT(11) NOT NULL REFERENCES iwebsms_posting (ID),
	LIST_RUBRIC_ID	INT(11) NOT NULL REFERENCES iwebsms_list_rubric (ID),
	UNIQUE UK_POSTING_POSTING_RUBRIC (POSTING_ID,LIST_RUBRIC_ID)
);
CREATE TABLE iwebsms_posting_group
(
	POSTING_ID	INT(11) NOT NULL REFERENCES iwebsms_posting (ID),
	GROUP_ID	INT(11) NOT NULL REFERENCES b_group (ID),
	UNIQUE UK_POSTING_POSTING_GROUP (POSTING_ID,GROUP_ID)
);
CREATE TABLE iwebsms_posting_file
(
	POSTING_ID	INT(11) NOT NULL REFERENCES iwebsms_posting (ID),
