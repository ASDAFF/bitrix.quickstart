	...
	foreach($arResult["ITEMS"]["DelDelCanBuy"] as $arBasketItems)
	{
		...
		<tr>
			...
			<td class="cart-item-actions">
				<a class="grey-but" style="position:static;" id="moveBasketProd" href="#" data-id="<?=$arBasketItems["ID"]?>" data-action="add"><?=GetMessage("SALE_ADD_CART")?></a>
			</td>
			<td class="cart-item-actions">

				<a href="/personal/cart/?action=delete&id=<?=$arBasketItems["ID"]?>" id="delBasketProd" data-id="<?=$arBasketItems["PRODUCT_ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/del_basket.gif" alt="" /></a>&nbsp;
			</td>
		</tr>
		<?
	}
