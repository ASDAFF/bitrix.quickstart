...
$iblockCode = "forgotten".WIZARD_SITE_ID; 
$iblockType = "services"; 	
...
if(COption::GetOptionString("taxi", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/prices/forgotten-things/index.php", array("FORGOTTEN_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/forgotten.xml"; 
...
if($iblockID == false)
{
	...
	$arFields = Array(
		...
		'PREVIEW_PICTURE' => array ( 'IS_REQUIRED' => 'N', 'DEFAULT_VALUE' => array ( 'FROM_DETAIL' => 'Y', 'DELETE_WITH_DETAIL' =>'Y', 'UPDATE_WITH_DETAIL'=>'Y', 'SCALE' => 'Y', 'WIDTH' => '261', 'HEIGHT' => '195', 'IGNORE_ERRORS' => 'N',  'METHOD' => 'resample', 'COMPRESSION' => '100'),), 
		...
		'CODE' => array ( 'IS_REQUIRED' => 'N', 'DEFAULT_VALUE' => array ( 'UNIQUE' => 'Y', 'TRANSLITERATION' => 'Y', 'TRANS_LEN' => 100, 'TRANS_CASE' => 'L', 'TRANS_SPACE' => '-', 'TRANS_OTHER' => '-', 'TRANS_EAT' => 'Y', 'USE_GOOGLE' => 'N', ), ), 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_FORGOTTEN_12")
		.'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_FORGOTTEN_1")
		.'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_FORGOTTEN_2")
		.'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_FORGOTTEN_3")
		.'--,--NAME--#--'.GetMessage("WZD_OPTION_FORGOTTEN_4")
		.'--,--CODE--#--'.GetMessage("WZD_OPTION_FORGOTTEN_10")	
		.'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_FORGOTTEN_5")
		.'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_FORGOTTEN_6")		
		.'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_FORGOTTEN_7")
		.'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_FORGOTTEN_8")
		.'--,--SORT--#--'.GetMessage("WZD_OPTION_FORGOTTEN_9")		
		.'--,--TAGS--#--'.GetMessage("WZD_OPTION_FORGOTTEN_11")
		.'--;--', ));
CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockType.".".$iblockID), array ( 'columns' => 'ACTIVE,SORT', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20', ));
