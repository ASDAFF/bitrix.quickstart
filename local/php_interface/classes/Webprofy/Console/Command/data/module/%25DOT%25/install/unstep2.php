...
if ($errors === false)
{
	echo CAdminMessage::ShowNote(GetMessage("%UNDER_CAPS%_UNINSTALL_COMPLETE"));
	...
	UnRegisterModuleDependences("main", "OnBuildGlobalMenu", $MODULE_ID, "%CLASS%", "OnBuildGlobalMenuHandler");
}else{
	for ($i = 0; $i < count($errors); $i++)
		$alErrors .= $errors[$i]."<br>";
	echo CAdminMessage::ShowMessage(Array("TYPE" => "ERROR", "MESSAGE" => GetMessage("%UNDER_CAPS%_UNINSTALL_ERROR"), "DETAILS" => $alErrors, "HTML" => true));
}
?>
