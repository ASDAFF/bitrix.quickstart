<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die(); IncludeTemplateLangFile(__FILE__); $VERSION_MODULE = NovaGroupGetVersionModule(); ?>
<?$createFrame = $this->createFrame("left", false)->begin(); ?>
...
<script>
	$(document).ready(function(){
		...
		objFilter.init(
			...
			'<?=htmlspecialchars($_GET['SEARCH_WHERE'])?>'
		);
	});
</script>
<script>
