...
Class asdaff_sortpanel extends CModule{
	var	$MODULE_ID = 'asdaff.sortpanel';
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage('ASDAFF_SORTPANEL_MODULE_NAME');
		$this->MODULE_DESCRIPTION = Loc::getMessage('ASDAFF_SORTPANEL_MODULE_DESC');

		$this->PARTNER_NAME = Loc::getMessage('ASDAFF_SORTPANEL_PARTNER_NAME');
		$this->PARTNER_URI = Loc::getMessage('ASDAFF_SORTPANEL_PARTNER_URI');
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage('ASDAFF_SORTPANEL_INSTALL_ERROR_VERSION'));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage('ASDAFF_SORTPANEL_INSTALL'), $this->GetPath().'/install/step.php');
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("ASDAFF_SORTPANEL_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}