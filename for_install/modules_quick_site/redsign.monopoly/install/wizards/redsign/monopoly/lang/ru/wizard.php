...
// $MESS["wiz_install_eshopapp"] = "Установить мобильное приложение для корпоративного сайта";
...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Готовый корпоративный сайт Монополия";
...
// $MESS["WIZ_SHOP_FACEBOOK"] = "Страница корпоративного сайта в facebook.com";
// $MESS["WIZ_SHOP_FACEBOOK_DEF"] = "http://www.facebook.com/1CBitrix";
// $MESS["WIZ_SHOP_TWITTER"] = "Страница корпоративного сайта в twitter.com";
// $MESS["WIZ_SHOP_TWITTER_DEF"] = "http://twitter.com/1C_Bitrix";
// $MESS["WIZ_SHOP_VK"] = "Страница корпоративного сайта в vk.com";
// $MESS["WIZ_SHOP_VK_DEF"] = "http://vk.com/bitrix_1c";
// $MESS["WIZ_SHOP_GOOGLE_PLUS"] = "Страница корпоративного сайта в plus.google.com";
// $MESS["WIZ_SHOP_GOOGLE_PLUS_DEF"] = "https://plus.google.com/111119180387208976312/";
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; Монополия. Информация сайта защищена законом об авторских правах.";
// $MESS["WIZ_REWRITE_INDEX_DESC"] = "Изменение главной страницы";
// $MESS["wiz_site_name"] = "Интернет-магазин";
$MESS["WIZ_SHOP_LOCALIZATION"] = "Выбор локализации корпоративного сайта";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"Монополия\"";
$MESS["WIZ_SHOP_OF_NAME_DEF_UA"] = "ТОВ \"Монополия\"";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"Монополия\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["WIZ_PAY_SYSTEM"] = "Выберите способы оплаты, которые будут возможны на вашем сайте. В дальнейшем в настройках корпоративного сайта вы сможете активировать другие платежные системы (Яндекс.Деньги, Ассист, Деньги@mail.ru, ChronoPay и т.п.). Для работы этих платежных систем потребуется заключение с ними договоров.";
...
$MESS["WIZ_DELIVERY"] = "Выберите способы доставки, которые возможны для вашего корпоративного сайта. В настройках корпоративного сайта вы можете активировать  или добавить дополнительные службы доставки (EMS, UPS и т.п.).";
...
$MESS["WIZ_DELIVERY_HINT"] = "В дальнейшем вы можете легко изменить и настроить платежные системы и службы доставки в настройках корпоративного сайта в административной части.";
...
$MESS["wiz_keywords"] = "готовый корпоративный сайт, корпоративный сайт на Битрикс";
