...
<script type="text/javascript">
	...
	var EAFormParams = {
		...
		SelectMultipleWrap : [
			...
			'<div class="'+TemplateName+'_EAFormInputSelectMultiple_center"></div>'
		],
		...
		SelectMultipleListItemBefore : '<div><div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_01"></div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_02"></div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_03"></div></div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_left"><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_right"><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_center"><span>',
		SelectMultipleListItemAfter : '</span></div></div></div><div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_04"></div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_05"></div><div class="'+TemplateName+'_EAFormInputSelectMultipleItem_06"></div></div></div>',	
		...
		SelectPopupWrap : [
			...
			'<div class="'+TemplateName+'_EAFormInputSelectPopup_center"></div>'
		],
		...
		SelectPopupListItemBefore : '<div><div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_01"></div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_02"></div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_03"></div></div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_left"><div class="'+TemplateName+'_EAFormInputSelectPopupItem_right"><div class="'+TemplateName+'_EAFormInputSelectPopupItem_center"><span>',
		SelectPopupListItemAfter : '</span></div></div></div><div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_04"></div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_05"></div><div class="'+TemplateName+'_EAFormInputSelectPopupItem_06"></div></div></div>',
