...
<div class="cart-items" id="id-na-list" style="display:none;">
	...
	foreach($arResult["ITEMS"]["nAnCanBuy"] as $arBasketItems)
	{
		...
		<tr>
			...
			<?endif;?>
				<td><a href="/personal/cart/?action=delete&id=<?=$arBasketItems["ID"]?>" id="delBasketProd" data-id="<?=$arBasketItems["PRODUCT_ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/del_ico.png" alt="" /></a>&nbsp;</td>
