...
if (isset($_REQUEST['SITE_ID'])
	...
	define('SITE_ID', substr(preg_replace("/[^a-z0-9_]/i", '', $_REQUEST['SITE_ID']), 0, 2));
}

if (isset($_REQUEST['ADMIN_SECTION'])
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'COUNTRY' => intval($_REQUEST[$_REQUEST['COUNTRY_INPUT_NAME'] . $_REQUEST['CITY_INPUT_NAME']]),
		'REGION_INPUT_NAME' => $_REQUEST['REGION_INPUT_NAME'],
		'REGION' => intval($_REQUEST[$_REQUEST['REGION_INPUT_NAME'] . $_REQUEST['CITY_INPUT_NAME']]),
