...
?><input <?
	...
	?>class="textinput40 back1" type="text" <?
	?>autocomplete="off" <?
	?>onfocus="loc_sug_CheckThis(this, this.id);" <?
	?>data-req="<?echo $arParams['REQUIED_FORMATED'] == 'Y' ? 'true' : 'false';?>" <?
	?>placeholder="<?echo $arParams['PROPERTY_NAME']?>" <?
	if($arResult['SINGLE_CITY'] == 'Y'){?> disabled<?}?>/><?
