...
<div class="tovar">
	...
	</div><!-- end tovar_left_block -->
	<div class="tovar_right_block">
	<?if (is_array($GLOBALS["arRecPrFilter"]) && !empty($GLOBALS["arRecPrFilter"])):?>
		<?$APPLICATION->IncludeComponent("bagmet:mobile.top", "sidebar", array(
				"IBLOCK_TYPE" => "",
				"IBLOCK_ID" => $arParams["IBLOCK_ID"],
				...
				"ELEMENT_COUNT" => 5,
				"TITLE" => GetMessage("RECOMMENDED")
			),
			false
		);?>
	<?endif?>

	<?if (is_array($GLOBALS["arSamePrFilter"]) && !empty($GLOBALS["arSamePrFilter"])):?>
		<?$APPLICATION->IncludeComponent("bagmet:mobile.top", "sidebar", array(
				"IBLOCK_TYPE" => "",
				"IBLOCK_ID" => $arParams["IBLOCK_ID"],
				"ELEMENT_SORT_FIELD" => "sort",
				...
				"SHOW_PRICE_COUNT" => $arParams["SHOW_PRICE_COUNT"],
				"PRICE_VAT_INCLUDE" => $arParams["PRICE_VAT_INCLUDE"],
				"FILTER_NAME" => "arSamePrFilter",
				"DISPLAY_IMG_WIDTH"	 =>	130,
				"DISPLAY_IMG_HEIGHT" =>	150,
				"SHARPEN" => $arParams["SHARPEN"],
				"ELEMENT_COUNT" => 5,
				"TITLE" => GetMessage("SAME")
			),
			false
		);?>
		<?endif?>
