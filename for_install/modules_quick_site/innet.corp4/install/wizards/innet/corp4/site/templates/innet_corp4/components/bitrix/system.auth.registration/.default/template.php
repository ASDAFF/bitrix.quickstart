...
<div class="bx-auth">
    ...
    <noindex>
        <form class="form" method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform">
            ...
            <p class="starrequired"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>
            <p class="starrequired"><span>*</span><?=GetMessage("AUTH_REQ")?></p>
            <p><a class="color_tmp" href="<?=$arResult["AUTH_AUTH_URL"]?>" rel="nofollow"><b><?=GetMessage("AUTH_AUTH")?></b></a></p>
        </form>
    </noindex>
    <script type="text/javascript">
