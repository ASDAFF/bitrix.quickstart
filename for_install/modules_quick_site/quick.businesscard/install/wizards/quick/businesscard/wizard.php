...
{$WIZARD_SITE_DIR="/";$WIZARD_SITE_ROOT_PATH=$_SERVER["DOCUMENT_ROOT"];$SERVER_NAME=$_SERVER["SERVER_NAME"];}}
define("WIZARD_SITE_DIR",$WIZARD_SITE_DIR);define("WIZARD_SITE_ROOT_PATH",$WIZARD_SITE_ROOT_PATH);define("SERVER_NAME",$SERVER_NAME);define("WIZARD_SITE_PATH",str_replace("//","/",WIZARD_SITE_ROOT_PATH."/".WIZARD_SITE_DIR."/"));$wizard->SetDefaultVars(Array("siteName"=>COption::GetOptionString("businesscard","siteName",GetMessage("WIZ_COMPANY_NAME_DEF"),$siteID),"EMAIL"=>COption::GetOptionString("businesscard","EMAIL",GetMessage("WIZ_COMPANY_EMAIL_DEF"),$siteID),"PHONE"=>COption::GetOptionString("businesscard","PHONE",GetMessage("WIZ_COMPANY_TELEPHONE_DEF"),$siteID),"SKYPE"=>COption::GetOptionString("businesscard","SKYPE",GetMessage("WIZ_COMPANY_SKYPE_DEF"),$siteID),"ADDRESS"=>COption::GetOptionString("businesscard","ADDRESS",GetMessage("WIZ_COMPANY_ADDRESS_DEF"),$siteID),"LATITUDE"=>COption::GetOptionString("businesscard","LATITUDE",GetMessage("WIZ_MAP_GOOGLE_LATITUDE_DEF"),$siteID),"LONGITUDE"=>COption::GetOptionString("businesscard","LONGITUDE",GetMessage("WIZ_MAP_GOOGLE_LONGITUDE_DEF"),$siteID),"LATITUDE_CENTER"=>COption::GetOptionString("businesscard","LATITUDE_CENTER",GetMessage("WIZ_MAP_GOOGLE_LATITUDE_CENTER_DEF"),$siteID),"LONGITUDE_CENTER"=>COption::GetOptionString("businesscard","LONGITUDE_CENTER",GetMessage("WIZ_MAP_GOOGLE_LONGITUDE_CENTER_DEF"),$siteID),"KEYWORDS"=>COption::GetOptionString("businesscard","KEYWORDS",GetMessage("WIZ_KEYWORDS"),$siteID),"DESCRIPTION"=>COption::GetOptionString("businesscard","DESCRIPTION",GetMessage("WIZ_DESCRIPTION"),$siteID),));}
function ShowStep()
...
{function InitStep()
{$this->SetStepID("catalog_settings");$this->SetTitle(GetMessage("WIZ_STEP_CT"));$this->SetPrevStep("site_settings");$this->SetNextStep("data_install");$this->SetNextCaption(GetMessage("NEXT_BUTTON"));$this->SetPrevCaption(GetMessage("PREVIOUS_BUTTON"));$wizard=&$this->GetWizard();$siteID=$wizard->GetVar("siteID");$wizard->SetDefaultVars(Array("iblockSliderID"=>COption::GetOptionInt("businesscard","iblockSliderID",0,$siteID),"iblockExtraID"=>COption::GetOptionInt("businesscard","iblockExtraID",0,$siteID),"iblockReviewsID"=>COption::GetOptionInt("businesscard","iblockReviewsID",0,$siteID),"iblockLogoID"=>COption::GetOptionInt("businesscard","iblockLogoID",0,$siteID),"iblockNewsID"=>COption::GetOptionInt("businesscard","iblockNewsID",0,$siteID),"iblockServicesMainID"=>COption::GetOptionInt("businesscard","iblockServicesMainID",0,$siteID),"iblockCatalogID"=>COption::GetOptionInt("businesscard","iblockCatalogID",0,$siteID),"iblockCatalogCommentsID"=>COption::GetOptionInt("businesscard","iblockCatalogCommentsID",0,$siteID),"iblockOrdersID"=>COption::GetOptionInt("businesscard","iblockOrdersID",0,$siteID),"iblockDocumentsID"=>COption::GetOptionInt("businesscard","iblockDocumentsID",0,$siteID),"iblockVacanciesID"=>COption::GetOptionInt("businesscard","iblockVacanciesID",0,$siteID),"iblockPartnersID"=>COption::GetOptionInt("businesscard","iblockPartnersID",0,$siteID),"iblockFaqID"=>COption::GetOptionInt("businesscard","iblockFaqID",0,$siteID),"iblockLicensesID"=>COption::GetOptionInt("businesscard","iblockLicensesID",0,$siteID),"iblockStaffID"=>COption::GetOptionInt("businesscard","iblockStaffID",0,$siteID),"iblockHistoryID"=>COption::GetOptionInt("businesscard","iblockHistoryID",0,$siteID),"iblockArticlesID"=>COption::GetOptionInt("businesscard","iblockArticlesID",0,$siteID),"iblockArticlesCommentsID"=>COption::GetOptionInt("businesscard","iblockArticlesCommentsID",0,$siteID),"iblockWorksID"=>COption::GetOptionInt("businesscard","iblockWorksID",0,$siteID),"iblockServicesID"=>COption::GetOptionInt("businesscard","iblockServicesID",0,$siteID),"iblockActionsID"=>COption::GetOptionInt("businesscard","iblockActionsID",0,$siteID),"iblockPhotoMainID"=>COption::GetOptionInt("businesscard","iblockPhotoMainID",0,$siteID),"iblockPhotoID"=>COption::GetOptionInt("businesscard","iblockPhotoID",0,$siteID),"iblockBannerCatalogID"=>COption::GetOptionInt("businesscard","iblockBannerCatalogID",0,$siteID),"iblockBannerServicesID"=>COption::GetOptionInt("businesscard","iblockBannerServicesID",0,$siteID),"iblockBannerWorksID"=>COption::GetOptionInt("businesscard","iblockBannerWorksID",0,$siteID),"installDemoData"=>COption::GetOptionString("businesscard","installDemoData","Y",$siteID),));}
function ShowStep()
