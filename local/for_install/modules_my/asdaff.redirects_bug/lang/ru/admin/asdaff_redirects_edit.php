...
$MESS ['ERROR_INVALID_URL_DESC'] = 'URL не прошел проверку на соответствие спецификации <a href="http://www.faqs.org/rfcs/rfc2396.html" target="_blank">RFC2396</a>.<br/>Вы можете отключить проверку в <a href="/bitrix/admin/settings.php?mid=asdaff.redirects" target="_blank">настройках модуля</a>. Это может пригодится, к примеру, если вы используете кириллические URL';
