...
if($countElements > 0) 
{
	...
	?><div class="catalog-section-filter">
		<div class="option">
			...
			<a class="ico ico-1 <?if($section_view == 1) echo 'active';?>" href="<?=$APPLICATION->GetCurPageParam("view=1", array("view"))?>" ></a>
			<a class="ico ico-2 <?if($section_view == 2) echo 'active';?>" href="<?=$APPLICATION->GetCurPageParam("view=2", array("view"))?>" ></a>
		</div>
		<div class="option">
