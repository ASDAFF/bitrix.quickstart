...
<table class="data-table profile-table">
	...
	<p style="margin: 10px 0;overflow: hidden;">
        <input style="margin: 0 20px 0 0; float: left;" class="btn_profile" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">
        <input style="margin: 0; float: left;" class="btn_profile" type="reset" value="<?=GetMessage('MAIN_RESET');?>">
    </p>
