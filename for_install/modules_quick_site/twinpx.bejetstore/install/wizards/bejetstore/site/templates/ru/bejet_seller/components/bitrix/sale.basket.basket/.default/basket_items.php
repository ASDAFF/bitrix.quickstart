									...
									else
									{
										...
										if($mxResult)
										{
											...
											if($ar_res = $res->GetNext())
											{
												...
												{
													$file = CFile::ResizeImageGet($ar_res["PREVIEW_PICTURE"], array('width'=>200, 'height'=>200), BX_RESIZE_IMAGE_PROPORTIONAL, true);
													$url=$file['src'];
												}
												elseif($ar_res['DETAIL_PICTURE'])
												{
													$file = CFile::ResizeImageGet($ar_res["DETAIL_PICTURE"], array('width'=>200, 'height'=>200), BX_RESIZE_IMAGE_PROPORTIONAL, true);
													$url=$file['src'];
												}
												else
												{
							...
							?>
								<td class="custom">
									...
									<div class="centered"><?
												...
												?><a href="javascript:void(0);" class="bj-quantity-minus minus" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'down', <?=$useFloatQuantityJS?>);"></a><input
														type="text"
														class="bj-quantity-input"
														size="3"
														...
														><a href="javascript:void(0);" class="bj-quantity-plus plus" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', <?=$useFloatQuantityJS?>);"></a>
...
?>
<div class="bj-panel"><b><?=GetMessage("SALE_NO_ITEMS");?></b></div>
<?/*?><div id="basket_items_list">
	<table>
		<tbody>
			<tr>
