...
// ƒоработки sergeland@mail.ru

1. ƒобавлен плавный ход выпадающего списка
2. ѕри выпадении списка добавл€етс€ класс .openList к .selectedTxt , который убераетс€ при схлопывании, позвол€ет корректировать .selectedTxt, например background-image 
3. ≈сли указан класс у <option> он будет добавлен к тегу <a> списка
4. ≈сли у <option> есть атрибут disable, элемент списка не будет показан
*/
...
(function($){
	...
	$.fn.sSelect = function(options) {
		...
		var defaults = {
			defaultText:  thistext,   // текст по умолчанию
			animationSpeed:    300,   // скорость анимации выпадени€ списка
			ddMaxHeight: 	    '',   // max-height списка
			newListSelected:    '',   // добавл€ет класс к div.newListSelected
			selectedTxt:'openList'    // добавл€ет класс к div.selectedTxt
		};
