...
$IS_SIMPLE = array(
	'IS_SIMPLE_OFFERS' => GetMessage('IS_SIMPLE_OFFERS'),
	'IS_SIMPLE_NO_OFFERS' => GetMessage('IS_SIMPLE_NO_OFFERS')
);
$arTemplateParameters['IS_SIMPLE'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage("IS_SIMPLE"),
	'TYPE' => 'LIST',
	'VALUES' => $IS_SIMPLE,
	'DEFAULT' => 'IS_SIMPLE_OFFERS',
	'ADDITIONAL_VALUES' => 'N'
);

$SORTS = array(
	'cheap' => GetMessage('SORT_CHEAP'),
	'popular' => GetMessage('SORT_POPULAR'),
	'new' => GetMessage('SORT_NEW'),
);
$arTemplateParameters['SORTS'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage("SORTS"),
	'TYPE' => 'LIST',
	'VALUES' => $SORTS,
	'DEFAULT' => array(
			0 => "cheap",
...
$arTemplateParameters['DEFAULT_SORT'] = array(
	'PARENT' => 'VISUAL',
