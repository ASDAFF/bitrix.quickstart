...
if(COption::GetOptionString("decima", "wizard_installed", "N", WIZARD_SITE_ID) == "N" || WIZARD_INSTALL_DEMO_DATA)
{
...
//___writeToAreasFile(WIZARD_SITE_PATH."include/footer_contaacts.php", $wizard->GetVar("siteTelephone"));
