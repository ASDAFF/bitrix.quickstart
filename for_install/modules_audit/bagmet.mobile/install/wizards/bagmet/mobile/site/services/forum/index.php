...
$arForums = Array(
	...
	Array(
		"XML_ID" => "BAGMET_MOBILE_REVIEWS",
		"NAME" => GetMessage("MOBILE_REVIEWS_FORUM_NAME"),
		"DESCRIPTION" => GetMessage("MOBILE_REVIEWS_FORUM_DESCRIPTION"),
		"SORT" => 2,
		"ACTIVE" => "Y",
		"ALLOW_HTML" => "N",
		"ALLOW_ANCHOR" => "Y",
...
$reviewsForumID = 0;
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "XML_ID" => "BAGMET_MOBILE_REVIEWS"));
