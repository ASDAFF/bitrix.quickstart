...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/payment_menu.xml"; 
$iblockCode = "bejetstore_payment_menu_".WIZARD_SITE_ID;
$iblockType = "menu"; 
...
WizardServices::IncludeServiceLang("payment_menu.php", $lang);
?>