...
$arTemplateParameters = array(
    ...
    "INNET_ELEMENT_USE_SORT" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("INNET_ELEMENT_USE_SORT"),
        "TYPE" => "CHECKBOX",
    ),
    "INNET_PREVIEW_TEXT_DETAIL" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("INNET_PREVIEW_TEXT_DETAIL"),
        "TYPE" => "CHECKBOX",
    ),
    "INNET_PREVIEW_TEXT_SECTION" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("INNET_PREVIEW_TEXT_SECTION"),
        "TYPE" => "CHECKBOX",
    ),
    "INNET_PREVIEW_TEXT_SECTION_COUNT" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("INNET_PREVIEW_TEXT_SECTION_COUNT"),
        "TYPE" => "STRING",
    ),
    ...
    "INNET_MESS_BTN_DELAY" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("INNET_MESS_BTN_DELAY"),
        "TYPE" => "STRING",
    ),
    "INNET_DELAY_PATH" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("INNET_DELAY_PATH"),
        "TYPE" => "STRING",
    ),
);
?>