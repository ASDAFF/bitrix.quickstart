	...
	<div class="bx_item_set_hor">
		...
		<div class="bx_item_set_hor_item result">
			<span class="bx_item_set_result_block">
				<span class="bx_item_set_current_price"><?=str_replace(GetMessage("STUDIOFACT_RUB"), '<span class="rub red">'.GetMessage("STUDIOFACT_R").'</span>', $arResult["SET_ITEMS"]["PRICE"]);?></span>
			...
			<a href="javascript:void(0)" onclick="catalogSetDefaultObj_<? echo $intElementID; ?>.Add2Basket();" class="bx_bt_white bx_medium button"><?=GetMessage("CATALOG_SET_BUY")?></a>
		</div>
