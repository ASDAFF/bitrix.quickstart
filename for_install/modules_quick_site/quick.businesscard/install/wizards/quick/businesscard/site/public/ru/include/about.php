<div class="section <?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["ABOUT_BG"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["ABOUT_BG"] : COption::GetOptionString("businesscard", "QUICK_THEME_ABOUT_BG", "white-bg", SITE_ID))?> clearfix">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "#SITE_DIR#include/".(!empty($_SESSION["QUICK_THEME"][SITE_ID]["ABOUT_VER"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["ABOUT_VER"] : COption::GetOptionString("businesscard", "QUICK_THEME_ABOUT_VER", "about-news", SITE_ID)).".php"
							),
							false,
