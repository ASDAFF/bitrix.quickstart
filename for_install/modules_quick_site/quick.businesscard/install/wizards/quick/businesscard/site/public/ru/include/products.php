<div class="section <?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["PRODUCTS_BG"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["PRODUCTS_BG"] : COption::GetOptionString("businesscard", "QUICK_THEME_PRODUCTS_BG", "white-bg", SITE_ID))?> clearfix">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
