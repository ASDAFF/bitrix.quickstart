...
<!--	<div class="bx-auth-note">--><?//=GetMessage("AUTH_PLEASE_AUTH")?><!--</div>-->
	...
	<form class="form" name="form_auth" style="0 0 20px;" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
			...
			<tr>
				...
				<td class="authorize-submit-cell">
					...
					<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
						<noindex>
							<p style="margin: 5px 3px;"><a class="color_tmp" href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a></p>
						</noindex>
					<?endif?>
					<?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
						<noindex>
							<p style="margin: 5px 3px;"><?=GetMessage("AUTH_FIRST_ONE")?> <a class="color_tmp" href="<?=$arResult["AUTH_REGISTER_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_REGISTER")?></a></p>
						</noindex>
					<?endif?>
				</td>
			</tr>
