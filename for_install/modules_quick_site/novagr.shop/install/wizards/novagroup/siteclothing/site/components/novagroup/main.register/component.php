<?
/**
 * Компонент trendlist.ru:main.register
 *
 * Компонент создан на основе bitrix:main.register
 * в нем в обязательных полях для регистрации заменено поле LOGIN на поле NAME
 *
 * @todo - разобраться с шифрованием полей с паролем при отправке формы, пока закомментировано
 */
...
/*
 * пока отключаю шифрование на клиенте, т.к. при сабмите формы - ставятся в дизайблед поля с паролем
 * 
 * 
 * 
 * */
