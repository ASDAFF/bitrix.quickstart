...
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/".LANGUAGE_ID."/services.xml"; 
...
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/header.php", array('S_GALLERY_ID' => $iblockID));
