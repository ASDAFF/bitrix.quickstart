...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "news/index.php", array('INNET_IBLOCK_ID_NEWS' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('INNET_IBLOCK_ID_NEWS' => $iblockID));
