<?
/**
 * компонент сделан на основе одноименного битрикс компонента - с целью сохранить код таким как он есть
 * сейчас, т. к. был прецедент когда у клиента код битрикс компонента отличался, из за этого съехало меню
 * 
 */
...
foreach($arResult["IBLOCK_LIST"] as $arIBlock)
{
    ...
    $aMenuLinksExt = $APPLICATION->IncludeComponent("novagroup:menu.sections", "", array(
        "IS_SEF" => "Y",
        "SEF_BASE_URL" => "",
