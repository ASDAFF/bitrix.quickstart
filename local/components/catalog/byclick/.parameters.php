...
$arFilter = Array("TYPE_ID" => "BISTROKLICK", "ACTIVE" => "Y");
if($site !== false)
	$arFilter["LID"] = $site;
...
$arComponentParameters = array(
	"GROUPS" => array(
			"FORM" => array(
            "NAME" => GetMessage("CAT_BK_GROUP_FORM"),
            "SORT" => "305",
            ),
			"ORDER" => array(
            "NAME" => GetMessage("CAT_BK_GROUP_ORDER"),
            "SORT" => "310",
            ),
			"NOTICE" => array(
            "NAME" => GetMessage("CAT_BK_GROUP_NOTICE"),
            "SORT" => "315",
            ),
			"SETT" => array(
            "NAME" => GetMessage("CAT_BK_GROUP_SETT"),
            "SORT" => "320",
            ),
	),
	...
	"PARAMETERS" => array(
		"IBLOCK_TYPE" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("CAT_BK_IBLOCK_TYPE"),
			"TYPE" => "LIST",
			"VALUES" => $arIBlockType,
			"REFRESH" => "Y",
		),
		"IBLOCK_ID" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("CAT_BK_IBLOCK_IBLOCK"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "Y",
			"VALUES" => $arIBlock,
			"REFRESH" => "Y",
		...
		"FIELD_SHOW" => array(
			'NAME' => GetMessage("CAT_BK_FIELD_SHOW"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"PARENT" => "FORM",
			"VALUES" => array_merge(array(
					"name" => GetMessage("CAT_BK_FIELD_REQ_NAME"),
					"phone" => GetMessage("CAT_BK_FIELD_REQ_PHONE"),
					"email" => GetMessage("CAT_BK_FIELD_REQ_EMAIL"),
					"mess" => GetMessage("CAT_BK_FIELD_REQ_MESS")
				),$arTypePersonField2),
			"SIZE" => 8
		),
		"FIELD_REQ" => array(
			'NAME' => GetMessage("CAT_BK_FIELD_REQ"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"PARENT" => "FORM",
			"VALUES" => array_merge(array(
		...
		"FIELD_DELIVERY" => array(
			'NAME' => GetMessage("CAT_BK_FIELD_FIELD_DELIVERY"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"PARENT" => "FORM",
			"VALUES" => $arDelivery,
		...
		"FIELD_PAYSYSTEM" => array(
			'NAME' => GetMessage("CAT_BK_FIELD_FIELD_PAYSYSTEM"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"PARENT" => "FORM",
			"VALUES" => $arPaysystem,
		...
		"CREATE_ORDER" => array(
			'NAME' => GetMessage("CAT_BK_CREATE_ORDER"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"REFRESH" => "Y",
			"PARENT" => "ORDER",
	...
	if (CModule::IncludeModule('currency'))
	{
		...
		$arComponentParameters['PARAMETERS']['CURRENCY_ID'] = array(
			'PARENT' => 'BASE',
			'NAME' => GetMessage('CAT_BK_CURRENCY_ID'),
			'TYPE' => 'LIST',
		...
		$arComponentParameters['PARAMETERS']['CURRENCY_SECOND'] = array(
			'PARENT' => 'BASE',
			'NAME' => GetMessage('CAT_BK_CURRENCY_ID2'),
			'TYPE' => 'LIST',
			'VALUES' => $arCurrencyList,
			'DEFAULT' => CCurrency::GetBaseCurrency(),
			"ADDITIONAL_VALUES" => "Y",
	...
	$arComponentParameters['PARAMETERS']["PRICE_CODE"] = array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("CAT_BK_PRICE_CODE"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"VALUES" => $arPrice,
		);
	...
	if($arCurrentValues['CREATE_ORDER']=='Y') {
		...
		$arComponentParameters['PARAMETERS']["PERSON_TYPE"] = array(
			"PARENT" => "ORDER",
			"NAME" => GetMessage("CAT_BK_PERSON_TYPE"),
			"TYPE" => "LIST",
			"VALUES" => $arTypePerson,
			"REFRESH" => "Y",
		);
		$arComponentParameters['PARAMETERS']["CHECK_USER"] = array(
			'NAME' => GetMessage("CAT_BK_CHECK_USER"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
			"REFRESH" => "N",
			"PARENT" => "ORDER",
		...
		$arComponentParameters['PARAMETERS']["CREATE_USER"] = array(
			'NAME' => GetMessage("CAT_BK_CREATE_USER"),
			"TYPE" => "LIST",
			"PARENT" => "ORDER",
			"VALUES" => array(
					"SET" => GetMessage("CAT_BK_CREATE_USER_SET"),
					"CUR" => GetMessage("CAT_BK_CREATE_USER_CUR")
			),
			"REFRESH" => "Y",
		);
		...
		if($arCurrentValues['CREATE_USER']=='SET') {
			$arComponentParameters['PARAMETERS']['CUR_USER'] = array(
				'NAME' => GetMessage("CAT_BK_CUR_USER"),
				'TYPE' => 'TEXT',
				'DEFAULT' => 1,
				"PARENT" => "ORDER",
				"REFRESH" => "N",
			...
			$arComponentParameters['PARAMETERS']['USER_PREFIX'] = array(
				'NAME' => GetMessage("CAT_BK_USER_PREFIX"),
				'TYPE' => 'TEXT',
				'DEFAULT' => 'user_',
				"PARENT" => "ORDER",
				"REFRESH" => "N",
			...
			'NAME' => GetMessage("CAT_BK_FIELD_USER_GROUP"),
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"PARENT" => "ORDER",
		...
		$arComponentParameters['PARAMETERS']["PERSON_FIELD_NAME"] = array(
			'NAME' => GetMessage("CAT_BK_PERSON_FIELD_NAME"),
			"TYPE" => "LIST",
			"PARENT" => "ORDER",
		...
		$arComponentParameters['PARAMETERS']["PERSON_FIELD_EMAIL"] = array(
			'NAME' => GetMessage("CAT_BK_PERSON_FIELD_EMAIL"),
			"TYPE" => "LIST",
			"PARENT" => "ORDER",
			"VALUES" => $arTypePersonField,
			"REFRESH" => "N",
		...
		$arComponentParameters['PARAMETERS']["PERSON_FIELD_PHONE"] = array(
			'NAME' => GetMessage("CAT_BK_PERSON_FIELD_PHONE"),
			"TYPE" => "LIST",
			"PARENT" => "ORDER",
			"VALUES" => $arTypePersonField,
			"REFRESH" => "N",
	...
	if($arCurrentValues['NOTICE_ADMIN']=='Y') {
		$arComponentParameters['PARAMETERS']["NOTICE_ADMIN_MAIL"] = array(
			'NAME' => GetMessage("CAT_BK_NOTICE_ADMIN_MAIL"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"REFRESH" => "Y",
			"PARENT" => "NOTICE",
		...
		if($arCurrentValues["NOTICE_ADMIN_MAIL"]=='Y'){
			$arComponentParameters['PARAMETERS']["NOTICE_ADMIN_MAIL_EMAIL"] = array(
				'NAME' => GetMessage("CAT_BK_NOTICE_ADMIN_MAIL_EMAIL"),
				"TYPE" => "TEXT",
				"DEFAULT" => "",
				"REFRESH" => "N",
				"PARENT" => "NOTICE",
			...
			$arComponentParameters['PARAMETERS']["NOTICE_ADMIN_MAIL_EVENT_MESSAGE_ID"] = Array(
				"NAME" => GetMessage("CAT_BK_NOTICE_EVENT_MESSAGE_ID"),
				"TYPE"=>"LIST",
				"VALUES" => $arEvent,
				"DEFAULT"=>"",
				"MULTIPLE"=>"N",
		...
		$arComponentParameters['PARAMETERS']["NOTICE_USER_MAIL"] = array(
			'NAME' => GetMessage("CAT_BK_NOTICE_USER_MAIL"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"REFRESH" => "Y",
			"PARENT" => "NOTICE",
		...
		if($arCurrentValues["NOTICE_USER_MAIL"]=='Y'){
			...
			$arComponentParameters['PARAMETERS']["NOTICE_USER_MAIL_EVENT_MESSAGE_ID2"] = Array(
					"NAME" => GetMessage("CAT_BK_NOTICE_EVENT_MESSAGE_ID2"),
					"TYPE"=>"LIST",
					"VALUES" => $arEvent,
					"DEFAULT"=>"",
					"MULTIPLE"=>"N",
		...
		if(count($arSms)>0){
			$arComponentParameters['PARAMETERS']["NOTICE_ADMIN_SMS"] = array(
				'NAME' => GetMessage("CAT_BK_NOTICE_ADMIN_SMS"),
				"TYPE" => "CHECKBOX",
				"DEFAULT" => "N",
				"REFRESH" => "Y",
				"PARENT" => "NOTICE",
			...
			if($arCurrentValues["NOTICE_ADMIN_SMS"]=='Y'){
				...
				'NAME' => GetMessage("CAT_BK_NOTICE_ADMIN_SMS_PHONE"),
				"TYPE" => "TEXT",
				"DEFAULT" => "",
				"REFRESH" => "N",
				"PARENT" => "NOTICE",
			...
			$arComponentParameters['PARAMETERS']["NOTICE_USER_SMS"] = array(
				'NAME' => GetMessage("CAT_BK_NOTICE_USER_SMS"),
				"TYPE" => "CHECKBOX",
				"DEFAULT" => "N",
				"REFRESH" => "Y",
				"PARENT" => "NOTICE",
			...
			if($arCurrentValues["NOTICE_USER_SMS"]=='Y' || $arCurrentValues["NOTICE_ADMIN_SMS"]=='Y'){
				$arComponentParameters['PARAMETERS']["NOTICE_SMS_MODULE"] = array(
					'NAME' => GetMessage("CAT_BK_NOTICE_SMS_MODULE"),
					"TYPE" => "LIST",
					"PARENT" => "NOTICE",
					"VALUES" => $arSms,
					"REFRESH" => "N",
	...
	$arComponentParameters['PARAMETERS']["MESS_OK"] = array(
				'NAME' => GetMessage("CAT_BK_MESS_OK"),
				"TYPE" => "TEXT",
				"DEFAULT" =>  GetMessage("CAT_BK_MESS_OK_DEFAULT"),
				"REFRESH" => "N",
				"PARENT" => "SETT",
			);
	$arComponentParameters['PARAMETERS']["SHOW_CAPTCHA"] = array(
				'NAME' => GetMessage("CAT_BK_SHOW_CAPTCHA"),
				"TYPE" => "LIST",
				"VALUES" =>  array(
						GetMessage("CAT_BK_SHOW_CAPTCHA_LIST1"),
						GetMessage("CAT_BK_SHOW_CAPTCHA_LIST2"),
						GetMessage("CAT_BK_SHOW_CAPTCHA_LIST3")
					),
				"REFRESH" => "N",
				"MULTIPLE"=>"N",
				"PARENT" => "SETT",
	...
	$arComponentParameters['PARAMETERS']["OFFERS_PROPERTY_CODE"] = array(
				'NAME' => GetMessage("CAT_BK_OFFERS_PROPERTY_CODE"),
				"TYPE" => "LIST",
