...
$arParams['FORM_TITLE'] = strlen($arParams['FORM_TITLE'])>0 ? $arParams['FORM_TITLE'] : GetMessage("FORM_TITLE");
$arParams['BUTTON_TITLE'] = strlen($arParams['BUTTON_TITLE'])>0 ? $arParams['BUTTON_TITLE'] : GetMessage("BUTTON_TITLE");
		...
		<tbody>
			<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
				<tr>
					...
					<td>					
						<label for="<?=$propertyID?>"><?if (intval($propertyID) > 0):?><?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["NAME"]?><?else:?><?=!empty($arParams["CUSTOM_TITLE_".$propertyID]) ? $arParams["CUSTOM_TITLE_".$propertyID] : GetMessage("IBLOCK_FIELD_".$propertyID)?><?endif?><?if(in_array($propertyID, $arResult["PROPERTY_REQUIRED"])):?><span class="starrequired">*</span><?endif?></label>
					</td>
					<td>
					<?else:?>
					...
					<?endif?>
						...
						switch ($INPUT_TYPE):
							...
							case "T":
								...
								?>
						<textarea id="<?=$propertyID?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
								<?
								}
							break;
							...
							case "N":
								...
								?>
								<input type="text" id="<?=$propertyID?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="25" value="<?=$value?>" /><br /><?
		...
		<tfoot>
			<tr>
				<td colspan="2" style="text-align:right;">
					<input class="woo-sc-button orange send_form" type="submit" name="iblock_submit" value="<?=$arParams["BUTTON_TITLE"]?>" />
