...
;(function ($, BX, document, window, undefined) {
    ...
    function CatalogElement(id, url) {
        this.id = id;
        this.isReady = false;
        this.item = null;
    ...
    CatalogElement.prototype.getPrices = function() {
        ...
        for(code in offer.PRICES) {
            prices.push({
                ...
                hasDiscount: !!offer.PRICES[code].DISCOUNT_DIFF
            });
        }
    ...
    window.CatalogElement = function(id, url) {
       ...
       if(!elementsCache[id]) {
          elementsCache[id] = new CatalogElement(id, url); 
       }
