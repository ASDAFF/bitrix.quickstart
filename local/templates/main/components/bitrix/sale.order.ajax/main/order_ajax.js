/*
 * Copyright (c) 27/7/2019 Created By/Edited By ASDAFF asdaff.asad@yandex.ru
 */
    ...
    BX.Sale.OrderAjaxComponent = {
        ...
        getBlockFooter: function (node) {
            ...
            if (!isLastNode) {
                buttons.push(
                    BX.create('button', {
                        props: {href: 'javascript:void(0)', className: 'btn-next btn btn-green pl-3 pr-3'},
            ...
            if (this.result.AUTH.new_user_registration === 'Y') {
                nodes.push(BX.create('DIV', {
                    ...
                    children: [
                        ...
                        BX.create('A', {
                            props: {className: 'btn btn-green btn-lg'},
            ...
            storeNode = BX.create('DIV', {
                ...
                children: [
                    ...
                    BX.create('DIV', {
                        ...
                        children: [
                            BX.create('A', {
                                props: {href: '', className: 'btn btn-sm btn-green'},
                    ...
                    if (property.isMultiple()) {
                        propContainer.appendChild(
                            BX.create('DIV', {
                                ...
                                props: {className: 'btn btn-sm btn-green'},
        ...
        alterProperty: function (settings, propContainer) {
            ...
            for (i = 0; i < add.length; i++) {
                BX.addClass(add[i], 'btn btn-green btn-sm');
            ...
            if (add.length) {
                ...
                BX.bind(add, 'click', BX.delegate(function (e) {
                    ...
                    if (add.length && add[add.length - 2]) {
                        ...
                        BX.addClass(add[add.length - 2], 'btn btn-green btn-sm');
                    }
                    ...
                    BX.create('DIV', {
                        ...
                        children: [
                            BX.create('A', {
                                props: {
                                    href: 'javascript:void(0)',
                                    className: 'btn btn-green btn-lg btn-order-save'
                                },
