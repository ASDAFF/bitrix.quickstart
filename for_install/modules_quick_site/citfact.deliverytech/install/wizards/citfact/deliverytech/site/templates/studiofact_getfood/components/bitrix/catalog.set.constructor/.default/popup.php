...
$arMessage = htmlspecialcharsbx($_REQUEST["arParams"]["MESS"]);
$curTemplatePath = htmlspecialcharsbx($_REQUEST["arParams"]["CURRENT_TEMPLATE_PATH"]);

$arSetElementsDefault = $_REQUEST["arParams"]["SET_ITEMS"]["DEFAULT"];
$arSetElementsOther = $_REQUEST["arParams"]["SET_ITEMS"]["OTHER"];

$setPrice = htmlspecialcharsbx($_REQUEST["arParams"]["SET_ITEMS"]["PRICE"]);
