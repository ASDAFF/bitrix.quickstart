...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"RSMONOPOLY_PROP_MARKER_TEXT_LIST" => "MARKER_TEXT",
		"RSMONOPOLY_PROP_MARKER_COLOR_LIST" => "MARKER_COLOR",
		"RSMONOPOLY_PROP_ACTION_DATE_LIST" => "ACTION_DATE",
		"DISPLAY_NAME" => "Y",
		"META_KEYWORDS" => "-",
		"META_DESCRIPTION" => "-",
		"BROWSER_TITLE" => "-",
		...
		"RSMONOPOLY_LIST_TEMPLATES_DETAIL" => "action",
		...
		"RSMONOPOLY_PROP_MARKER_TEXT_DETAIL" => "MARKER_TEXT",
		"RSMONOPOLY_PROP_MARKER_COLOR_DETAIL" => "MARKER_COLOR",
		"RSMONOPOLY_PROP_ACTION_DATE_DETAIL" => "ACTION_DATE",
