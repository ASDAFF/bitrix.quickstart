...
Class CStepUseRedhelper 
{
    ...
    function addScriptTag() {
        ...
        if(defined('ADMIN_SECTION') && ADMIN_SECTION===true) return false;
        
        $MODULE_ID = basename(dirname(__FILE__));
        $clientID = COption::GetOptionString($MODULE_ID, "CLIENT_ID");
        if(!$clientID) return false;
		
        $APPLICATION->AddHeadString('<script id="rhlpscrtg" type="text/javascript" charset="utf-8" async="async" src="https://web.redhelper.ru/service/main.js?c='.$clientID.'"></script>', true);
