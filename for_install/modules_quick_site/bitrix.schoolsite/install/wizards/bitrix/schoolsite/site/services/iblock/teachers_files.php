...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/teachers_files.xml"; 
$iblockCode = "teachers_files_".WIZARD_SITE_ID; 
$iblockCodeOriginal = "teachers_files"; 
$iblockType = "library"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "teachers_files"';
        return;
    }
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/teachers/teaching_materials/index.php", Array("TEACHERS_FILES_IBLOCK_ID" => $iblockID));
?>
