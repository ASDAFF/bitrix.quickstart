    ...
    <form id="subscrForm1" class="form-horizontal demo-sub" action="<?= POST_FORM_ACTION_URI ?>" method="post">
        ...
        <p><span><? echo GetMessage("CT_BSE_FORMAT_LABEL") ?></span>
            <label class="radio" for="MAIL_TYPE_TEXT">
                <?= GetMessage("CT_BSE_FORMAT_TEXT") ?>
                <input type="radio" name="FORMAT" id="MAIL_TYPE_TEXT"
                                                               value="text" <? if ($arResult["SUBSCRIPTION"]["FORMAT"] != "html") echo "checked" ?> />

            </label>
            <label class="radio" for="MAIL_TYPE_HTML">
                <?= GetMessage("CT_BSE_FORMAT_HTML") ?>
                ...
                foreach ($arResult["RUBRICS"] as $itemID => $itemValue):?>
                    <section>
                        <label class="checkbox">
                            ...
                            <span class="tlt"><? echo $itemValue["NAME"] ?></span>
                        </label>
        ...
        <form id="subscrForm2" class="form-inline" action="<?= POST_FORM_ACTION_URI ?>" method="post">
            ...
            <div class="control-group">
                ...
                <label class="control-label">
                    <input name="sf_EMAIL" type="text" value="<? echo GetMessage("CT_BSE_EMAIL") ?>"
                           placeholder="<? echo GetMessage("CT_EMAIL_PLACEHOLDER") ?>">
                </label>
