...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "company/questions/index.php", array('INNET_IBLOCK_ID_QUESTIONS_ANSWER' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/bitrix/php_interface/init.php", array('INNET_IBLOCK_ID_QUESTIONS_ANSWER' => $iblockID));
