...
else
{
	...
	while( $arItem = mysql_fetch_assoc($result) )
	{
		...
		$arItem["PROPERTY_VALUES"]["LENGTH"] = $res["PROPERTY_LENGTH"];
		$arItem["PROPERTY_VALUES"]["HEIGHT"] = $res["PROPERTY_HEIGHT"];
		$arItem["PROPERTY_VALUES"]["WIDTH"] = $res["PROPERTY_WIDTH"];
		$arItem["PROPERTY_VALUES"]["ARTICUL"] = $res["PROPERTY_ARTICUL"];
