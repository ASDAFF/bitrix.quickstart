...
<?php if (!empty($arResult['ITEMS'])): ?>
	<section>
        ...
        */
		...
		$arDeleteParams = array('CONFIRM' => getMessage('RS_ONAIR.BNL_TILES.ELEMENT_DELETE_CONFIRM'));
        ?>
		...
		<?php if ($arParams['SECTION_PAGE_MORE_URL']): ?>
			<a class="rs_more_link" href="<?=$arParams['SECTION_PAGE_MORE_URL']?>"><?=(strlen($arParams['SECTION_PAGE_MORE_TEXT']) > 0 ? $arParams['SECTION_PAGE_MORE_TEXT'] : getMessage('RS_ONAIR.BNL_TILES.MORE_LINK'))?></a>
		<?php endif; ?>
