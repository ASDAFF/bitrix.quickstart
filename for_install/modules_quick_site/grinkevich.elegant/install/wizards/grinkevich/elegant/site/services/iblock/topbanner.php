...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/iblock_10.xml";
$iblockCode = "topbanner_".WIZARD_SITE_ID;
$iblockType = "news";
...
WizardServices::IncludeServiceLang("topbanner.php", $lang);
...
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/bitrix/templates/".$wizrdTemplateId."/header.php", array("TOPBANNERS_IBLOCK_ID" => $iblockID));
