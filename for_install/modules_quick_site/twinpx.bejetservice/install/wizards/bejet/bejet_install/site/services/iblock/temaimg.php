...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/temaimg.xml";
$iblockCode = "temaimg";
$iblockType = "bserv_mainimg";
...
$arFields = Array(
	...
	'IN_RSS'=>'N',
	'SORT'=>100,
	"LANG" => array ("ru" => array ( "NAME" => GetMessage("SERVICE_IBLOCK_TEMAIMG")) )
);
...
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/index.php", array("TEMAIMG_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index.php", array("TEMAIMG_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("TEMAIMG_IBLOCK_ID" => $iblockID));
?>
