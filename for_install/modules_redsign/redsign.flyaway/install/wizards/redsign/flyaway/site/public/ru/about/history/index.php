...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		"IBLOCK_TYPE" => "company",
		"IBLOCK_ID" => "#IBLOCK_ID_company_history#",
		"NEWS_COUNT" => "12",
		"USE_SEARCH" => "N",
		"USE_RSS" => "N",
		"USE_RATING" => "N",
		...
		"CHECK_DATES" => "Y",
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "#SITE_DIR#about/history/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		...
		"USE_REVIEW" => "N",
		"SET_LAST_MODIFIED" => "N",
		"RSFLYAWAY_LIST_TEMPLATES_LIST" => "timeline",
