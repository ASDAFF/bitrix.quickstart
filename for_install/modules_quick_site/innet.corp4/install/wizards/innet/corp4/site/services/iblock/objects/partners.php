...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "company/partners/index.php", array('INNET_IBLOCK_ID_PARTNERS' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('INNET_IBLOCK_ID_PARTNERS' => $iblockID));
