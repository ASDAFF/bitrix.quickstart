...
if ($arSite = $obSite->Fetch())
{
	...
	if (!$found) {
		$arTemplates[]= Array("CONDITION" => "", "SORT" => 1, "TEMPLATE" => WIZARD_TEMPLATE_ID);
		$arTemplates[]= Array("CONDITION" => "\$_GET['print']=='Y'", "SORT" => 2, "TEMPLATE" => "print");
		//$arTemplates[]= Array("CONDITION" => "\$_GET['export']=='rtf'", "SORT" => 350, "TEMPLATE" => "rtf_export");		
		}
