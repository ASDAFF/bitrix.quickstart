...
$iblockType = "catalogs"; 
$ABS_FILE_NAME = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/catalog.xml";
...
$NS = array(
			...
			"URL_DATA_FILE" => $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/catalog.xml",
			"ACTION" => "D",
			"PREVIEW" => "N",
		);
