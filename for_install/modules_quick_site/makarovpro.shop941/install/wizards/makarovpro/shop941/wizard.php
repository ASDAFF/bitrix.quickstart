...
function InitStep()
	...
	function OnPostForm()
	{
		...
		if ($wizard->IsNextButtonClick())
		{
			...
			if (in_array($templateID,  array("shop941")))
			{
				$wizard->SetCurrentStep("site_settings");
				$wizard->SetVar("templateID", "shop941");
			}
			else
				$wizard->SetVar("templateID", "shop941");
		}
	...
	function ShowStep()
	{
		...
		if (in_array("shop941", array_keys($arTemplates)))
		{
			$arTemplateOrder[] = "shop941";
		}
		

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "shop941", $wizard->GetVar("siteID"));
		if (!in_array($defaultTemplateID, array("shop941"))) $defaultTemplateID = "shop941";
		...
		$arTemplateInfo = array(
			"shop941" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/shop941/images/".LANGUAGE_ID."/preview.png",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/shop941/images/".LANGUAGE_ID."/screen.png",
			),
			
		);


	//	$this->content .= "<input type='hidden' value='shop941' name='templateID' id='templateID'>";//$this->ShowInputField('hidden', 'templateID', array("id" => "templateID", "value" => "shop941"));
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		if(COption::GetOptionString("shop941", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		if ($wizard->GetVar("templateID") == "shop941")
		{
			$arSocNetsValues["facebook"] = COption::GetOptionString("shop941", "shopFacebook", GetMessage("WIZ_SHOP_FACEBOOK_DEF"), $siteID);
			$arSocNetsValues["twitter"] = COption::GetOptionString("shop941", "shopTwitter", GetMessage("WIZ_SHOP_TWITTER_DEF"), $siteID);
			$arSocNetsValues["vk"] = COption::GetOptionString("shop941", "shopVk", GetMessage("WIZ_SHOP_VK_DEF"), $siteID);
			$arSocNetsValues["google"] = COption::GetOptionString("shop941", "shopGooglePlus", GetMessage("WIZ_SHOP_GOOGLE_PLUS_DEF"), $siteID);
		}
		else
		{
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("shop941", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				...
				//"installEshopApp" => COption::GetOptionString("shop941", "installEshopApp", "Y", $siteID),	
			)
		);
...
class CatalogSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"catalogSubscribe" => (isset($arSubscribe[$siteID])) ? ($arSubscribe[$siteID]['use'] == "Y" ? "Y" : false) : "Y",//COption::GetOptionString("shop941", "catalogSubscribe", "Y", $siteID),
				"catalogView" => COption::GetOptionString("shop941", "catalogView", "list", $siteID),
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("shop941", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("shop941", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("shop941", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("shop941", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("shop941", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("shop941", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("shop941", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("shop941", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("shop941", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("shop941", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("shop941", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("shop941", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("shop941", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("shop941", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("shop941", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("shop941", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("shop941", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("shop941", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("shop941", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("shop941", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("shop941", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("shop941", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("shop941", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("shop941", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("shop941", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("shop941", "installPriceBASE", "Y", $siteID),
			)
		);
	}
	...
	function InitStep()
	{
		...
		if ($shopLocalization == "ua")
			...
			$wizard->SetDefaultVars(
				Array(
					"personType" => Array(
						"fiz" =>  COption::GetOptionString("shop941", "personTypeFiz", "Y", $siteID),
						"ur" => COption::GetOptionString("shop941", "personTypeUr", "Y", $siteID),
					)
				)
			);
	}
...
===*/
	...
	function ShowStep()
	{
		...
		if (
			...
			LANGUAGE_ID == "ru" &&
			(
				COption::GetOptionString("shop941", "wizard_installed", "N", $siteID) != "Y"
			...
			<div class="wizard-input-form-block">
				...
				<div>
					<div class="wizard-input-form-field wizard-input-form-field-checkbox">';
						...
						if(COption::GetOptionString("shop941", "wizard_installed", "N", $siteID) != "Y")
						{
