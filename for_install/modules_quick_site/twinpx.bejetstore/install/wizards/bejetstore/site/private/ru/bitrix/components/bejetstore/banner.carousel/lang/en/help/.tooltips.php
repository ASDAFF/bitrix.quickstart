...
$MESS["SORT_BY1_TIP"] = "Select here the field by which the banners items are to be sorted. You can select <b><i>(other)</i></b> and specify the field ID in the field beside.";
$MESS["SORT_ORDER1_TIP"] = "Ascending or descending.";
$MESS["SORT_BY2_TIP"] = "Select here the field by which the banners items are to be sorted in the second pass. You can select <b><i>(other)</i></b> and specify the field ID in the field beside.";
