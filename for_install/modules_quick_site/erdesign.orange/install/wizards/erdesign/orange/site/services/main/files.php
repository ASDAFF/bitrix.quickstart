...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_NAME" => $wizard->GetVar("siteName")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_TELEFON" => $wizard->GetVar("siteTel")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_HOME" => $wizard->GetVar("siteHome")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_OFIC" => $wizard->GetVar("siteOfic")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_COUNTRY" => $wizard->GetVar("siteCountry")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_SITY" => $wizard->GetVar("siteSity")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_INDEX" => $wizard->GetVar("siteIndex")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_left_bottom.php", array("SITE_EMAIL" => $wizard->GetVar("siteEmail")));


CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_NAME" => $wizard->GetVar("siteName")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_TELEFON" => $wizard->GetVar("siteTel")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_HOME" => $wizard->GetVar("siteHome")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_OFIC" => $wizard->GetVar("siteOfic")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_COUNTRY" => $wizard->GetVar("siteCountry")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_SITY" => $wizard->GetVar("siteSity")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_INDEX" => $wizard->GetVar("siteIndex")));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contact/index.php", array("SITE_EMAIL" => $wizard->GetVar("siteEmail")));
if (WIZARD_INSTALL_DEMO_DATA)
{	
