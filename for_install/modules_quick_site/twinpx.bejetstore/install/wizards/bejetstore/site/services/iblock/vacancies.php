...
$iblockCode = "bejetstore_vacancies_".WIZARD_SITE_ID;
$iblockType = "bj_vacancies"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/about/vacancies/index.php", array("VACANCIES_IBLOCK_ID" => $iblockID));
?>