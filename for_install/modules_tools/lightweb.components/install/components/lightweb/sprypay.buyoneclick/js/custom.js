...
$.fn.lw_sp_check_form = function() {
	...
	var handle_each = function($each_element) {
		var self = {},
			...
			$submit_button = $form_block.find('.lw-sp-form-submit'),
...
$.fn.lw_sp_check_get_form = function() {
	var $this = $(this);
...
$(document).ready(function(){
	...
	$('.sp-window-wrapper').lw_sp_check_form();

	$('.lw-sp-get-order').le_window({
		element_id: true,
		before_open: function(button,element){
			var $element = $(element);
	...
	$('.sp-get-wrapper').lw_sp_check_get_form();
