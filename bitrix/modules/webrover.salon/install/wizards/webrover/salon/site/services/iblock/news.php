...
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/".LANGUAGE_ID."/news.xml"; 
$iblockCode = "COMPANY_NEWS"; 
$iblockType = "salon_news"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index_foot.php", $arReplace);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."about/sect_inc.php", $arReplace);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."contacts/sect_inc.php", $arReplace);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."news/index.php", $arReplace);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."services/sect_inc.php", $arReplace);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."vacancies/sect_inc.php", $arReplace);
