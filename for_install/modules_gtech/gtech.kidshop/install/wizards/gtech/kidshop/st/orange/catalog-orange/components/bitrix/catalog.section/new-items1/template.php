...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="31px"><tr><td class="new-items">Новинки магазина!</td></tr></table>
...
<a href="<?=$arPicture["SRC"];?>" class="zoom_pic" style="margin-right: 8px;"><img src="<?=$templateFolder?>/images/zoom.png" title="Увеличить" /></a>
</td>
...
<?if($arElement["CAN_BUY"]):?>
				<?if($arParams["USE_PRODUCT_QUANTITY"] || count($arElement["PRODUCT_PROPERTIES"])):?>
					...
					<?if($arParams["USE_PRODUCT_QUANTITY"]):?>
						<tr>
<td colspan="1" style="padding-top: 5px;" valign="bottom"><input type="submit" name="<?echo $arParams["ACTION_VARIABLE"]."BUY"?>" value="" class="buy" title="Купить сразу" >&nbsp;
</td><td valign="bottom"><a href="<?echo $arElement["ADD_URL"]?>" class="tobasket-list" rel="nofollow"  onclick="return addToCart(this, 'catalog_list_image_<?=$arElement['ID']?>', 'list','','<?=$count?>');" id="catalog_add2cart_link_<?=$arElement['ID']?>"><img src="<?=$templateFolder?>/images/basket.png" title="Добавить в корзину" /></a>
...
<br />
				...
				<?if($arPrice["CAN_ACCESS"]):?>
					...
					<?if($arPrice["DISCOUNT_VALUE"] < $arPrice["VALUE"]):?>
						Цена: <span class="catalog-price"><?=$arPrice["DISCOUNT_VALUE"]?> <span style="font-family:rouble;">c</span> (<s><?=$arPrice["VALUE"]?> <span style="font-family:rouble;">c</span></s>)</span>
					<?else:?>Цена: <span class="catalog-price"><?=$arPrice["VALUE"]?> <span style="font-family:rouble;">c</span></span><?endif;?>
					</p>
				<?endif;?>
			<?endforeach;?>
                  </td>
