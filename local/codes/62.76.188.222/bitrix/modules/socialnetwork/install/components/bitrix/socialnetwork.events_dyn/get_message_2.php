...
{
	require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/socialnetwork/classes/".$GLOBALS["DBType"]."/log_counter.php");
	$log_cnt = CSocNetLogCounter::GetValueByUserID($GLOBALS["USER"]->GetID(), $site);
}
