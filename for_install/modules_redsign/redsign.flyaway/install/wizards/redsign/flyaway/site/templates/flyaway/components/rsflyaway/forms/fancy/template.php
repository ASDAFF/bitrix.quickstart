				...
				?></div><?
					?><div class="row"><?
						if($arParams["USE_CAPTCHA"] == "Y") {
							?><div class="col col-md-12 form-group field-wrap req"><?
								?><div class="captcha_wrap"><?
									?><div class="row"><?
										...
										?><div class="col col-md-6 field"><input class="form-control req-input form-item" id="captcha_<?=$arResult['WEB_FORM_NAME']?>" type="text" name="captcha_word" size="30" maxlength="50" value=""></div><?
