...
/**
 * Class CJustdevelopSlider
 * Слайдер (Highload)
 * Простой адаптивный слайдер, минимум настроек, без использования сторонних js-библиотек.
 * Источником данных является Highload Инфоблок.
...
class CJustdevelopSlider
{
    const TABLE_HIGHLOAD_IBLOCK_VOTE = 'jdslide';
