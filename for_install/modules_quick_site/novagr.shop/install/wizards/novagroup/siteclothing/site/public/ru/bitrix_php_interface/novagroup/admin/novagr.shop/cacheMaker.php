<?
	...
	if(empty($arParams['PRESET']['IBLOCK_CODE_PRODUCTS']))
		$arParams['PRESET']['IBLOCK_CODE_PRODUCTS'] = "novagr_standard_products";
	...
	if(empty($arParams['PRESET']['IBLOCK_CODE_COMPLECT']))
		$arParams['PRESET']['IBLOCK_CODE_COMPLECT'] = "novagr_standard_images";
	...
	if(empty($arParams['PRESET']['RELPATH_COMPLECT']))
		$arParams['PRESET']['RELPATH_COMPLECT'] = "/imageries/";
