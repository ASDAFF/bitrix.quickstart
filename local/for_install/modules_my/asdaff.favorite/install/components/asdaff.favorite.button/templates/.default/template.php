...
<? endif; ?>
<div data-skey="<?= md5($arParams['FAV_TYPE'] . $arParams['ELEMENT_ID'] . Coption::GetOptionString('asdaff.favorite', 'js_key')) ?>" class="asd_<?= $arParams['BUTTON_TYPE'] ?>_button<? if ($arResult['FAVED'] == 'Y') echo ' asd_' . $arParams['BUTTON_TYPE'] . 'ed' ?>" id="asd_fav_<?= $arParams['ELEMENT_ID'] ?>" title="<?= GetMessage('ASD_TPL_' . ($arResult['FAVED'] == 'Y' ? 'DEL' : 'ADD') . '_' . $arParams['BUTTON_TYPE_UPP']) ?>"></div>
