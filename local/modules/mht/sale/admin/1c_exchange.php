...
/*if (!empty($_GET['KodUzla'])){
arraytofile($_GET,  $_SERVER["DOCUMENT_ROOT"]."/upload/import_orders_log2.txt", "_GET");
arraytofile($_POST,  $_SERVER["DOCUMENT_ROOT"]."/upload/import_orders_log2.txt", "_POST");
}
else{
arraytofile($_GET,  $_SERVER["DOCUMENT_ROOT"]."/upload/import_orders_log1.txt", "_GET");
arraytofile($_POST,  $_SERVER["DOCUMENT_ROOT"]."/upload/import_orders_log1.txt", "_POST");
}*/
