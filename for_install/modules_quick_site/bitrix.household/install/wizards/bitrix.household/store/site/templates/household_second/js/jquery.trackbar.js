	...
	init : function(hash) {
		try {
			...
			this.jq.html('<div class="tickdiv" id="'+this.TICKDIV_PREFIX+this.id+'"></div><table id="'+this.TABLE_PREFIX+this.id+'" ' + (this.width ? ' style="width:'+this.width+'px;"' : '') + 'class="trackbar" onSelectStart="return false;">\
				<tr>\
					<td class="l"><div id="leftBlock" style="margin-top: -5px;"><span></span><span class="limit"></span><img id="leftBegun" ondragstart="return false;" src="/bitrix/templates/household_second/images/imgtrackbar/b_l.gif" width="12" height="23" alt="" /></div></td>\
					<td class="c" id="centerBlock"></td>\
					<td class="r"><div id="rightBlock" style="margin-top: -5px;"><span></span><span class="limit"></span><img id="rightBegun" ondragstart="return false;" src="/bitrix/templates/household_second/images/imgtrackbar/b_r.gif" width="12" height="23" alt="" /></div></td>\
				</tr>\
			</table>');
			// Is all right?
			if (this.onMove == null) {
