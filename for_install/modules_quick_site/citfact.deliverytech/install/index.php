...
Class citfact_deliverytech extends CModule
{
	var $MODULE_ID = "citfact.deliverytech";
	var $MODULE_VERSION;
	...
	function InstallDB($install_wizard = true)
	{
		...
		RegisterModule("citfact.deliverytech");
		RegisterModuleDependences("main", "OnBeforeProlog", "citfact.deliverytech", "CDeliverytech", "ShowPanel");
	...
	function UnInstallDB($arParams = Array())
	{
		...
		UnRegisterModule("citfact.deliverytech");
		UnRegisterModuleDependences("main", "OnBeforeProlog", "citfact.deliverytech", "CDeliverytech", "ShowPanel");
