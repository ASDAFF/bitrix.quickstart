...
namespace Collected\Sberbank;

use \Collected\Sberbank\Exception\ActionException;
use \Collected\Sberbank\Exception\BadResponseException;
use \Collected\Sberbank\Exception\NetworkException;
use \Collected\Sberbank\Exception\ResponseParsingException;
use \Collected\Sberbank\HttpClient\CurlClient;
use \Collected\Sberbank\HttpClient\HttpClientInterface;
use \Collected\Sberbank\OrderStatus;
...
class Client
{
    ...
    public function getLastOrdersForMerchants(\DateTime $from, \DateTime $to = null, array $data = array())
    {
        ...
        $data['transactionStates'] = array_map('\Collected\Sberbank\OrderStatus::statusToString', $data['transactionStates']);
