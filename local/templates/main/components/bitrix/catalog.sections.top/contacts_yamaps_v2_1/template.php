...
<div class="contacts-wrapper">
	...
	<ul class="nav nav-tabs contacts-ul" role="tablist">
		...
		<li<?php if ($iSectionIndex == 0): ?> class="active"<?php endif; ?>>
		    <a href="#tab<?php echo ($iSectionIndex + 1); ?>" data-toggle="tab" role="tab">
	...
	<div class="tab-content">
	    <?php foreach ($arResult["SECTIONS"] as $iSectionIndex => $arSection): ?>
		<div id="tab<?php echo ($iSectionIndex + 1); ?>" class="tab-pane fade<?php if ($iSectionIndex == 0): ?> in active<?php endif; ?>">
		    <div class="row">
			<?php foreach ($arSection["ITEMS"] as $iItemIndex => $arItem): ?>
			    <?php if (($iItemIndex > 0) && (($iItemIndex % $arParams["LINE_ELEMENT_COUNT"]) == 0)): ?>
				</div><div class="row">
			    <?php endif; ?>
			    <div class="col-xs-4" id="<?php echo $this->GetEditAreaId($arItem["ID"]); ?>">
				<div class="thumbnail contact-a">
					...
					<p>				
						...
						<?php echo GetMessage("CT_BCST_PHONE_LABEL"); ?>:&nbsp;<?php echo $sPhone; ?><br />
					    <?php endforeach; ?>
					</p>
				    <?php endif; ?>
					...
					<p>
					    <?php echo GetMessage("CT_BCST_FAX_LABEL"); ?>:&nbsp;<?php echo $arItem["PROPERTIES"]["FAX"]["VALUE"]; ?>
					</p>
				    <?php endif; ?>
					...
					<p>
					    ...
					    <a href="http://<?php echo $arItem["PROPERTIES"]["SITE"]["VALUE"]; ?>" target="_blank">
