		...
		<tr>
			<td colspan="2" class="account">
				...
				<label for="PAY_CURRENT_ACCOUNT">
					...
					<img src="<?=$templateFolder?>/images/logo-default-ps.gif" alt="" <?=($arResult["USER_VALS"]["PAY_CURRENT_ACCOUNT"]=="Y")?"class=\"active\"":"";?> />
					<div class="desc">
	...
	foreach($arResult["PAY_SYSTEM"] as $arPaySystem)
	{
		if(count($arResult["PAY_SYSTEM"]) == 1)
		{
			...
			<div class="ps_logo selected">
				...
				<?else:?>
					<img src="<?=$templateFolder?>/images/logo-default.gif" title="<?=$arPaySystem["PSA_NAME"];?>"/>
				<?endif;?>
