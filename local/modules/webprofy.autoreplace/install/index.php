...
Class webprofy_autoreplace extends CModule
{
	var $MODULE_ID = "webprofy.autoreplace";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;
	var $MLANG = "WEBPROFY_AUTOREPLACE_";

	function webprofy_autoreplace()
	{
		$this->MODULE_VERSION      = WEBPROFY_AUTOREPLACE_VERSION;
		$this->MODULE_VERSION_DATE = WEBPROFY_AUTOREPLACE_VERSION_DATE;
