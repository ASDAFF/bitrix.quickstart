...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/events.xml"; 
$iblockCode = "events_".WIZARD_SITE_ID; 
$iblockCodeOriginal = "events"; 
$iblockType = "news"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "events"';
        return;
    }
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("EVENTS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/index_events.php", array("EVENTS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/about/events/index.php", array("EVENTS_IBLOCK_ID" => $iblockID));
