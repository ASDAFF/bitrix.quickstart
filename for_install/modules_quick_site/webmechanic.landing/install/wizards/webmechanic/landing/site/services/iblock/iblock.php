...
//$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/".WIZARD_TEMPLATE_ID."/iblocks.xml"; 
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/ru/".WIZARD_TEMPLATE_ID."/iblocks.xml"; 

//$iblockCode = "iblocks_".WIZARD_SITE_ID; 
$iblockCode = "credit_elem"; 
$iblockCodeOriginal = "credit_elem"; 
$iblockType = "credit_elem"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "iblocks"';
        return;
    }
