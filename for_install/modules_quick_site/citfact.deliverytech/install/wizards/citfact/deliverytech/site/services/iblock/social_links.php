...
if(COption::GetOptionString("eshop", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "social_links_".WIZARD_SITE_ID;
		$iblockType = "services";
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/footer_socials.php", array("SOCIALS_ID" => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/social_links.xml"; 
$iblockCode = "social_links_".WIZARD_SITE_ID;
$iblockType = "services"; 
