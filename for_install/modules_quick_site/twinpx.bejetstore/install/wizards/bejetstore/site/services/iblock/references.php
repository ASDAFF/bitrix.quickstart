...
if (!$dbHblock->Fetch())
{
	...
	global $DB;
	$strSql="DROP TABLE IF EXISTS bj_color_reference";
	$DB->Query($strSql, false);
	
	$data = array(
		'NAME' => 'ColorReference',
		'TABLE_NAME' => 'bj_color_reference',
	);
...
if (!$dbHblock->Fetch())
{
	...
	global $DB;
	$strSql="DROP TABLE IF EXISTS bj_brand_reference";
	$DB->Query($strSql, false);
	
	$data = array(
		'NAME' => 'BrandReference',
		'TABLE_NAME' => 'bj_brand_reference',
	);
