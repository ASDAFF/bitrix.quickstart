...
<div class="workarea personal">
	...
	<input type="hidden" name="EMAIL" value=<?=$arResult["arUser"]["EMAIL"]?> />
		...
		<input type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" class="input_text_style" value="" autocomplete="off" /> <br><br><br>

		<input name="save" value="<?=GetMessage("MAIN_SAVE")?>" class="orange-but" type="submit">
	</form>
</div>
<br>
<?
