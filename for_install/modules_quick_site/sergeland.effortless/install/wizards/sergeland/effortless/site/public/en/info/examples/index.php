...
?>
<h2 class="title">Example of filling of pages of text</h2>
<p class="text-muted">For your content Manager this page shows an example of filling the page with text.</p>
...
<div class="row">
	<div class="col-md-6">
		<img src="#SITE_DIR#images/content.jpg" alt="" class="mb-20">
	</div>
	<div class="col-md-6">
		<p class="text-muted">Ut wisi enim ad minim veniam, quis nostrud exerci taion ullamcorper suscipit lobortis nisl ut aliquip ex en commodo consequat. Duis te feugifacilisi per suscipit lobortis nisl ut aliquip ex en commodo consequat.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem nonummy nibh euismod tincidunt ut lacreet dolore magna aliguam erat volutpat. Ut wisis enim ad minim veniam, quis nostrud exerci tution ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis te feugifacilisi. Duis autem dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit.</p>
	</div>
</div>
<p class="small text-info">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex, eligendi cum officiis sint eveniet omnis eius quo. Et iusto eos dolor ratione nesciunt praesentium eveniet distinctio repellat. Quas, soluta, ipsam.</p>
<blockquote>
...
<div class="row">
	<div class="col-md-6 col-sm-6">
		<ul class="list-icons">
			...
			<li><i class="fa fa-times"></i> Sdipisicing elit</li>
			<li><i class="fa fa-fax"></i> Sint eveniet omnis eius quo</li>
			<li><i class="fa fa-book"></i> Dolor ratione nesciunt</li>
		</ul>								
	</div>
	<div class="col-md-6 col-sm-6">
		<ul class="list-icons">
