...
$arIBlock=array();
$rsIBlock = CIBlock::GetList(Array("sort" => "asc"), Array("TYPE" => $arCurrentValues["RELATED_PRODUCTS_IBLOCK_TYPE"], "ACTIVE"=>"Y"));
...
$arTemplateParameters = array(
	...
	'RSFLYAWAY_SHOW_RELATED_PRODUCTS' => array(
		'NAME' => GetMessage('RS.FLYAWAY.SHOW_RELATED_PRODUCTS'),
		'TYPE' => 'CHECKBOX',
		'VALUE' => 'Y',
		'DEFAULT' => 'N',
		'REFRESH' => 'Y',
    ...
    'USE_ARCHIVE' => array(
        'NAME' => GetMessage('RS.FLYAWAY.USE_ARCHIVE'),
        'TYPE' => 'CHECKBOX',
        'VALUE' => 'Y',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y',
...
if ($arCurrentValues['USE_ARCHIVE'] == 'Y') {
    ...
    $arTemplateParameters["ARCHIVE_URL"] = array(
		"PARENT" => "SEF_MODE",
		"NAME" => GetMessage("RS_FLYAWAY.ARCHIVE_URL"),
		"TYPE" => "STRING",
		"DEFAULT" => "archive/",
    );
    
    $arTemplateParameters["ARCHIVE_SHOW_YEARS"] = array(
        "PARENT" => "ADDITIONAL_SETTINGS",
        "NAME" => GetMessage("RS_FLYAWAY.ARCHIVE_SHOW_YEARS"),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    );
    
    $arTemplateParameters["ARCHIVE_SHOW_MONTHS"] = array(
        "PARENT" => "ADDITIONAL_SETTINGS",
        "NAME" => GetMessage("RS_FLYAWAY.ARCHIVE_SHOW_MONTHS"),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    );
    ...
    $arTemplateParameters["ARCHIVE_URL"] = CIBlockParameters::GetPathTemplateParam(
        "SECTION",
        "ARCHIVE_URL",
        GetMessage("RS_FLYAWAY.BN_FLYAWAY.ARCHIVE_URL"),
        "/news/arcive/#YEAR#/#MONTH#/",
        "SEF_MODE"
    );
    */
    /*
    $arTemplateParameters["SEF_RULE"] = array(
        "VALUES" => array(
            "YEAR" => array(
                "TEXT" => 'YEAR_TEXT',//GetMessage("IBLOCK_SECTION_ID"),
                "TEMPLATE" => "#YEAR#",
                "PARAMETER_LINK" => "ARCHIVE_URL",
                "PARAMETER_VALUE" => '={$_REQUEST["YEAR"]}',
            ),
            "MONTH" => array(
                "TEXT" => 'MONTH_TEXT',//GetMessage("IBLOCK_SECTION_ID"),
                "TEMPLATE" => "#MONTH#",
                "PARAMETER_LINK" => "ARCHIVE_URL",
                "PARAMETER_VALUE" => '={$_REQUEST["MONTH"]}',
            ),
        ),
    );
    */
...
if( $arCurrentValues['RSFLYAWAY_SHOW_RELATED_PRODUCTS']=='Y' ) {
	$arTemplateParameters['RELATED_PRODUCTS_IBLOCK_TYPE'] = array(
		'NAME' => GetMessage('RS.FLYAWAY.RELATED_PRODUCTS_IBLOCK_TYPE'),
		'TYPE' => 'LIST',
		'VALUES' => $arIBlockType,
		'PARENT' => 'DETAIL_SETTINGS',
		'REFRESH' => 'Y'
	);
	$arTemplateParameters['RSFLYAWAY_RELATED_PRODUCTS_IBLOCK'] = array(
		'NAME' => GetMessage('RS.FLYAWAY.RELATED_PRODUCTS_IBLOCK'),
		'TYPE' => 'LIST',
		'VALUES' => $arIBlock,
		'PARENT' => 'DETAIL_SETTINGS',
	);
	$arTemplateParameters['RSFLYAWAY_RELATED_PRODUCTS_CODE'] = array(
		'NAME' => GetMessage('RS.FLYAWAY.RELATED_PRODUCTS_CODE'),
		'TYPE' => 'LIST',
		'VALUES' => $listProp['ALL'],
		'PARENT' => 'DETAIL_SETTINGS',
	);
...
if( $arCurrentValues['RSFLYAWAY_LIST_TEMPLATES_DETAIL_USE']=='Y' && $arCurrentValues['RSFLYAWAY_LIST_TEMPLATES_DETAIL']!='news' ) {
	...
	if( $arCurrentValues['RSFLYAWAY_USE_OWL_DETAIL']=='Y' ) {
		...
		$arTemplateParameters['RSFLYAWAY_OWL_MID_DETAIL'] = array(
			'NAME' => GetMessage('RS.FLYAWAY.OWL_MID'),
			'TYPE' => 'STRING',
			'DEFAULT' => '2',
			'PARENT' => 'DETAIL_SETTINGS',
		);
