...
WizardServices::IncludeServiceLang("step3.php", $lang);

$dbEvent = CEventType::GetList(Array("TYPE_ID" => "YOUR_FAV"));
if(!($dbEvent->Fetch())){
	$et = new CEventType;
	$et->Add(array(
		"LID" => $lid,
		"EVENT_NAME" => "YOUR_FAV",
		"NAME" => GetMessage("YOUR_FAV"),
		"DESCRIPTION" => GetMessage("YOUR_FAV_DESC"),
	));
	...
	$emess->Add(array(
		...
		"EMAIL_TO" => "#EMAIL#",
		"BCC" => "#BCC#",
		"SUBJECT" => GetMessage("YOUR_FAV_SUBJECT"),
		"MESSAGE" => GetMessage("YOUR_FAV_MESSAGE"),
		"BODY_TYPE" => "text",
	));
}
