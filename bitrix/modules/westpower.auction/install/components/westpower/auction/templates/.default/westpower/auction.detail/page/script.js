...
function auctionTimer() 
{
	...
	if (timeCurrent < timeBegin)
	{
		...
		$('.js-auction-date-title').html(BX.message('A_BEGIN'));		
	}
	else
	{
		...
		$('.js-auction-date-title').html(BX.message('A_TIME'));
	}
