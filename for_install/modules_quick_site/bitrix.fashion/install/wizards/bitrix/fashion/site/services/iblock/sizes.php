...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sizes.xml";
$iblockCode = "sizes_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
WizardServices::IncludeServiceLang("sizes.php", $lang);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/sect_inc.php", array("CATALOG_SIZES_IBLOCK_ID" => $iblockID));
?>