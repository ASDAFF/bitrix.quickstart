...
$MESS ['PRMEDIA_MM_MR_TITLE'] = 'Регистрация';
$MESS ['PRMEDIA_MM_MR_TOP_NOTE'] = '
			Звездочкой (<span class="required">*</span>) отмечены поля обязательные для заполненения.<br>
			Если у вас уже есть аккаунт, вы можете';
$MESS ['PRMEDIA_MM_MR_AUTH_LINK'] = 'авторизоваться';
$MESS ['PRMEDIA_MM_MR_CAPTCHA'] = 'Введите фразу с картинки';
$MESS ['PRMEDIA_MM_MR_SUBMIT'] = 'Регистрация';
...
$MESS ['main_profile_time_zones_auto'] = 'Как определять часовой пояс:';
