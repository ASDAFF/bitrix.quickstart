...
Class slobel_socialicons extends CModule
{
	const MODULE_ID = 'slobel.socialicons';
	var $MODULE_ID = 'slobel.socialicons'; 
	var $MODULE_VERSION;
	...
	{
		RegisterModuleDependences('main', 'OnBuildGlobalMenu', self::MODULE_ID, 'CSlobelSocialicons', 'OnBuildGlobalMenu');
		return true;
	}

	function UnInstallDB($arParams = array())
	{
		UnRegisterModuleDependences('main', 'OnBuildGlobalMenu', self::MODULE_ID, 'CSlobelSocialicons', 'OnBuildGlobalMenu');
		return true;
	}
