...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	...
	<?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>
		...
		<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
			<input class="button" style="margin: 10px 0 0 0;" type="submit" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" />
			<input type="hidden" name="action" value="unsubscribe" />
		<?else:?>
			<input class="button" style="margin: 10px 0 0 0;" type="submit" name="activate" value="<?echo GetMessage("subscr_activate")?>" />
