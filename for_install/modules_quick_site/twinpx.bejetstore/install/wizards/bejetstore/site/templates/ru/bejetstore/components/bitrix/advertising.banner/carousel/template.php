...
<?if($arResult["COUNT"] <= 0)
	return;
?>
<div id="banner-carousel-1" class="carousel slide banner-carousel" data-ride="carousel" data-interval="20000">
	<!-- Indicators -->
	...
	<?if(strpos($arBanner, '<a')===false && strpos($arBanner, '<span')===false){$arBanner='<span class="item">'.$arBanner.'</span>';}?>
	<?=$arBanner?>
	<?}?>
	</div>
	<!-- Controls -->
