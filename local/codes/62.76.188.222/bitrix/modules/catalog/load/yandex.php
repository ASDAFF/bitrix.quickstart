...
$strAll.= "<shop>\n";
$strAll.= "<name>".htmlspecialcharsbx($APPLICATION->ConvertCharset(COption::GetOptionString("main", "site_name", ""), LANG_CHARSET, 'windows-1251'))."</name>\n";
$strAll.= "<company>".htmlspecialcharsbx($APPLICATION->ConvertCharset(COption::GetOptionString("main", "site_name", ""), LANG_CHARSET, 'windows-1251'))."</company>\n";
