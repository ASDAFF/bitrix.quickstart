...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
        ...
        "SLIDER_NEWS_COUNT" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("SLIDER_NEWS_COUNT"),
			"TYPE" => "STRING",
			"DEFAULT" => "5",
		),
        "SLIDER_HITS_COUNT" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("SLIDER_HITS_COUNT"),
			"TYPE" => "STRING",
			"DEFAULT" => "5",
		),
        "SLIDER_DISCOUNT_COUNT" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("SLIDER_DISCOUNT_COUNT"),
			"TYPE" => "STRING",
			"DEFAULT" => "5",
		),
        "PROPERTY_CODE" => Array(
            "PARENT" => "VISUAL",
            "NAME" => "Необходимые свойства",
            "TYPE" => "LIST",
            "MULTIPLE" => "Y",
            "VALUES" => $arProps,
        ),
