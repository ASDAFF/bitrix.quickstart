<?
$MESS["REGISTER_TITLE"] = "Информация  о покупателе";
$MESS["REGISTER_INFO"] = "Чтобы сохранить данные для повторных покупок в нашем магазине, пожалуйста зарегистрируйтесь:";
...
$MESS["REGISTER_FIELD_LOGIN"] = "E-mail (логин)";
