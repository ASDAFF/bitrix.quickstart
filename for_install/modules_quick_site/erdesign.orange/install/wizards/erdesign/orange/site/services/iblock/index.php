...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/index.xml"; 
$iblockCode = "index_".WIZARD_SITE_ID; 
$iblockType = "service"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("INDEX_IBLOCK_ID" => $iblockID));
?>
