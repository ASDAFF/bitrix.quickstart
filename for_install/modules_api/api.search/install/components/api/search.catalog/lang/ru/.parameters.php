...
//GROUP SEARCH
$MESS['IBLOCK_SEARCH']             = 'Поиск';
$MESS['USE_SEARCH']                = 'Настроить';
$MESS['INCLUDE_CSS']               = 'Подключать стили';
...
//GROUP CATALOG_TEMPLATE
$MESS['CATALOG_TEMPLATE']              = 'Шаблон компонента - Элементы раздела (catalog.section)';
$MESS['CATALOG_TEMPLATE_SITE_DEFAULT'] = 'Общий шаблон';
$MESS['CATALOG_TEMPLATE_SYSTEM']       = 'Встроенный шаблон';