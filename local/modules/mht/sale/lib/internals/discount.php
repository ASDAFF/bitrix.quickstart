	...
	public static function getMap()
	{
		return array(
			...
			'PRICE_FROM' => new Main\Entity\FloatField('PRICE_FROM', array(
				'title' => Loc::getMessage('DISCOUNT_ENTITY_PRICE_FROM_FIELD')
			)),
			'PRICE_TO' => new Main\Entity\FloatField('PRICE_TO', array(
				'title' => Loc::getMessage('DISCOUNT_ENTITY_PRICE_TO_FIELD')
			)),
			...
			'DISCOUNT_VALUE' => new Main\Entity\FloatField('DISCOUNT_VALUE', array(
				'title' => Loc::getMessage('DISCOUNT_ENTITY_DISCOUNT_VALUE_FIELD')
			)),
			'DISCOUNT_TYPE' => new Main\Entity\StringField('DISCOUNT_TYPE', array(
				'default_value' => 'P',
				'validation' => array(__CLASS__, 'validateDiscountType'),
				'title' => Loc::getMessage('DISCOUNT_ENTITY_DISCOUNT_TYPE_FIELD')
			)),
			...
			'ACTIONS' => new Main\Entity\TextField('ACTIONS', array(
				'title' => Loc::getMessage('DISCOUNT_ENTITY_ACTIONS_FIELD')
			)),
			...
			'APPLICATION' => new Main\Entity\TextField('APPLICATION', array(
				'title' => Loc::getMessage('DISCOUNT_ENTITY_APPLICATION_FIELD')
			)),
