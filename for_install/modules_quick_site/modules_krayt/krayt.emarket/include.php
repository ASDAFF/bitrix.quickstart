...
class CEmarket
{
	function ShowPanel()
	{
		if ($GLOBALS["USER"]->IsAdmin() && 
			COption::GetOptionString("main", "wizard_solution", "", SITE_ID) == "emarket")
		{
			$GLOBALS["APPLICATION"]->SetAdditionalCSS("/bitrix/wizards/krayt/emarket/css/panel.css"); 

			$arMenu = Array(
				Array(		
					"ACTION" => "jsUtils.Redirect([], '".CUtil::JSEscape("/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&wizardSiteID=".SITE_ID."&wizardName=bitrix:emarket&".bitrix_sessid_get())."')",
			...
			$GLOBALS["APPLICATION"]->AddPanelButton(array(
				"HREF" => "/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&wizardName=bitrix:emarket&wizardSiteID=".SITE_ID."&".bitrix_sessid_get(),
				"ID" => "emarket_wizard",
    ...
    {
        if(SITE_TEMPLATE_ID == 'emarket_emarket')
        {
