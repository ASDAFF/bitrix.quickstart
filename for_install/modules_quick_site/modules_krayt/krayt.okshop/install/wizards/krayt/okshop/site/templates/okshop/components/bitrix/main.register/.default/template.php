...
?>
    ...
    <div class="registration-box">
        ...
        <?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
            ...
            <?else:?>
                <tr>
                    <td><?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="starrequired">*</span><?endif?><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:</td>
                    <td><?
            switch ($FIELD)
            {
                case "PASSWORD":
        ...
        <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
            <tr><td colspan=3"><?=strlen(trim($arParams["USER_PROPERTY_NAME"])) > 0 ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB")?></td></tr>
        ...
        if ($arResult["USE_CAPTCHA"] == "Y")
        {
            ?>
                <tr>
                    <td colspan="3"><b><?=GetMessage("REGISTER_CAPTCHA_TITLE")?></b></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
        ...
        <div class="bx-registration-buttons">
            ...
            <input type="submit" name="register_submit_button" class="bg-blue-gradient" value="<?=GetMessage("AUTH_REGISTER")?>" />
        </div>
    </div>
</form>
<?endif?>
