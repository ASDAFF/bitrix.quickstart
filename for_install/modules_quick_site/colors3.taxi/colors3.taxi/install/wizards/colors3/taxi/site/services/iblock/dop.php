...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/dop.xml"; 
...
WizardServices::IncludeServiceLang("dop.php", $lang);

CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_DOP_1")
		.'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_DOP_2")
		.'--,--NAME--#--'.GetMessage("WZD_OPTION_DOP_3")
		.'--,--CODE--#--'.GetMessage("WZD_OPTION_DOP_4")	
		.'--,--PROPERTY_'.$arProperty["COST"].'--#--'.GetMessage("WZD_OPTION_DOP_5")
		.'--,--SORT--#--'.GetMessage("WZD_OPTION_DOP_6")
		.'--;--', ));
CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockType.".".$iblockID), array ( 'columns' => 'ACTIVE,SORT,PROPERTY_'.$arProperty["SORT"].',ID', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20', ));
