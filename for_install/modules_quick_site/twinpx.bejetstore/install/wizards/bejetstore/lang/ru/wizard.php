...
$MESS["WIZ_TEMPLATE_VERTICAL_POPUP"] = "Шаблон Seller 1.1";
$MESS["WIZ_TEMPLATE_BEJET_SELLER"] = "Шаблон Seller 1.2";
$MESS["WIZ_TEMPLATE_VERTICAL_POPUP_DESCRIPTION"] = "Первая версия решения, использующая библиотеку Bootstrap (адаптивная вёрстка). Более не обновляется.";
$MESS["WIZ_TEMPLATE_BEJET_SELLER_DESCRIPTION"] = "Новый шаблон решения с новой «Шапкой» и мобильным меню. Используется в качестве основной актуальной версии и будет обновляться.";
...
$MESS["WIZ_COMPANY_LOGO"] = "Логотип (рекомендуемый размер 143 X 40)";
$MESS["WIZ_COMPANY_NAME"] = "Название сайта или компании";
$MESS["WIZ_COMPANY_NAME_DEF"] = "Seller — продажа одежды.";
