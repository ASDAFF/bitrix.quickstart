...
<aside class="b-sidebar">
    <div class="b-banner m-sidebar">
        <h2 class="b-h2__green">Скидки на ноутбуки Lenovo</h2>
        <span>До 50 % в течение сентября</span>
    </div>
    <div class="b-banner m-sidebar">
        <h2 class="b-h2__green">Конкурс от компании ASUS</h2>
        <p><img src="/upload/img2.png" alt="" /></p>
        <span>Компания ASUS <a href="#">объявила о конкурсе</a>, в котором можно выиграть один из 6 туристических сертификатов</span>
    </div>
</aside>
