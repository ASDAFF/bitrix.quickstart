...
if($arParams["ES_INCLUDE_JQUERY"]=="Y") $APPLICATION->AddHeadScript(__DIR__ . "/js/jquery-1.6.4.min.js");
if($arParams["ES_INCLUDE_JQUERY_EASING"]=="Y") $APPLICATION->AddHeadScript(__DIR__ . "/js/jquery.animation.easing.js");
if($arParams["ES_INCLUDE_JQUERY_JCAROUSEL"]=="Y") $APPLICATION->AddHeadScript(__DIR__ . "/js/jquery.jcarousel.js");
?>