...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "redsign.activelife";
	}
}
...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		if ($wizard->IsNextButtonClick())
		{
			...
			if (in_array($templateID,  array("al")))
				$wizard->SetVar("templateID", "al");
		}
	}
	...
	function ShowStep()
	{
		...
		if (in_array("al", array_keys($arTemplates)))
		{
			$arTemplateOrder[] = "al";
		}

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "al", $wizard->GetVar("siteID"));
		if (!in_array($defaultTemplateID, array("al"))) $defaultTemplateID = "al";
		...
		$arTemplateInfo = array(
			"al" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/al/preview.gif",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/al/screen.gif",
			),
		);

	//	$this->content .= "<input type='hidden' value='al' name='templateID' id='templateID'>";//$this->ShowInputField('hidden', 'templateID', array("id" => "templateID", "value" => "al"));
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$isWizardInstalled = COption::GetOptionString("redsign.activelife", "wizard_installed", "N", $siteID) == "Y";

		if(COption::GetOptionString("redsign.activelife", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		$wizard->SetDefaultVars(Array(
			"siteLogo" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/activelife/site/templates/al/assets/img/logo.png"),
			"siteLogoRetina" => file_exists(WIZARD_SITE_PATH."include/logo_retina.png") ? WIZARD_SITE_DIR."include/logo_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/activelife/site/templates/al/assets/img/logo.png"),
			//"siteLogoMobile" => file_exists(WIZARD_SITE_PATH."include/logo_mobile.png") ? WIZARD_SITE_DIR."include/logo_mobile.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/activelife/site/templates/al/themes/".$themeID."/images/logo_mobile.png"),
			//"siteLogoMobileRetina" => file_exists(WIZARD_SITE_PATH."include/logo_mobile_retina.png") ? WIZARD_SITE_DIR."include/logo_mobile_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/redsign/activelife/site/templates/al/themes/".$themeID."/images/logo_mobile_retina.png")
		));
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("redsign.activelife", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"siteMetaDescription" => GetMessage("wiz_site_desc"),
				"siteMetaKeywords" => GetMessage("wiz_keywords"),
				//"installEshopApp" => COption::GetOptionString("redsign.activelife", "installEshopApp", "Y", $siteID),
			)
		);
...
class CatalogSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"catalogSubscribe" => (isset($arSubscribe[$siteID])) ? ($arSubscribe[$siteID]['use'] == "Y" ? "Y" : false) : "Y",//COption::GetOptionString("redsign.activelife", "catalogSubscribe", "Y", $siteID),
				"catalogView" => COption::GetOptionString("redsign.activelife", "catalogView", "list", $siteID),
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("redsign.activelife", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("redsign.activelife", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("redsign.activelife", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("redsign.activelife", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("redsign.activelife", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("redsign.activelife", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("redsign.activelife", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("redsign.activelife", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("redsign.activelife", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("redsign.activelife", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("redsign.activelife", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("redsign.activelife", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("redsign.activelife", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("redsign.activelife", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("redsign.activelife", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("redsign.activelife", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("redsign.activelife", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("redsign.activelife", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("redsign.activelife", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("redsign.activelife", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("redsign.activelife", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("redsign.activelife", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("redsign.activelife", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("redsign.activelife", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("redsign.activelife", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("redsign.activelife", "installPriceBASE", "Y", $siteID),
			)
		);
	}
	...
	function InitStep()
	{
		...
		if ($shopLocalization == "ua")
			...
			$wizard->SetDefaultVars(
				Array(
					"personType" => Array(
						"fiz" =>  COption::GetOptionString("redsign.activelife", "personTypeFiz", "Y", $siteID),
						"ur" => COption::GetOptionString("redsign.activelife", "personTypeUr", "Y", $siteID),
					)
				)
			);
	}
...
===*/
	...
	function ShowStep()
	{
		...
		if (
			...
			LANGUAGE_ID == "ru" &&
			(
				COption::GetOptionString("redsign.activelife", "wizard_installed", "N", $siteID) != "Y"
			...
			<div class="wizard-input-form-block">
				...
				<div>
					<div class="wizard-input-form-field wizard-input-form-field-checkbox">';
						...
						if(COption::GetOptionString("redsign.activelife", "wizard_installed", "N", $siteID) != "Y")
						{
...
class FinishStep extends CFinishWizardStep
{
	...
	//	$this->content .= "<br clear=\"all\"><a href=\"/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&site_id=".$siteID."&wizardName=redsign:activelife.mobile&".bitrix_sessid_get()."\" class=\"button-next\"><span id=\"next-button-caption\">".GetMessage("wizard_store_mobile")."</span></a><br>";
