...
Class refreshlab_err404 extends CModule
{
	var $MODULE_ID = "refreshlab.err404";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;

	function refreshlab_err404()
	{
		...
		$this->PARTNER_URI = "http://www.refreshlab.ru/";
	...
	function DoInstall()
	{
		...
		$this->InstallEvents();
		$APPLICATION->IncludeAdminFile(GetMessage("ERR404_INSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/refreshlab.err404/install/step.php");
	}
