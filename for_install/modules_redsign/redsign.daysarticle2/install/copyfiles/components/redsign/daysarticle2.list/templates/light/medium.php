...
<?if(count($arResult["ITEMS"])>0):?>
	<?foreach($arResult["ITEMS"] as $key => $arItem):?>
		...
		<!-- second view -->
		<div class="daysarticle light_wrap view2" id="<?=$element['ID']?>">
			<div class="top_part">
				<div class="left_part">
					<div class="title">
					...
					<div class="circle_progress">
						<input id="circle_progress_input" type="text" value="<?=$timer["DINAMICA_EX"]["PHP_DATA"]["persent"]?>" class="circle" data-width="90" data-fgColor="#47bdec" data-displayPrevious=true data-readOnly=true data-thickness="0.05">
