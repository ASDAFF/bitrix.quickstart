...
<tr class=xl37 height=44 style='mso-height-source:userset;height:33.6pt'>
	<td height=44 class=xl54 width=311 style='height:33.6pt;width:213pt'>
	Наименование товара (описание  <br>выполненных работ, оказанных услуг),  <br>имущественного права
	</td>
	<td class=xl55 width=40 style='border-left:none;width:30pt'>Ед. изм.</td>
	<td class=xl55 width=39 style='border-left:none;width:29pt'>Кол-<br>во</td>
	...
	<td class=xl54 width=43 style='border-left:none;width:32pt'>Налого<br>вая ставка</td>
...
<tr class=xl39>
	...
	width:59pt' x:num><?echo SaleFormatCurrency($nds_val*$arQuantities[$mi], $arOrder["CURRENCY"], true); $total_nds += $nds_val*$arQuantities[$mi];?></td>
...
<tr>
	...
	<td class=xl63 align=right width=83 style='border-top:none;width:62pt;white-space:nowrap' x:num><?echo SaleFormatCurrency($arOrder["PRICE"], $arOrder["CURRENCY"], true)?></td>
