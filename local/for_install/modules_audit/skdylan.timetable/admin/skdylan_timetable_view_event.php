...
$APPLICATION->SetTitle(GetMessage("TAMETABLE_VIEW_TAB"));
...
{
    $groupName = MainTimeTable::GetGroupNameByID($_REQUEST['SID']);
}
...
$APPLICATION->SetTitle(GetMessage("TAMETABLE_VIEW_TAB")." - ".$event["NAME"]);
...
while ($item = $arRes->Fetch()) {
    ...
    $arActions[] = array(
        ...
        "ACTION" => $lAdmin->ActionRedirect("skdylan_timetable_edit_participant.php?ID=".$f_ID.'&lang='.LANG),
        "DEFAULT" => false
    );
    $arActions[] = array(
        "ICON" => "delete",
...
$aContext = array(
    array(
        ...
        "LINK" => "/bitrix/admin/skdylan_timetable_edit_participant.php?EID=".$eventID."&lang=".LANG,
        "TITLE" => GetMessage("TAMETABLE_ADD_PARTICIPANT"),
        "ICON" => "btn_new",
    ),
);
...
$aMenu = array(
    array(
        ...
        "LINK" => "skdylan_timetable_events_list.php?SID=".$event["IBLOCK_ID"]."&lang=".LANG,
        "ICON" => "btn_list",
    )
);
...
$aTabs = array(
    array("DIV" => "edit1", "TAB" => GetMessage("TAMETABLE_VIEW_TAB"), "ICON" => "", "TITLE" => GetMessage("TAMETABLE_VIEW_TAB")),
);
