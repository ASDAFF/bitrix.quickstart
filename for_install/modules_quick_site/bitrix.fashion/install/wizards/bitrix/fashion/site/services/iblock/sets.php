...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sets.xml";
$iblockCode = "sets_".WIZARD_SITE_ID;
$iblockType = "catalog";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("SETS_IBLOCK_ID" => $iblockID));
?>