...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/doctors.xml"; 
$iblockCode = "clinic_doctors_".WIZARD_SITE_ID; 
$iblockType = "clinic"; 
...
if($iblockID == false)
{
	...
	$arFields = Array(
		...
		"FIELDS" => array (
			...
			'PREVIEW_PICTURE' => array ( 'IS_REQUIRED' => 'N', 'DEFAULT_VALUE' => array ( 'FROM_DETAIL' => 'N', 'SCALE' => 'Y', 'WIDTH' => '120', 'HEIGHT' => '160', 'IGNORE_ERRORS' => 'N', ), ),
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/doctors/.sub.menu_ext.php", array("DOCTORS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/doctors/index.php", array("DOCTORS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/doctors/section.php", array("DOCTORS_IBLOCK_ID" => $iblockID));
?>
