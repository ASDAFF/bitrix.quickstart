<?
$MESS["WIZ_TEMPLATE"] = "Интернет–магазин детских товаров";
$MESS["WIZ_TEMPLATE_DESCR"] = "Мастер создания интернет магазина на примере детских товаров";
...
$MESS["WIZ_COMPANY_LOGO"] = "Логотип (рекомендуемый размер 215 X 40)";
$MESS["WIZ_COMPANY_NAME"] = "Название сайта или компании";
$MESS["WIZ_COMPANY_NAME_DEF"] = "Интернет-магазин детских товаров";
$MESS["WIZ_COMPANY_TELEPHONE"] = "Телефон для обратной связи";
$MESS["WIZ_COMPANY_TELEPHONE_DEF"] = "Поддержка: +7 (495) 012-34-56, support@lenal.biz";
$MESS["WIZ_COMPANY_COPY"] = "Подпись сайта";
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; 2010 — 2014 LENAL ShopLight";
...
$MESS["wiz_site_desc"] = "Мы предлагаем широкий ассортимент детских товаров по адекватным ценам.";
$MESS["wiz_keywords"] = "дети, игрушки, развиваюшие игры, ходунки, все для мам";
