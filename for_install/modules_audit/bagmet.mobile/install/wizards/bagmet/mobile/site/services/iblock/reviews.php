...
$iblockCode = "mobile_reviews_".WIZARD_SITE_ID;
$iblockType = "news"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_NEWS_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_NEWS_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_NEWS_3").'--,--NAME--#--'.GetMessage("WZD_OPTION_NEWS_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_NEWS_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_NEWS_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_NEWS_10").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_NEWS_11").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_NEWS_12").'--;--', ));
