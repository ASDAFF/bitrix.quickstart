...
<?$arPrice = CPrice::GetBasePrice($arItem["ITEM_ID"]);?>
                                    <div class="b-slider__item">
                                        <div class="b-popup-slider__image"><a href="<?echo $arItem["URL"]?>"><img src="<?echo $arItem["PREV"]["SRC"]?>" width="<?=$arItem["PREV"]["WIDTH"]?>" height="<?=$arItem["PREV"]["HEIGHT"]?>"></a></div>
                                        <div class="b-popup-slider__title"><?echo $arItem["NAME"]?><br><b><?=CurrencyFormat($arPrice["PRICE"], "RUB");?></b></div>
                                    </div>  
                                    <?endif;?>
                                <?endforeach;?>
                        </div>
