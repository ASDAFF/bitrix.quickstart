...
$MESS['KLONDIKE_IBLOCK_TYPE']    = 'Тип инфоблока';
$MESS['KLONDIKE_IBLOCK_ID']      = 'Инфоблок';
$MESS['KLONDIKE_COLOR_SCHEME']   = 'Цвет';
$MESS['KLONDIKE_ITEMS_LIMIT']    = 'Количество слайдов';
$MESS['KLONDIKE_AUTO_PLAY']      = 'Автопрокрутка';

$MESS['KLONDIKE_COLOR_SCHEME_PINK']      = 'Розовый';
$MESS['KLONDIKE_COLOR_SCHEME_YELLOW']    = 'Желтый';
$MESS['KLONDIKE_COLOR_SCHEME_ORANGE']    = 'Ораньжевый';
$MESS['KLONDIKE_COLOR_SCHEME_SIREN']     = 'Сиреневый';
$MESS['KLONDIKE_COLOR_SCHEME_GREEN']     = 'Зеленый';
$MESS['KLONDIKE_COLOR_SCHEME_BLUE']      = 'Синий';

$MESS['KLONDIKE_INCLUDE_JQUERY']        = 'Подключать jQuery (активируйте, если jQuery не подключен на сайте)';
$MESS['KLONDIKE_INCLUDE_MODERNIZER']    = 'Подключать Modernizr (активируйте, если Modernizr не подключен на сайте)';

$MESS['KLONDIKE_GROUP_JS_OPTIONS']      = 'Настройка JavaScript';
$MESS['KLONDIKE_GROUP_PLUGIN_OPTIONS']  = 'Настройка слайдера';

$MESS["KLONDIKE_PREVIEW_TRUNCATE_LEN"]  = "Максимальная длина анонса для вывода (только для типа текст)";
$MESS["KLONDIKE_INTERVAL"]              = "Интервал прокрутки (секунды)";
?>