	...
	<form action="" method="get">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody><tr>
				...
				<td>
					<input class="search-button btn btn-grey do hg-23 pt-0 pb-1" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
				</td>
			</tr>
		</tbody></table>
		<br /><br />
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			<div class="search-item">
				...
				<div class="search-preview"><?=trim($arItem["BODY_FORMATED"])?></div>
				<?if(
