...
$MESS["GALLERY_ID"] = "Идентификатор контейнера (уникальный, если на странице несколько галерей)";
$MESS["GALLERY_SKIN"] = "Скин";
$MESS["GALLERY_CSS"] = "Путь к CSS-файлу со скином";
$MESS["SMALL_IMAGE_WIDTH"] = "Ширина изображения в карусели";
$MESS["SMALL_IMAGE_HEIGHT"] = "Высота изображения в карусели";
$MESS["SHOW_BIG_IMAGE"] = "Показывать большое изображение";
$MESS["BIG_IMAGE_WIDTH"] = "Ширина большого изображения";
$MESS["BIG_IMAGE_HEIGHT"] = "Высота большого изображения";
$MESS["USE_PRELOADER"] = "Включить предзагрузку больших изображений";
$MESS["SHOW_IMAGE_CAPTIONS"] = "Показывать названия изображений";
