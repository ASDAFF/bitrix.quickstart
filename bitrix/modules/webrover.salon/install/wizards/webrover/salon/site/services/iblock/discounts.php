...
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/".LANGUAGE_ID."/discounts.xml"; 
$iblockCode = "DISCOUNTS"; 
...
CWizardUtil::ReplaceMacros($bitrixTemplateDir."/header.php", array('DISCOUNTS_ID' => $iblockID));
