...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/index.php", array('INNET_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/index.php", array('INNET_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/.left.menu.php", array('INNET_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/.top_child.menu.php", array('INNET_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('INNET_IBLOCK_ID_PROJECTS' => $iblockID));
