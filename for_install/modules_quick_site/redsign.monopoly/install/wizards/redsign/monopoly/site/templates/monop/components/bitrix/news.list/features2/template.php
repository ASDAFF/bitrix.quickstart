...
if(is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0) {
	...
	?><div class="<?if($arParams['RSMONOPOLY_USE_OWL']=='Y'):?>owl<?else:?>row<?endif;?> features features2" <?
			...
			?><div class="item<?if($arParams['RSMONOPOLY_USE_OWL']!='Y'):?> col col-md-<?=$arParams['RSMONOPOLY_COLS_IN_ROW']?><?endif;?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>"><?
				?><div class="row"><?
					?><div class="col col-md-12"><?
						?><a class="clearfix" href="<?=$arItem['PROPERTIES'][$arParams['RSMONOPOLY_LINK']]['VALUE']?>"<?if($arItem['PROPERTIES'][$arParams['RSMONOPOLY_BLANK']]['VALUE']!=''):?> target="_blank"<?endif;?>><?
							?><div class="image"><?
							...
							?></div><?
							?><div class="data"><?
								?><div class="name robotolight"><?=$arItem['NAME']?></div><?
