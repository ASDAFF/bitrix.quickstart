...
<div class="b-cart__list clearfix">
    ...
    <div class="b-cart-field m-cart-field__first">
        ...
        <input type="password" name="NEW_PASSWORD" class="b-cart-field__input">
        <label class="b-cart-field__label">Повтор пароля <span class="b-star">*</span></label>
        <input type="password" name="NEW_PASSWORD_CONFIRM" class="b-cart-field__input">
    </div>
    <div class="b-cart-field">
        ...
        <input type="text" name="NEW_LOGIN" class="b-cart-field__input" value="<?=$arResult["POST"]["NEW_LOGIN"]?>">
        <label class="b-cart-field__label">E-mail  (логин) <span class="b-star">*</span></label>
        ...
        <input type="text" class="b-cart-field__input" name="NEW_NAME" class="b-cart-field__input" value="<?=$arResult["POST"]["NEW_NAME"]?>">
