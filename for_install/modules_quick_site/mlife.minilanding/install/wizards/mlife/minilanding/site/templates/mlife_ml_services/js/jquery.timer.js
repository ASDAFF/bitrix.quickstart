...
function initcount(elem, options){
	...
	$.each(['Days','Hours','Minutes','Seconds'],function(i){
		...
		$('.count'+this).html('<span class="position"><span class="digit static">0</span></span><span class="position"><span class="digit static">0</span></span><span class="countDiv countDiv'+i+'">'+texxt+'</span>');
	});
