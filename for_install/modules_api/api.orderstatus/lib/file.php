	...
	public static function getMap()
	{
		return array(
			'ID'          => new Main\Entity\IntegerField('ID', array(
				'primary'      => true,
				'autocomplete' => true,
				'title'        => Loc::getMessage('AOS_FILE_ID'),
			)),
			'ORDER_ID'    => new Main\Entity\IntegerField('ORDER_ID', array(
				'title' => Loc::getMessage('AOS_FILE_ORDER_ID'),
			)),
			'FILE_ID'      => new Main\Entity\StringField('FILE_ID', array(
				'title' => Loc::getMessage('AOS_FILE_FILE_ID'),
			)),
		);
	}

	/**
	 * Returns file list for order
	 *
	 * @param $orderId
	 *
	 * @return array
	 */
	public static function getOrderFiles($orderId)
	{
		...
		{
			$arOrderFiles = Main\FileTable::getList(array(
				'filter' => array('=MODULE_ID' => 'api.orderstatus', '=ID' => $arFilesId)
			))->fetchAll();
		}
