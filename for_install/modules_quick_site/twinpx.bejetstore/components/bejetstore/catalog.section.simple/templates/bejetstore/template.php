...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	<div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?> bj-ce-no-scu"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
	...
	<div class="row bj-product-card__cart">
		...
		<?if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
		{
			...
			<div class="col-xs-6">
				...
				?></a-->
				<a class="btn btn-default" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><? echo ('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY')); ?></a>
			</div><?
			}
			else
			{
				?>
			<div class="col-xs-6">
				<span class="btn btn-default visible-xs-inline-block"><?
				echo ('' != $arParams['MESS_NOT_AVAILABLE'] ? $arParams['MESS_NOT_AVAILABLE'] : GetMessage('CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE'));
				?></span>
				<span class="btn btn-default "><?echo ('' != $arParams['MESS_NOT_AVAILABLE'] ? $arParams['MESS_NOT_AVAILABLE'] : GetMessage('CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE'));?></span>
			</div><?
			}
		...
		else
		{
			...
			{?>
			<div class="col-xs-6">
				<!--a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn btn-default visible-xs-inline-block" href="javascript:void(0)" rel="nofollow"><?
				echo ('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY'));
				?></a-->
				<a class="btn btn-default" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><? echo ('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY')); ?></a>
			</div><?
			...
			?><div class="bx_catalog_item_controls touch">
				...
				?></a-->
				<a class="btn btn-default visible-xs-inline-block" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><? echo ('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY')); ?></a>
			</div><?
			}
		}?>		
	</div>
...
var <? echo $strObName; ?> = new JCCatalogSection(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
	...
	<?if($i % $arParams["LINE_ELEMENT_COUNT"] == ($arParams["LINE_ELEMENT_COUNT"] - 1)):$bOpen = false;?></div><?if($count != $i + 1):?><hr class="i-line i-size-L"><?endif;?><?endif;?>
	<?$i++;
}
?><?if($bOpen):?></div><?endif;?>
...
?>
<script>
$('.bj-ce-no-scu').each(function(i,elem) {
