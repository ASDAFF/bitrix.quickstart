...
if(COption::GetOptionString("mono", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	COption::SetOptionString("mono", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
	$shopLocation = $wizard->GetVar("shopLocation");
	COption::SetOptionString("mono", "shopLocation", $shopLocation, false, WIZARD_SITE_ID);
	$shopOfName = $wizard->GetVar("shopOfName");
	COption::SetOptionString("mono", "shopOfName", $shopOfName, false, WIZARD_SITE_ID);
	...
	$paysystem = $wizard->GetVar("paysystem");
		...
		COption::SetOptionString("mono", "shopINN", $shopINN, false, WIZARD_SITE_ID);
		$shopKPP = $wizard->GetVar("shopKPP");
		COption::SetOptionString("mono", "shopKPP", $shopKPP, false, WIZARD_SITE_ID);
		$shopNS = $wizard->GetVar("shopNS");
		COption::SetOptionString("mono", "shopNS", $shopNS, false, WIZARD_SITE_ID);
		$shopBANK = $wizard->GetVar("shopBANK");
		COption::SetOptionString("mono", "shopBANK", $shopBANK, false, WIZARD_SITE_ID);
		$shopBANKREKV = $wizard->GetVar("shopBANKREKV");
		COption::SetOptionString("mono", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID);
		$shopKS = $wizard->GetVar("shopKS");
		COption::SetOptionString("mono", "shopKS", $shopKS, false, WIZARD_SITE_ID);
		$siteStamp = $wizard->GetVar("siteStamp"); 
		COption::SetOptionString("mono", "siteStamp", $siteStamp, false, WIZARD_SITE_ID);
 

	$shopAdr = $wizard->GetVar("shopAdr");
	COption::SetOptionString("mono", "shopAdr", $shopAdr, false, WIZARD_SITE_ID);
	$siteTelephone = $wizard->GetVar("siteTelephone");
	COption::SetOptionString("mono", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID);
	$shopEmail = $wizard->GetVar("shopEmail");
	COption::SetOptionString("mono", "shopEmail", $shopEmail, false, WIZARD_SITE_ID);
	$siteName = $wizard->GetVar("siteName");
	COption::SetOptionString("mono", "siteName", $siteName, false, WIZARD_SITE_ID);
//SocNets
	$shopFacebook = $wizard->GetVar("shopFacebook");
	COption::SetOptionString("mono", "shopFacebook", $shopFacebook, false, WIZARD_SITE_ID);
	$shopTwitter = $wizard->GetVar("shopTwitter");
	COption::SetOptionString("mono", "shopTwitter", $shopTwitter, false, WIZARD_SITE_ID);
	$shopGooglePlus= $wizard->GetVar("shopGooglePlus");
	COption::SetOptionString("mono", "shopGooglePlus", $shopGooglePlus, false, WIZARD_SITE_ID);
	if (LANGUAGE_ID == "ru")
	{
		$shopVk = $wizard->GetVar("shopVk");	
		COption::SetOptionString("mono", "shopVk", $shopVk, false, WIZARD_SITE_ID);
	}
