...
use \Lema\Sberbank\HttpClient\CurlClient;
use \Lema\Sberbank\HttpClient\HttpClientInterface;
use \Lema\Sberbank\OrderStatus;
...
class Client
{
    ...
    public function getLastOrdersForMerchants(\DateTime $from, \DateTime $to = null, array $data = array())
    {
        ...
        $data['transactionStates'] = array_map('\Lema\Sberbank\OrderStatus::statusToString', $data['transactionStates']);
