...
$defaultListValues = array('-' => getMessage('RS_ONAIR.UNDEFINED'));
$arIBlock=array();
...
$arTemplateParameters = array(
	'DISPLAY_DATE' => Array(
		'NAME' => getMessage('RS_ONAIR.NEWS_DATE'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'DISPLAY_NAME' => Array(
		'NAME' => getMessage('RS_ONAIR.NEWS_NAME'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'DISPLAY_PICTURE' => Array(
		'NAME' => getMessage('RS_ONAIR.NEWS_PICTURE'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'DISPLAY_PREVIEW_TEXT' => Array(
		'NAME' => getMessage('RS_ONAIR.NEWS_TEXT'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'GROUP_BY_ABC' => array(
		'NAME' => getMessage('RS_ONAIR.GROUP_BY_ABC'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
	),
	'SHOW_PARENT' => array(
		'NAME' => getMessage('RS_ONAIR.SHOW_PARENT'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
	),
	'SECTION_PAGE_MORE_URL' => array(
		'NAME' => getMessage('RS_ONAIR.SECTION_PAGE_MORE_URL'),
		'TYPE' => 'STRING',
		'DEFAULT' => '',
	),
	'SECTION_PAGE_MORE_TEXT' => array(
		'NAME' => getMessage('RS_ONAIR.SECTION_PAGE_MORE_TEXT'),
		'TYPE' => 'STRING',
		'DEFAULT' => getMessage('RS_ONAIR.SECTION_PAGE_MORE_DEFAULT'),
	),
	'LINKED_PROP' => array(
		'NAME' => getMessage('RS_ONAIR.LINKED_PROP'),
		'TYPE' => 'LIST',
		'VALUES' => array_merge($defaultListValues, $arProperty),
		'DEFAULT' => '-',
	),
	'CATALOG_IBLOCK_ID' => array(
		'NAME' => getMessage('RS_ONAIR.CATALOG_IBLOCK_ID'),
		'TYPE' => 'LIST',
		'ADDITIONAL_VALUES' => 'Y',
		'VALUES' => $arIBlock,
		'REFRESH' => 'Y',
...
if (0 < $CATALOG_IBLOCK_ID) {
	...
	$arTemplateParameters['CATALOG_URL'] = array(
		'NAME' => getMessage('RS_ONAIR.CATALOG_URL'),
		'TYPE' => 'STRING',
		'DEFAULT' => 'catalog/',
	);
	$arTemplateParameters['CATALOG_FILTER_NAME'] = array(
		'NAME' => getMessage('RS_ONAIR.CATALOG_FILTER_NAME'),
		'TYPE' => 'STRING',
		'DEFAULT' => 'arrFilter',
	);
	$arTemplateParameters['CATALOG_LINKED_PROP'] = array(
		'NAME' => getMessage('RS_ONAIR.CATALOG_LINKED_PROP'),
		'TYPE' => 'LIST',
