...
if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
	$arLocationArr = Array();
...
COption::SetOptionString("redsign.flyaway", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>