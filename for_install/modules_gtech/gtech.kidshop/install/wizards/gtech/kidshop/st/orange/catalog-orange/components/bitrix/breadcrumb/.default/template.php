...
$strReturn = '<div id="breadcrumb"><a title="'.GetMessage('BREADCRUMB_MAIN').'" href="'.SITE_DIR.'"><img width="12" height="11" src="'.SITE_TEMPLATE_PATH.'/images/home.gif" alt="'.GetMessage('BREADCRUMB_MAIN').'" /></a>';
