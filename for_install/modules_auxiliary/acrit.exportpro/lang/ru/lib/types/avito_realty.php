...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_CATEGORY"] = "Категория объявления<br><b class='required'>Обязательный элемент</b>";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_REGION"] = "Дата конца экспозиции объявления<br>(Значение из Справочника регионов)<br><b class='required'>Обязательный элемент</b>";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_REGION"] = "Город или населенный пункт,<br>в котором находится объект объявления<br>(Значение из Справочника городов)<br><b class='required'>Обязательный элемент</b>";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_SUBWAY"] = "Станция метро<br>(Значение из Cправочника метро)";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_DESCRIPTION"] = "Описание ";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_PRICE"] = "Цена в рублях";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_CONTACTPHONE"] = "Контактный телефон, если не указан,<br>подставляется из данных клиента.";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_ADSTATUS"] = "Статус объявления. Возможные значения:<br><b>Free, Premium, VIP, Highlight, PushUp, QuickSale, TurboSale</b>";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_LANDAREA"] = "Площадь земли в сотках";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_OBJECTSUBTYPE"] = "Тип гаража,<br> только если вид объекта — Гараж<br><b>Возможные значения:<ul>
<li>Железобетонный</li>
<li>Кирпичный</li>
<li>Металлический</li>
</ul></b>";

$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_SECURED"] = "Охраняемое место или гараж";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_STREET"] = "Наименование улицы, на которой<br>находится объект объявления";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_ROOMS"] = "Количество комнат в квартире<br><b class='required'>Обязательный элемент</b>";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_SQUARE"] = "Площадь комнаты (в м.кв.)<br>Если продается/сдается несколько комнат,<br>указывается их суммарная площадь<br><b class='required'>Обязательный элемент</b>";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_MARKETTYPE"] = "Принадлежность квартиры к рынку новостроек<br> или вторичному,
...
";
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_LEASETYPE"] = "Тип аренды,только для типа 'Сдам'<br><b>Возможные значения:<ul>
<li>Долгосрочная</li>
<li>Посуточная</li>
</ul></b>
";
...
$MESS["ACRIT_EXPORTPRO_AVITO_REALTY_FIELD_LEASEADDITIONALLYOPTION"] = "Только для аренды: опции Комфорт — вложенные элементы Option с возможными значениями из списка:<br><br>
