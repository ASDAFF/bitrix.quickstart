...
class SotaParserContent extends SotaParserContentGeneral
{
        ...
        foreach ($aSort as $key => $ord) {
            ...
            switch ($key) {
                case "ID":
                    ...
                    break;
                case "TYPE":
                    $arOrder[$key] = "P.TYPE " . $ord;
                    break;
                case "TIMESTAMP":
                    $arOrder[$key] = "P.TIMESTAMP_X " . $ord;
                    break;
                case "NAME":
                    $arOrder[$key] = "P.NAME " . $ord;
                    break;
                case "RSS":
                    $arOrder[$key] = "P.RSS " . $ord;
                    break;
                case "ACTIVE":
                    $arOrder[$key] = "P.ACTIVE " . $ord;
                    break;
                case "IBLOCK_ID":
                    $arOrder[$key] = "P.IBLOCK_ID " . $ord;
                    break;
                case "ENCODING":
                    $arOrder[$key] = "P.ENCODING " . $ord;
                    break;
                case "START_AGENT":
                    $arOrder[$key] = "P.START_AGENT " . $ord;
                    break;
                case "TIME_AGENT":
                    $arOrder[$key] = "P.TIME_AGENT " . $ord;
                    break;
                case "SORT":
                    $arOrder[$key] = "P.SORT " . $ord;
                    break;
                case "START_LAST_TIME":
                    $arOrder[$key] = "P.START_LAST_TIME_X " . $ord;
                    break;
                case "CATEGORY_ID":
                    $arOrder[$key] = "P.CATEGORY_ID " . $ord;
                    break;
            }
        }
        if (count($arOrder) == 0)
