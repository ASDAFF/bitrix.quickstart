...
if (is_array($arResult['ITEMS']) && count($arResult['ITEMS']) > 0) {
    ...
    foreach ($arResult['ITEMS'] as $key1 => $arItem) {
        ...
        $this->AddDeleteAction(
            ...
            array('CONFIRM' => Loc::getMessage('CT_BCS_ELEMENT_DELETE_CONFIRM'))
        );
        ...
        ?><div class="view-case products__item <?
            ?>col <?
            ?><?=($arParams['PARAM_VIEW_MOB'] == 'Y' ? '' : 'half')?> <?
            ?><?=($IS_PREVIEW_TEXT == 'Y' ? 'products__item_wide' : '')?> <?
                        ...
                        <div class="products__data"><?
                            ...
                            ?><div class="products__detail"><?
                                ...
                                ?><div class="row clearfix quantity-wrapper"><?
                                    ?><div class="col col-xs-5 col-left"><?
                                    ...
                                    if ($arParams['USE_STORE'] == 'Y'):
                                        ?><div class="col col-xs-7 col-right text-right pull-right"><?
