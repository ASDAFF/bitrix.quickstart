...
$MESS['ACRIT_EXPORTPRO_SCHEME_TAGS_DESCRIPTION'] = "
    ...
    Название #ПОЛЕЙ-ЭКСПОРТА# может быть любым, за исключением <b>#MARKET_CATEGORY#</b>.<br><br>
    <b>#MARKET_CATEGORY#</b> - Категория соответствующая спецификации торговой площадки на вкладке \"Категории торговой площадки\"<br>
";
