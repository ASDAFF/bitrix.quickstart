...
if(COption::GetOptionString("shoplight", "wizard_installed", "N", WIZARD_SITE_ID) == "N" || WIZARD_INSTALL_DEMO_DATA)
{
...
___writeToAreasFile(WIZARD_SITE_PATH."include/company_support.php", $wizard->GetVar("siteTelephone"));


if(COption::GetOptionString("shoplight", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
	return;
