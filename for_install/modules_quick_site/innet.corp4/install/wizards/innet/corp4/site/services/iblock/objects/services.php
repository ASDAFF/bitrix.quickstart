...
$iblockType = "innet_objects_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/index.php", array('INNET_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/index.php", array('INNET_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/.left.menu.php", array('INNET_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/.top_child.menu.php", array('INNET_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array('INNET_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/header.php", array('INNET_IBLOCK_ID_SERVICES' => $iblockID));
?>