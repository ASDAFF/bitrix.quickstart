...
<div class="vertical hc-tabs">
	<div class="hc-tabs-top">
		<img data-tab="#hctab1" src="#SITE_DIR#images/content.jpg" alt="BusinessCard" data-tab-animation-effect="fadeInRightSmall">
		<img data-tab="#hctab2" src="#SITE_DIR#images/content.jpg" alt="BusinessCard" data-tab-animation-effect="fadeInRightSmall">
		<img data-tab="#hctab3" src="#SITE_DIR#images/content.jpg" alt="BusinessCard" data-tab-animation-effect="fadeInRightSmall">
		<img data-tab="#hctab4" src="#SITE_DIR#images/content.jpg" alt="BusinessCard" data-tab-animation-effect="fadeInRightSmall">
		<div class="space-bottom"></div>
	</div>	
...
<div class="space-bottom"></div>
<h2>BusinessCard Progress Bars</h2>
<div class="space-bottom"></div>
<div class="progress">
