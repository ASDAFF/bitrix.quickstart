...
<tr>
	<td width="50%"><label for="save_product_without_price_y"><? echo GetMessage("CAT_SAVE_PRODUCTS_WITHOUT_PRICE"); ?></label></td>
	<td width="50%"><input type="hidden" name="save_product_without_price" id="save_product_without_price_n" value="N"><input type="checkbox" name="save_product_without_price" id="save_product_without_price_y" value="Y"<?if ('Y' == $strSaveProductWithoutPrice) echo " checked";?>></td>
</tr>
<tr class="heading">
	<td colspan="2" valign="top" align="center"><? echo GetMessage("CAT_STORE") ?></td>
</tr>
<tr>
	<td width="50%"><label for="quantity_trace_y"><? echo GetMessage("CAT_QUANTITY_TRACE"); ?></label></td>
	<td width="50%"><input type="hidden" name="quantity_trace" id="quantity_trace_n" value="N"><input type="checkbox" name="quantity_trace" id="quantity_trace_y" value="Y"<?if($strQuantityTrace == "Y")echo " checked";?>></td>
</tr>
<tr>
	<td width="50%"><label for="allow_can_buy_zero_y"><? echo GetMessage("CAT_ALLOW_CAN_BUY_ZERO"); ?></label></td>
	<td width="50%"><input type="hidden" name="allow_can_buy_zero" id="allow_can_buy_zero_n" value="N"><input type="checkbox" name="allow_can_buy_zero" id="allow_can_buy_zero_y" value="Y"<?if($strAllowCanBuyZero == "Y")echo " checked";?>></td>
</tr>
<tr>
	<td width="50%"><label for="allow_negative_amount_y"><? echo GetMessage("CAT_ALLOW_NEGATIVE_AMOUNT"); ?></label></td>
	<td width="50%"><input type="hidden" name="allow_negative_amount" id="allow_negative_amount_n" value="N"><input type="checkbox" name="allow_negative_amount" id="allow_negative_amount_y" value="Y"<?if($strAllowNegativeAmount == "Y")echo " checked";?>></td>
</tr><?
...
?>
<tr>
	<td width="50%"><label for="discount_vat_y"><? echo GetMessage("CAT_DISCOUNT_VAT"); ?></label></td>
	<td width="50%"><input type="hidden" name="discount_vat" id="discount_vat_n" value="N"><input type="checkbox" name="discount_vat" id="discount_vat_y" value="Y"<?if ('Y' == $strDiscountVat) echo " checked";?>></td>
</tr>
<?
*/
?>
<tr>
	<td width="50%"><label for="discsave_apply"><? echo GetMessage("CAT_DISCSAVE_APPLY"); ?></label></td>
	<td width="50%">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="internal">
	...
	foreach ($arIBlockFullInfo as $res)
	{
		...
		<tr>
			...
			<td align="center" style="text-align: center;"><input type="checkbox" name="IS_CATALOG_<?echo $res["ID"] ?>" onclick="ib_checkFldActivity('<?=$res['ID']?>', 0)" <?if ('Y' == $res['IS_CATALOG']) echo 'checked="checked"'?> <?php if ('Y' == $res['IS_OFFERS']) echo 'disabled="disabled"'; ?>value="Y" /></td>
			...
			<td align="center" style="text-align: center;"><input type="checkbox" name="IS_CONTENT_<?echo $res["ID"] ?>" onclick="ib_checkFldActivity('<?=$res['ID']?>', 1)" <?if ('Y' == $res["IS_CONTENT"]) echo "checked"?> value="Y" /></td>
			<td align="center" style="text-align: center;"><input type="checkbox" name="YANDEX_EXPORT_<?echo $res["ID"] ?>" <?if ('N' == $res['IS_CATALOG']) echo 'disabled="disabled"';?> <?if ('Y' == $res["YANDEX_EXPORT"]) echo "checked"?> value="Y" /></td>
