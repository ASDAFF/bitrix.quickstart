...
$APPLICATION->SetAdditionalCSS($templateFolder.'/style.custom.css', true);
$this->addExternalJs($templateFolder.'/order_ajax.js');
$this->addExternalJs($templateFolder.'/order_ajax.custom.js');
    ...
    <div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
        ...
        <div class="col-sm-9 bx-soa">
            ...
            <div id="bx-soa-orderSave" class="hidden-xs">
                <a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn2">
                <?=$arParams['MESS_ORDER']?>
                </a>
            </div>
...
<script type="text/javascript">
    ...
    RS.Sale.OrderAjaxComponent.init({
...
<script>
    (function bx_ymaps_waiter(){
    	if (typeof ymaps !== 'undefined')
    		ymaps.ready(BX.proxy(RS.Sale.OrderAjaxComponent.initMaps, RS.Sale.OrderAjaxComponent));
    	else
    ...
    (function bx_counter_waiter(i){
    	...
    	if (typeof window['yaCounter<?=$arParams['YM_GOALS_COUNTER']?>'] !== 'undefined')
    		R.Sale.OrderAjaxComponent.reachGoal('initialization');
    	else
