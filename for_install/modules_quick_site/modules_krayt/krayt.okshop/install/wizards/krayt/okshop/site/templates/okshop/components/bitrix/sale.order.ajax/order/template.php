...
<div class="bx_order_make">
	...
	else
	{
		...
		else
		{
			...
			<div class="bx_ordercart_order_pay_center"><a href="javascript:void();" onClick="submitForm('Y'); return false;" class="checkout bg-blue-gradient"><?=GetMessage("SOA_TEMPL_BUTTON")?></a></div>
