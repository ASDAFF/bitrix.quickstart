...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/students_files.xml"; 
$iblockCode = "students_files_".WIZARD_SITE_ID; 
$iblockCodeOriginal = "students_files"; 
$iblockType = "library"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "students_files"';
        return;
    }
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/students/teaching_materials/index.php", Array("STUDENTS_FILES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/parents/teaching_materials/index.php", Array("STUDENTS_FILES_IBLOCK_ID" => $iblockID));
?>
