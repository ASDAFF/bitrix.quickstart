...
$strReturn = '<div id="breadcrumb" class="bread_crumbs">';
$strReturn .= '<a href="'.SITE_DIR.'">'.GetMessage('BREADCRUMB_MAIN').'</a><span class="arrow">&nbsp;</span> ';
...
for($index = 0, $itemSize = $num_items; $index < $itemSize; $index++)
{
	...
	if($arResult[$index]["LINK"] <> "" && $index != $itemSize-1)
		$strReturn .= '<a href="'.$arResult[$index]["LINK"].'" title="'.$title.'">'.$title.'</a><span class="arrow">&nbsp;</span> ';
	else
