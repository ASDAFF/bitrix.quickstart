...
<div class="b-catalog-list_list clearfix" id="<?=$this->GetEditAreaId($arElement['ID']);?>">
    ...
    <div class="b-catalog-list_list__info"> 
            ...
            <p>Путь: <a href="<?=$arElement['SECTION_PAGE_URL'];?>"><?=$arElement['PATH_NAME']?></a></p>
    </div>
    <div class="b-catalog-list_list__where">
          <?foreach($arElement['PROPERTIES']['SHOP']["VALUE_XML_ID"] as $k=>$shop){?>
                                <span title="<?=$arElement['PROPERTIES']['SHOP']['VALUE'][$k]?>" class="b-where__icon <?=$shop;?>"></span>
                            <?}?> 
...
<? if ($arPrice["DISCOUNT_VALUE"] < $arPrice["VALUE"]): ?>
        <span class="b-price m-price__list"><?= $arPrice["PRINT_DISCOUNT_VALUE"] ?></span>
