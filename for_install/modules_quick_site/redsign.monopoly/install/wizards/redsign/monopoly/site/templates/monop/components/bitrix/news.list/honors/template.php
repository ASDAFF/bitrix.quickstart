...
if( is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0 ) {
	...
	?><div class="<?if($arParams['RSMONOPOLY_USE_OWL']=='Y'):?>owl<?else:?>row<?endif;?> honors" <?
			...
			?><div class="item<?if($arParams['RSMONOPOLY_USE_OWL']!='Y'):?> col col-md-<?=$arParams['RSMONOPOLY_COLS_IN_ROW']?><?endif;?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>"><?
				?><div class="row"><?
					?><div class="col col-md-12"><?
						...
						?></div><?
						?><div class="data"><?
							?><div class="info<?if( $arParams['RSMONOPOLY_SHOW_DATE']=='Y' && $arItem['DISPLAY_ACTIVE_FROM']!='' ):?> smaller<?endif;?>"><?
								?><div class="name"><a class="aprimary robotolight" href="<?=$arItem['DETAIL_PICTURE']['SRC']?>" target="_blank"><?=$arItem["NAME"]?></a></div><?
