...
if (!in_array($wizrdTemplateId, array("store_software"))) $wizrdTemplateId = "store_software"; 
COption::SetOptionString("main", "wizard_template_id", $wizrdTemplateId, false, WIZARD_SITE_ID);

// replace macros
WizardServices::ReplaceMacrosRecursive($bitrixTemplateDir, Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros($bitrixTemplateDir.'/css/main.css', Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros($bitrixTemplateDir.'/js/common.min.js', Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros($bitrixTemplateDir.'/js/img_magic.js', Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros($bitrixTemplateDir.'/components/bitrix/menu/left_help/template.php', Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros($bitrixTemplateDir.'/components/bitrix/sale.order.ajax/order-list-mini/template.php', Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros($bitrixTemplateDir.'/components/bitrix/sale.basket.basket.small/basket_small/template.php', Array("SITE_DIR" => WIZARD_SITE_DIR));
?>