...
if(is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0) {
	...
	?><div class="<?if($arParams['RSMONOPOLY_USE_OWL']=='Y'):?>owl<?else:?>row<?endif;?> action" <?
					...
					?><div class="col col-md-12"><?
						?><a class="clearfix" href="<?=$arItem['DETAIL_PAGE_URL']?>"><?
							...
							?><div class="row data"><?
								...
								if(
									$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_MARKER_TEXT']]['DISPLAY_VALUE']!='' ||
									$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_ACTION_DATE']]['DISPLAY_VALUE']!=''
								) {
									?><div class="col col-md-12 markers"><?
										if( $arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_MARKER_TEXT']]['DISPLAY_VALUE']!='' ) {
											?><span class="marker" <?
												if( $arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_MARKER_COLOR']]['DISPLAY_VALUE']!='' ) {
													?> style="background-color: <?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_MARKER_COLOR']]['DISPLAY_VALUE']?>;" <?
												}
											?>><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_MARKER_TEXT']]['DISPLAY_VALUE']?></span><?
										}
										if( $arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_ACTION_DATE']]['DISPLAY_VALUE']!='' ) {
											?><span class="action_date"><?=$arItem['DISPLAY_PROPERTIES'][$arParams['RSMONOPOLY_PROP_ACTION_DATE']]['DISPLAY_VALUE']?></span><?
										}
									?></div><?
								}
								?><div class="col col-md-12 description"><?=$arItem['PREVIEW_TEXT']?></div><?
							?></div><?
						?></a><?
					?></div><?
				?></div><?
