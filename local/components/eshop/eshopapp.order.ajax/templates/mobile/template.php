...
<div id="order_form_div" class="order-checkout">
    ...
    <form action="" method="POST" name="ORDER_FORM" id="ORDER_FORM">
                            ...
                            foreach ($arResult["PERSON_TYPE"] as $v) {
                                ...
                                <li>
                                    ...
                                    if ($v["CHECKED"] == "Y"):?>checked<?endif ?>">
                                        <table>
                                            <tr>
                                                <td><span class="inputradio"><input type="radio"
                                                                                    id="PERSON_TYPE_<?= $v["ID"] ?>"
                                                                                    name="PERSON_TYPE"
                                                                                    value="<?= $v["ID"] ?>"<?
                                                        if ($v["CHECKED"] == "Y") echo " checked=\"checked\""; ?>
                                                                                    onClick="0submitForm()"></span></td>
                                                <td><label for="PERSON_TYPE_<?= $v["ID"] ?>"><?= $v["NAME"] ?></label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
        ...
        <div class="tac">
            <a class="ordering button_red_big" ontouchstart="BX.toggleClass(this, 'active');"
               ontouchend="BX.toggleClass(this, 'active');" href="javascript:void(0)"
               onClick="submitForm('Y');"><?= GetMessage("SOA_TEMPL_BUTTON") ?></a>
