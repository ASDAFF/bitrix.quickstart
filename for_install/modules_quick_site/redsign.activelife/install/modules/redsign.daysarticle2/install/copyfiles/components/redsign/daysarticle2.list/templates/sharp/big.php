			...
			<div class="left_part">
				...
				<div class="time_wrap">
					...
					<? if ($timer["TIMER"]["DAYS"]==0) { ?>
						<div class="digits" data-dateto="<? echo strtotime($arItem['DAYSARTICLE2']['DATE_TO']); ?>">
			...
			<div class="right_part">
				<div class="titles">
					...
					<div class="main">
						...
						<span class="title"><?=GetMessage("DA2_END_TITLE")?></span>
						<div class="progress_bar" style="width: 150px;">
							<div class="progress" style="min-width: 15%; width: <?=$timer["DINAMICA_EX"]["PHP_DATA"]["persent"]?>%;"><?=$timer["DINAMICA_EX"]["PHP_DATA"]["persent"]?>%</div>
						</div>
					</div>
				</div>
