...
<?if($arResult["SECTION_ITEMS"]){?>
<div class = "section_items">
<ul class = "elements_list">
<?foreach($arResult["SECTION_ITEMS"] as $item){?>
<li class = "color1" <?if($item["SELECTED"] == "Y") echo "style = \"font-weight: bold;\""?>><a href = "<?echo $item["DETAIL_PAGE_URL"];?>"><?echo $item["NAME"];?></a></li>
<?}?>
</ul>
</div>
<?}?>
