...
<div class="rs-banners-container js-mainbanners-container <?=$arResult['BANNER_CLASS']?>"
    ...
    <div class="rs-banners-sidebanner __left js-sidebanners <?php echo(in_array("left", $arResult['SELECTED_SIDEBANNERS'])? 'js-sidebanners_selected' : '') ?>" style="opacity: 0; transition: opacity 1s;">
    ...
    <div class="rs-banners-sidebanner __right js-sidebanners <?php echo(in_array("right", $arResult['SELECTED_SIDEBANNERS'])? 'js-sidebanners_selected' : '') ?>" style="opacity: 0; transition: opacity 1s;">
