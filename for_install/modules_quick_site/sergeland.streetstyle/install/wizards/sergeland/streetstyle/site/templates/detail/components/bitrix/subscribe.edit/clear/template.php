...
<div class="subscription">
	...
	<div class="subscription-utility">
		...
		<input name="CONFIRM_CODE" type="text" class="subscription-textbox" value="" data-value="<?=GetMessage("CT_BSE_CONFIRMATION")?>" /> <input type="submit" name="confirm" value="<?=GetMessage("CT_BSE_BTN_CONF")?>" />
	</div>
	<?endif?>
	...
	<div class="subscription-utility">
		...
		<input name="sf_EMAIL" type="text" class="subscription-textbox" value="" data-value="<?=GetMessage("CT_BSE_EMAIL")?>" /> <input type="submit" value="<?=GetMessage("CT_BSE_BTN_SEND")?>" />
	</div>
	</form>
	<?endif?>
