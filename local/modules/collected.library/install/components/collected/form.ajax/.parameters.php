...
$params = array(
    'FORM_CLASS' => array(
        ...
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_FORM_CLASS'),
        'TYPE' => 'STRING',
        'MULTIPLE' => 'N',
        'DEFAULT' => 'ajax-form',
        'REFRESH' => 'N',
    ...
    'FORM_ACTION' => array(
        'PARENT' => 'URL_TEMPLATES',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_FORM_ACTION'),
        'TYPE' => 'STRING',
        'MULTIPLE' => 'N',
        'DEFAULT' => '',
        'REFRESH' => 'N',
    ...
    'FORM_152_FZ' => array(
        'PARENT' => 'URL_TEMPLATES',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_FORM_152_FZ'),
        'TYPE' => 'STRING',
        'MULTIPLE' => 'N',
    ...
    'FORM_BTN_TITLE' => array(
        'PARENT' => 'URL_TEMPLATES',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_FORM_BTN_TITLE'),
        'TYPE' => 'STRING',
        'MULTIPLE' => 'N',
        'DEFAULT' => Loc::getMessage('COLLECT_FORM_AJAX_BTN_SEND'),
        'REFRESH' => 'N',
    ),
    'FORM_SUCCESS_FUNCTION' => array(
        'PARENT' => 'URL_TEMPLATES',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_FORM_SUCCESS_FUNCTION'),
        'TYPE' => 'STRING',
        'MULTIPLE' => 'N',
    ...
    'FORM_SUCCESS_FUNCTION_CORRECT_JSON' => array(
        'PARENT' => 'URL_TEMPLATES',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_FORM_SUCCESS_FUNCTION_CORRECT_JSON'),
        'TYPE' => 'CHECKBOX',
        'MULTIPLE' => 'N',
        'DEFAULT' => 'Y',
        'REFRESH' => 'N',
    ...
    'NEED_SAVE_TO_IBLOCK' => array(
        ...
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_NEED_SAVE_TO_IBLOCK'),
        'TYPE' => 'CHECKBOX',
        'MULTIPLE' => 'N',
        'DEFAULT' => 'Y',
        'REFRESH' => 'Y',
...
)
{
    $params['IBLOCK_TYPE'] = array(
        'PARENT' => 'SAVE_TO_IBLOCK',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_IBLOCK_TYPE'),
        'TYPE' => 'LIST',
        'VALUES' => $iblockTypes,
        'DEFAULT' => 'news',
        'REFRESH' => 'Y',
    ...
    $params['IBLOCK_ID'] = array(
        'PARENT' => 'SAVE_TO_IBLOCK',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_IBLOCK_ID'),
        'TYPE' => 'LIST',
        'VALUES' => $iblockIds,
        'DEFAULT' => 'news',
        'REFRESH' => 'Y',
...
$params['NEED_SEND_EMAIL'] = array(
    'PARENT' => 'SEND_EMAIL',
    'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_NEED_SEND_EMAIL'),
    'TYPE' => 'CHECKBOX',
    'MULTIPLE' => 'N',
    'DEFAULT' => 'Y',
    'REFRESH' => 'Y',
...
)
{
    $params['EVENT_TYPE'] = array(
        'PARENT' => 'SEND_EMAIL',
        'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_EVENT_TYPE'),
        'TYPE' => 'LIST',
        'VALUES' => $emailTypes,
        'DEFAULT' => 'news',
        'REFRESH' => 'N',
...
/*$params['CACHE_GROUPS'] = array(
    ...
    'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_CACHE_GROUPS'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
);*/
...
$params['FORM_FIELDS'] = array(
    'PARENT' => 'URL_TEMPLATES',
    'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_IBLOCK_FIELDS'),
    'TYPE' => 'CUSTOM',
...
$arComponentParameters = array(
    'GROUPS' => array(
        'SAVE_TO_IBLOCK' => array(
            'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_SAVE_TO_IBLOCK'),
            'SORT' => '500',
        ),
        'SEND_EMAIL' => array(
            'NAME' => Loc::getMessage('COLLECT_FORM_AJAX_SEND_EMAIL'),
            'SORT' => '500',
        ),
    ),
    'PARAMETERS' => $params,
