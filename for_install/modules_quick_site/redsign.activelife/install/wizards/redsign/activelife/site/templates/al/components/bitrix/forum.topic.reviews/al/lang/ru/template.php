...
$MESS["CHANGE_IMG_REVIEWS"] = "Сменить изображение";
$MESS["REQUIRES_INPUT"] = " поля обязательные для заполнения &nbsp;&nbsp;";
$MESS["FORUM_SHOW_FULL_TEXT"] = "показать целиком";
$MESS["FORUM_SHOW_NOT_FULL_TEXT"] = "свернуть";
...
$MESS['POST_MSG_ASSESSMENT'] = 'Оценка';
$MESS['RS.FLYAWAY.REVIEW_RATING'] = 'Оценка';
$MESS['POST_LINK'] = 'Подробнее';
$MESS['POST_LINK_CLOSE'] = 'Скрыть';