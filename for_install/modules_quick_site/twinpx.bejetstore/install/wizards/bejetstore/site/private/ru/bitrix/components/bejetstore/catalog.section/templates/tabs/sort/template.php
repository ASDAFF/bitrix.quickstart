...
<div class="col-sm-6">
	<div class="bj-sorting">
		...
		<a href="<?=$APPLICATION->GetCurPageParam("sort=default",array("sort"));?>" class="btn bj-reset-button" title="<?=GetMessage("SORT_RESET")?>" data-toggle="tooltip" data-placement="top"></a>
