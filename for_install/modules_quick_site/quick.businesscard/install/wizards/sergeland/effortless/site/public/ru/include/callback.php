			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="text-center">
						<a href="#" class="btn btn-lg <?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["CALLBACK_BUTTON"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["CALLBACK_BUTTON"] : COption::GetOptionString("effortless", "QUICK_THEME_CALLBACK_BUTTON", "btn-default", SITE_ID))?>" data-toggle="modal" data-target=".FEEDBACK">Задать вопрос</a>
					</div>
				</div>
			</div>
		</div>
