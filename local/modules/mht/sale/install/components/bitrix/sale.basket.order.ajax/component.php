		...
		if ('' == $errorMessage)
		{
			...
			if ($ORDER_ID > 0 && empty($arErrors))
			{
				...
				$dbBasketItems = CSaleBasket::GetList(
					...
					false,
					array(
						"ID", "CALLBACK_FUNC", "MODULE", "PRODUCT_ID", "QUANTITY", "DELAY", "CAN_BUY", "PRICE", "WEIGHT",
						"NAME", "DISCOUNT_PRICE", "CURRENCY", "PRODUCT_PROVIDER_CLASS", "DIMENSIONS", "TYPE", "SET_PARENT_ID"
					)
				);
