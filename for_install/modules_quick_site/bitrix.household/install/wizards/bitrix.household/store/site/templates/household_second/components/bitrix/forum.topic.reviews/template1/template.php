...
?>
<div class="group_item reviews-block-container reviews-reviews-block-container">
...
?>
	...
	<?
		...
		?><div class="reviews-message-img"><?
			?><p><?$GLOBALS["APPLICATION"]->IncludeComponent(
...
?>
		...
		<div class="inf">
			<a name="message<?=$res["ID"]?>"></a><p><?=$res["POST_DATE"]?>&nbsp;&nbsp;<span class="name">
	<?
...
<div class="add_review">
	<a onClick="document.getElementById('reviews-reply-form').style.display = document.getElementById('reviews-reply-form').style.display == 'none' ? 'block' : 'none'; return false;" href="#"><img border="0" src="<?=SITE_TEMPLATE_PATH?>/images/make_otz.png" width="139px" height="19px" alt="Добавить отзыв" /></a>
</div>

<div class="reviews-reply-form" id="reviews-reply-form" style="display: none;">
...
<form name="REPLIER<?=$arParams["form_index"]?>" id="REPLIER<?=$arParams["form_index"]?>" action="<?=POST_FORM_ACTION_URI?>#feedback"<?
