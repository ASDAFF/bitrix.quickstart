...
$arRECOMENDATION_TYPE = array(
	'PERSONAL' => GetMessage('RECOMENDATION_TYPE_PERSONAL'),
	'STORE' => GetMessage('RECOMENDATION_TYPE_STORE'),
);
$arTemplateParameters['RECOMENDATION_TYPE'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RECOMENDATION_TYPE'),
	'TYPE' => 'LIST',
	'DEFAULT' => 'STORE',
	'VALUES' => $arRECOMENDATION_TYPE
); 
