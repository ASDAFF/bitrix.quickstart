...
if(is_array($arResult["ITEMS"]) && count($arResult["ITEMS"])>0) {
	...
	?><div class="row news"><?
		...
		foreach($arResult["ITEMS"] as $arItem) {
			...
			?><div class="news-item col col-md-12" id="<?=$this->GetEditAreaId($arItem['ID']);?>"><?
				?><div class="row"><?
					?><div class="col col-sm-3 col-md-2 news-image"><?
					...
					?><div class="col col-md-10 data"><?
						...
						?><div class="news-name aprimary"><a class="aprimary" href="<?=$arItem['DETAIL_PAGE_URL']?>"><?=$arItem['NAME']?></a></div><?
						?><div class="news-description"><a href="<?=$arItem['DETAIL_PAGE_URL']?>"><?=$arItem['PREVIEW_TEXT']?></a></div><?
					?></div><?
				?></div><?
			?></div><?
		}
