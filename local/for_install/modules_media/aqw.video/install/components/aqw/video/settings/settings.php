...
__IncludeLang($_SERVER['DOCUMENT_ROOT'] . '/bitrix/components/aqw/video/lang/' . LANGUAGE_ID . '/settings.php');
...
?>
    <script type="text/javascript" src="/bitrix/components/aqw/video/settings/serialize-0.2.js"></script>
<?
...
?>
    <div>
        <table width="700">
            <tr>
                <th width="50%">URL</th>
                <th width="50%"><?= GetMessage('MYMV_SET_TITLE') ?></th>
            </tr>
            <?
            $ITERATION = 0;
