...
Class redsign_grupper extends CModule
{
    ...
    function DoInstall()
    {
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.grupper/install/install.php");
    }
    ...
    function DoUninstall()
    {
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.grupper/install/uninstall.php");
    }
}
?>