...
$MESS["DEFATOOLS_IB_DEMO_ADD_ELS_IN_EXISTED_SEC"] = "Добавлять элементы в<br>существующие разделы";
$MESS["DEFATOOLS_IB_DEMO_ELEMENT_OWNER_CHECK_FAILS"] = "Элемент является частью демо-данных. Изменять его может только владелец (тот, кто его создал). Перед наполнением сайта реальными материалами рекомендуем полностью удалить демо-данные.";
$MESS["DEFATOOLS_IB_DEMO_SECTION_OWNER_CHECK_FAILS"] = "Раздел является частью демо-данных. Изменять его может только владелец (тот, кто его создал). Перед наполнением сайта реальными материалами рекомендуем полностью удалить демо-данные.";
$MESS["DEFATOOLS_IB_DEMO_NO_SECTION_SELECLED"] = "Раздел не выбран";
