                ...
                <div class="alx_feed_back_form_error_block">
                        ...
                        <tr>
                                ...
                                <td class="alx_feed_back_form_error_td_list">
                                        ...
                                        <div class="alx_feed_back_form_error_list"><?=GetMessage("ALX_TP_CORRECT_DATE");?></div>
                                </td>
                        </tr>
                        </table>
                </div>
...
<form id="f_feedback" name="f_feedback_<?=$ALX?>" action="<?=$actionPage?>" method="post" enctype="multipart/form-data">
        ...
        <?endforeach?>
                <?if(in_array("FEEDBACK_TEXT", $arParams["PROPERTY_FIELDS"])):?>
                        <div class="alx_feed_back_form_item_pole<?if(in_array('FEEDBACK_TEXT_'.$ALX, $errorField, true)):?> alx_feed_back_form_error_pole<?endif?>">
                                ...
                                <div class="alx_feed_back_form_textarea_bg"><textarea cols="" rows="" id="EMPTY_TEXT1" name="FEEDBACK_TEXT_<?=$ALX?>"><?=$arResult["FEEDBACK_TEXT"]?></textarea></div></div>
                                <?if(in_array("FEEDBACK_TEXT_".$ALX, $errorField, true)):?>
                                        <div class="alx_feed_back_form_error_text"><?=$arResult["FORM_ERRORS"]["EMPTY_FIELD"]["FEEDBACK_TEXT_".$ALX]?></div>
                                <?endif?>
                        </div>
                <?endif?>
...
<script type="text/javascript">
        $(document).ready(function()
        {
                file_w_<?=$ALX?> = parseInt($("#alx_feed_back_theme3_<?=$ALX?> .alx_feed_back_form_feedback_poles").width()/5);
                <?for($i=1;$i<=$k;$i++):?>
                $("#alx_feed_back_theme3_<?=$ALX?> #alx_feed_back_form_file_input_add<?=$i?>").attr('size', file_w_<?=$ALX?>);
                <?endfor?>
                ...
                <?for($i=1;$i<=$k;$i++):?>
                $("#alx_feed_back_theme3_<?=$ALX?> #alx_feed_back_form_file_input_add<?=$i?>").change(function() {
                        var newpath_<?=$ALX?> = str_replace_<?=$ALX?>("C:\\fakepath\\", "", $("#alx_feed_back_theme3_<?=$ALX?> #alx_feed_back_form_file_input_add<?=$i?>").val());
                        $("#alx_feed_back_theme3_<?=$ALX?> #alx_feed_back_form_filename<?=$i?>").text(newpath_<?=$ALX?>);
                });
                <?endfor?>
        });
</script>
