...
$arTemplateParameters['PRODUCTS_BLOCK'] =  array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("PRODUCTS_BLOCK"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "N",
			"VALUES" => $arAllIBlock,
			"REFRESH" => "N",
...
$arTemplateParameters['GALLERY_STYLE'] = array(
	'PARENT' => 'BASE',
	'NAME' => GetMessage('GALLERY_STYLE'),
	'TYPE' => 'LIST',
	'VALUES' => array(
			'center' => GetMessage('GALLERY_STYLE_CENTER'),
			'left' => GetMessage('GALLERY_STYLE_LEFT'),
		),
	'DEFAULT' => 'center',
	'REFRESH' => 'N'
);
