...
IncludeTemplateLangFile(WIZARD_ABSOLUTE_PATH."/site/services/main/lang/".LANGUAGE_ID."/areas.php");
if(!CModule::IncludeModule("iblock")) return;
$wizard =& $this->GetWizard();

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/news_".$wizard->GetVar("siteBlogSectionText").".xml"; 
...
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."_".WIZARD_SITE_ID."/header.php", array("NEWS_IBLOCK_ID" => $iblockID));
?>
