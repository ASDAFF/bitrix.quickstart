...
if(COption::GetOptionString("iarga.shopplus100", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "information_".WIZARD_SITE_ID; 
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("INFORMATION_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/information.xml"; 
$iblockCode = "information_".WIZARD_SITE_ID; 
$iblockType = "iarga_shopplus100"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/information/index.php", array("INFORMATION_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/index.php", array("INFORMATION_IBLOCK_ID" => $iblockID));
