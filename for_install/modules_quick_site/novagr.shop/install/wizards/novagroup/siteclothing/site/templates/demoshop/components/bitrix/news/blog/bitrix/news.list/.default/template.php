	...
	<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
		<div class="block-news-img">
			<div>
				...
				<img height="auto" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>"  title="<?=$arItem["NAME"]?>" />
...
<!--pixel-->
<div class="soc-pr"><img src="http://trendylist.ru/bitrix/redirect.php?event1=download&amp;event2=pixel&amp;goto=/upload/iblock/acp7/blog.png" alt="blog"></div>
