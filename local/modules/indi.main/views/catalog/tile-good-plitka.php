...
<div class="tile__item tile__item_sm">
	<div class="tile__container">
		...
		<div class="tile__desc"><a class="tile__title" href="<?=$item['DETAIL_PAGE_URL']?>"><?=$item['NAME']?></a>
			<div class="tile__text"><?=$app[$item['PROPERTY_APPOINTMENTS_VALUE']]['UF_NAME']?>, <?=$item['PROPERTY_LENGTH_PIECES_VALUE'].' x '.$item['PROPERTY_WIDTH_PIECES_VALUE'].' x '.$item['PROPERTY_THICKNESS_PIECES_VALUE']?></div>
