...
if(is_array($arResult['ITEMS']) && count($arResult['ITEMS'])>0) {
	...
	?><div class="row timeline"><?
		foreach($arResult["ITEMS"] as $key => $arItem) {
			...
			?><div class="timeline-item col col-sm-5" id="<?=$this->GetEditAreaId($arItem['ID']);?>" data-key="<?=$key?>"><?
				?><div class="row"><?
					?><div class="col col-md-12"><?
						?><a class="timeline-body clearfix" href="<?=$arItem['DETAIL_PAGE_URL']?>"><?
							?><div class="row image"><?
								?><div class="col col-md-12"><?
							...
							?><div class="row data"><?
								...
								?><div class="col col-md-12 timeline-description"><?=$arItem['PREVIEW_TEXT']?></div><?
							?></div><?
						?></a><?
					?></div><?
				?></div><?
