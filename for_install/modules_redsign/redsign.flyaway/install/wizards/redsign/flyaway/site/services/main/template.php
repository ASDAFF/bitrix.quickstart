...
*/
if (!in_array($wizrdTemplateId, array("flyaway")))
	$wizrdTemplateId = "flyaway";
...
if($logo || $logoRetina)
{
	...
	$content = '<a href="'.WIZARD_SITE_DIR.'"><img src="'.WIZARD_SITE_DIR.'include/logo.png"'.($retinaPath ? ' srcset="'.$retinaPath.' 2x"' : "").'></a>';
...
{
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/flyaway/images/logo.png", WIZARD_SITE_PATH."include/logo.png");
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/flyaway/images/logo.png", WIZARD_SITE_PATH."include/logo_retina.png");
	___writeToAreasFile(WIZARD_SITE_PATH."include/company_logo.php", '<a href="'.WIZARD_SITE_DIR.'"><img src="'.WIZARD_SITE_DIR.'include/logo.png" srcset="'.WIZARD_SITE_DIR.'include/logo_retina.png 2x"></a>');
}
