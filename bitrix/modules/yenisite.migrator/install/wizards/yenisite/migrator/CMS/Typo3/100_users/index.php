...
/* количество записей */
$query = "SELECT COUNT(*) as CNT FROM `".$arResult["prefix"]."be_users`";	
...
else
{
	...
	$query = "SELECT * FROM ".$arResult["prefix"]."be_users LIMIT ".$left.", 10";
	...
	while($arItem = mysql_fetch_assoc($result))
	{
		...
		$arFields = Array(
		  "NAME"             => $arItem["username"],
		  "EMAIL"             => $arItem["email"],
		  "LOGIN"             => $arItem["realName"],
		  "LID"               => SITE_ID,
		  "ACTIVE"            => "Y",	  
		  "PASSWORD"          => $pass,
