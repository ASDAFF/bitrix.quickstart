...
<div class="page_wrapper">
	<form method="post" action="<?echo $arResult["FORM_ACTION"]?>">
		<table class="data-table bx-confirm-table">
			<tr>
				<td><label><?echo GetMessage("CT_BSAC_LOGIN")?>:</label></td>
				<td>
			...
			<tr>
				<td><label><?echo GetMessage("CT_BSAC_CONFIRM_CODE")?>:</label></td>
				<td>
			...
			<tr>
				<td></td>
				<td><input class="login_button" type="submit" value="<?echo GetMessage("CT_BSAC_CONFIRM")?>" /></td>
			</tr>
		</table>
