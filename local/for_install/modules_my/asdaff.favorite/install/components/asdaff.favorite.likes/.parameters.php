...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"PREVIEW_WIDTH" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_PREVIEW_WIDTH"),
			"TYPE" => "STRING",
			"COLS" => "5",
			"DEFAULT" => "50"
		),
		"PREVIEW_HEIGHT" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_PREVIEW_HEIGHT"),
			"TYPE" => "STRING",
			"COLS" => "5",
			"DEFAULT" => "50"
		),
		"PAGE_COUNT" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_PAGE_COUNT"),
			"TYPE" => "STRING",
			"COLS" => "5"
		),
		"PAGER_TEMPLATE" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_PAGER_TEMPLATE"),
			"TYPE" => "STRING",
		),
		"USER_ID" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_USER_ID"),
			"TYPE" => "STRING",
		),
		"FOLDER_ID" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_FOLDER_ID"),
			"TYPE" => "STRING",
		),
		"NOT_SHOW_WITH_NOT_FOLDER" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_NOT_SHOW_WITH_NOT_FOLDER"),
			"TYPE" => "CHECKBOX",
		),
		"ALLOW_MOVED" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ASDAFF_CMP_PARAM_ALLOW_MOVED"),
			"TYPE" => "CHECKBOX",
		),
	),
);
...
if (strlen($arCurrentValues["FAV_TYPE"]) && $arFullTypes[$arCurrentValues["FAV_TYPE"]]["MODULE"]=="blog")
{
	$arComponentParameters["PARAMETERS"]["URL_TO_BLOG_POST"] = Array(
														"PARENT" => "BASE",
														"NAME" => GetMessage("ASDAFF_CMP_PARAM_URL_TO_BLOG_POST"),
														"TYPE" => "STRING",
													);
}
...
if (strlen($arCurrentValues["FAV_TYPE"]) && $arFullTypes[$arCurrentValues["FAV_TYPE"]]["MODULE"]=="iblock")
{
	$arComponentParameters["PARAMETERS"]["URL_TO_ELEMENT"] = Array(
														"PARENT" => "BASE",
														"NAME" => GetMessage("ASDAFF_CMP_PARAM_URL_TO_ELEMENT"),
														"TYPE" => "STRING",
													);
}
