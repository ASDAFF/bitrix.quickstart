...
<div class="search-page">
	...
	<form action="" method="get" class="form-inline">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form-group">
			<tbody><tr>
				<td style="width: 100%;">
				...
				<td>
					<input class="search-button btn btn-default" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
				</td>
			</tr>
		</tbody></table>
		...
		<div class="search-advanced">
			...
			<?if($arParams["SHOW_WHERE"] || $arParams["SHOW_WHEN"]):?>
				...
				<div id="search_params" class="search-filter" style="display:<?echo $arResult["REQUEST"]["FROM"] || $arResult["REQUEST"]["TO"] || $arResult["REQUEST"]["WHERE"]? 'block': 'none'?>">
					...
					<table class="search-filter" cellspacing="0" class="form-group"><tbody>
						<?if($arParams["SHOW_WHERE"]):?>
						<tr>
						...
						<tr>
							...
							<td class="search-filter-field"><input class="search-button btn btn-default" value="<?echo GetMessage("CT_BSP_GO")?>" type="submit"></td>
						</tr>
					</tbody></table>
				</div>
			<?else:?>
...
<?if(isset($arResult["REQUEST"]["ORIGINAL_QUERY"])):
	...
	<?elseif($arResult["ERROR_CODE"]!=0):?>
		...
		<table border="0" cellpadding="5" class="form-group">
			<tr>
