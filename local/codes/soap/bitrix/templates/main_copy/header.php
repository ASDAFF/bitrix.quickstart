...
<?global $USER;?>
<?if(!$USER->GetId()):?>
<div class="b-wishlist-need_auth m-breadcrumb__top">Чтобы сохранить вишлисты, необходимо <a href="#b-login" class='m-login__link' >авторизоваться</a></div>
<?endif;?>

<div class="b-container m-wishlist clearfix">
