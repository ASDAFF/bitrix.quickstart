...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/options.xml";
$iblockCode = "options_".WIZARD_SITE_ID;
$iblockCode2 = "options";
$iblockType = "calc";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/calc/index.php", array("OPTION_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax/form_calc.php", array("OPTION_IBLOCK_ID" => $iblockID));
?>
