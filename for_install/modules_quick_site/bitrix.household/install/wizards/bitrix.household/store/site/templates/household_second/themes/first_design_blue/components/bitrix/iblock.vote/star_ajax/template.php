...
//результатом запроса
?>
<table border="0" cellspacing="0" cellpadding="0" class="aj_star">
	<tr>
...
?>"></div></td>
	...
	<?endif?>
	<?if($arResult["PROPERTIES"]["vote_count"]["VALUE"]):?>
		<td>&nbsp;</td><td class="vote_result"><div id="wait_vote_<?echo $arResult["ID"]?>"><?echo $DISPLAY_VALUE;?></div></td>
	<?else:?>
		<td>&nbsp;</td><td class="vote_result"><div id="wait_vote_<?echo $arResult["ID"]?>"><?echo "0";?></div></td>
	<?endif?>
	</tr>
</table>
</div><?
