                        ...
                        <label class="item_delivery <?if($arProfile["CHECKED"] == "Y"):?>label-active<?endif;?>" for="ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>"  onclick="BX('ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>').checked=true;calculateDeliveryCount(<?=$count?>);submitForm();">
                            ...
                            <div class="row">
                                <div class="col-sm-5 sm-padding-right-no">
                                    <div class="block_img">
                                        <img class="img-responsive" src="<?=$deliveryImgURL?>" width="85px" height="45px"  alt=""/>
                                    </div>
                                </div>
                                <div class="col-sm-19">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-11 sm-padding-left-no">
                                                <div class="block_cost">
                                                     ...
                                                     ?>
                                                        <div><?=GetMessage("MS_ORDER_DELIVERY_PRICE")?>:&nbsp;<b><?=$arResult["DELIVERY_PRICE_FORMATED"]?></b></div>
                                                        <?
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-11 sm-padding-left-no">
                                            <div class="block_cost">        
                                                ...
                                                <p><span><?=GetMessage("MS_ORDER_DELIVERY_PRICE")?>:</span> <?=(isset($arDelivery['DELIVERY_DISCOUNT_PRICE_FORMATED']) && !empty($arDelivery['DELIVERY_DISCOUNT_PRICE_FORMATED']))?$arDelivery['DELIVERY_DISCOUNT_PRICE_FORMATED']:$arDelivery["PRICE_FORMATED"]?>
                                                <?if (strlen($arDelivery["PERIOD_TEXT"])>0):?>
                                                <br />
                                                <span><?=GetMessage('SALE_SADC_TRANSIT')?></span>
