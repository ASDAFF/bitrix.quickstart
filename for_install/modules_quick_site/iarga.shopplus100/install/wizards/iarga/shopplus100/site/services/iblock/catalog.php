...
if ($arIBlock = $rsIBlock->Fetch())
{
	...
	if (WIZARD_INSTALL_DEMO_DATA)
	{
		...
		$iblockID = false; 
		COption::SetOptionString("iarga.shopplus100", "demo_deleted", "N", "", WIZARD_SITE_ID);
...
if($iblockID == false)
{
	...
	//ImportXMLFile($iblockXMLFile,$iblockType,WIZARD_SITE_ID);
	$ws = new WizardServices;
	$iblockID1 = $ws->ImportIBlockFromXML(
		$iblockXMLFilePrices,
		"catalog",
		$iblockType."_prices",
		WIZARD_SITE_ID,
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/favorite/index.php", array("CATALOG_IBLOCK_ID" => $iblockID));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/bitrix/templates/iarga.shopplus100.main/inc/parts/index_bottom.php", array("CATALOG_IBLOCK_ID" => $iblockID));
