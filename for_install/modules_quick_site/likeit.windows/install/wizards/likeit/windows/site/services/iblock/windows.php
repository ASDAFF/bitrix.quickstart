...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/windows.xml";
$iblockCode = "windows_".WIZARD_SITE_ID;
$iblockCode2 = "windows";
$iblockType = "calc";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/calc/index.php", array("WINDOWS_IBLOCK_ID" => $iblockID));
?>
