...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/events/index.php", array("EVENTS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("EVENTS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/news/index.php", array("EVENTS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/gallery/index.php", array("EVENTS_IBLOCK_ID" => $iblockID));
