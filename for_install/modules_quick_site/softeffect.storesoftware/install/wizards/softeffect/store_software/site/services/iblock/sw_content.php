...
$iblockType = 'sw_content';
$arIblockContent = array(
	'sw_actions' => array (
		'FILE' => WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sw_content/action.xml",
		'FIELDS' => array(
			// elements
	...
	'sw_faq' => array (
		'FILE' => WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sw_content/faq.xml",
		'FIELDS' => array(
			// elements
			'IBLOCK_SECTION' => array (
				'IS_REQUIRED' => 'N',
	...
	'sw_banner' => array (
		'FILE' => WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sw_content/banner.xml",
		'FIELDS' => array(
			// elements
			'IBLOCK_SECTION' => array (
				'IS_REQUIRED' => 'N',
	...
	'sw_partners' => array (
		'FILE' => WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sw_content/partners.xml",
		'FIELDS' => array(
			// elements
			'IBLOCK_SECTION' => array (
				'IS_REQUIRED' => 'N',
	...
	'sw_reviews_comp' => array (
		'FILE' => WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sw_content/reviews_comp.xml",
		'FIELDS' => array(
			// elements
			'IBLOCK_SECTION' => array (
				'IS_REQUIRED' => 'N',
	...
	'sw_reviews_goods' => array (
		'FILE' => WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sw_content/reviews_goods.xml",
		'FIELDS' => array(
			// elements
			'IBLOCK_SECTION' => array (
				'IS_REQUIRED' => 'N',
...
foreach ($arIblockContent as $iblockCode => $iblockFields) {
	...
	if ($iblockCode=='sw_banner') {
		CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array($iblockCode => $iblockID));
	} elseif ($iblockCode=='sw_partners') {
		CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/about/partners/index.php", array($iblockCode => $iblockID));
	} elseif ($iblockCode=='sw_reviews_comp') {
		CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/about/reviews/index.php", array($iblockCode => $iblockID));
		CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."components/bitrix/news/news_se_tmp/bitrix/news.detail/.default/template.php", array($iblockCode => $iblockID));
	} elseif ($iblockCode=='sw_actions') {
		CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/search/index.php", array($iblockCode => $iblockID));
		CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/news/index.php", array($iblockCode => $iblockID));
		CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array($iblockCode => $iblockID));
	} elseif ($iblockCode=='sw_reviews_goods') {
