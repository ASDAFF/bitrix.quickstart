<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)
    ...
    if ($IBLOCK_CATALOG_ID)
    {
        ...
        $res = CIBlockProperty::GetByID("COLOR_REF", $IBLOCK_OFFERS_ID, false);
        ...
        $res = CIBlockProperty::GetByID("BRAND_REF", $IBLOCK_CATALOG_ID, false);
        if($ar_res = $res->GetNext()){
            $arFields2 = array(
                'USER_TYPE_SETTINGS' => array(
                    'size' => '1',
        ...
        WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."blog/", Array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
