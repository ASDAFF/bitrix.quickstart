...
if(!($dbEvent->Fetch()))
{
	...
	WizardServices::IncludeServiceLang("step3.php", $lid);
	...
	// custom softeffect.ru
	$dbEvent = CEventType::GetList(Array("TYPE_ID" => "NEW_PHONE"));
	if(!($dbEvent->Fetch())) {
		$et = new CEventType;
		$et->Add(array(
			"LID" => $lid,
			"EVENT_NAME" => "NEW_PHONE",
			"NAME" => GetMessage("NEW_PHONE"),
			"DESCRIPTION" => GetMessage("NEW_PHONE_DESC"),
		));
	}
	...
	##### custom softeffect.ru #####
	$emess = new CEventMessage; // callme
	$id = $emess->Add(array(
		"ACTIVE" => "Y",
		"EVENT_NAME" => "NEW_PHONE",
		"LID" => WIZARD_SITE_ID,
		...
		"SUBJECT" => GetMessage("CALLME_SUBJECT"),
		"MESSAGE" => GetMessage("CALLME_MESSAGE"),
		"BODY_TYPE" => "text",
	));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/phone-sbox-form.php", array("template_callme" => $id));
	
	$emess = new CEventMessage; // one click order
	$id = $emess->Add(array(
		"ACTIVE" => "Y",
		"EVENT_NAME" => "NEW_PHONE",
		"LID" => WIZARD_SITE_ID,
		"EMAIL_FROM" => "#DEFAULT_EMAIL_FROM#",
		"EMAIL_TO" => "#DEFAULT_EMAIL_FROM#",
		"SUBJECT" => GetMessage("1CLK_SUBJECT"),
		"MESSAGE" => GetMessage("CALLME_MESSAGE"),
		"BODY_TYPE" => "text",
	));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/1click-order-sbox/1click-order-sbox-form.php", array("template_1clk" => $id));
	
	$emess = new CEventMessage; // review
	$id = $emess->Add(array(
		"ACTIVE" => "Y",
		"EVENT_NAME" => "NEW_PHONE",
		"LID" => WIZARD_SITE_ID,
		"EMAIL_FROM" => "#DEFAULT_EMAIL_FROM#",
		"EMAIL_TO" => "#DEFAULT_EMAIL_FROM#",
		"SUBJECT" => GetMessage("REVIEW_SUBJECT"),
		"MESSAGE" => GetMessage("CALLME_MESSAGE"),
		"BODY_TYPE" => "text",
	));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/rating/rating-sbox-form.php", array("template_review" => $id));
	################################
