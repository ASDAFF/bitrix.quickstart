...
if(IntVal($userGroupID) > 0)
{
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/articles/"), Array($userGroupID => "W"));
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/calc/"), Array($userGroupID => "W"));
}
?>