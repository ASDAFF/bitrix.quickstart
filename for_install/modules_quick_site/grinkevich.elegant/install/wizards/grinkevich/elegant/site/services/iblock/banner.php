...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/iblock_4.xml";
$iblockCode = "furniture_banner_".WIZARD_SITE_ID;
$iblockType = "news";
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_SLIDER_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_SLIDER_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_SLIDER_3").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_SLIDER_4").'--,--PROPERTY_'.$arProperty["LINK"].'--#--'.GetMessage("WZD_OPTION_SLIDER_6").'--,--PROPERTY_'.$arProperty["BGCOLOR"].'--#--'.GetMessage("WZD_OPTION_SLIDER_BGCOLOR").'--,--SORT--#--'.GetMessage("WZD_OPTION_SLIDER_5").'--;--', ));
...
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/bitrix/templates/".$wizrdTemplateId."/header.php", array("BANNERS_IBLOCK_ID" => $iblockID));
