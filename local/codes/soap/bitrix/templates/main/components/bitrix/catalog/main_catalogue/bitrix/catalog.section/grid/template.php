...
<?endif?>
	...
	<div class="b-slider__btn clearfix">
		...
		<a href="#b-wishlist__add" class="b-icon m-wishlist__add" title="<?echo GetMessage("WISHLIST")?>"></a>
				<?if($arParams["DISPLAY_COMPARE"]):?>
					<noindex>
					<a href="<?echo $arElement["COMPARE_URL"]?>" rel="nofollow" class="b-icon m-icon__compare m-compare__add" title="<?echo GetMessage("CATALOG_COMPARE")?>"></a>
					</noindex>
				<?endif?>
	</div>
</div>
	...
	<div class="b-popup m-popup__orange" id="b-wishlist__add">
		<div class="b-popup__wrapper">
			<div class="b-wishlist__select">
				<select name="" id="">
					<option value="">На день рождения</option>
					<option value="">На день рождения</option>
					<option value="">На день рождения</option>
					<option value="">На день рождения</option>
				</select>
			...
			<div class="clearfix"><button class="b-button__fast">OK</button></div>
		</div>
	</div>
