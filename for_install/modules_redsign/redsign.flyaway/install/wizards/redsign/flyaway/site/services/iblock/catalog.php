...
$iblockXMLFile			= WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/catalog/catalog.xml';
$iblockXMLFilePrices	= WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/catalog/catalog_prices.xml';

if (WIZARD_THEME_ID != 'default' && file_exists(WIZARD_SERVICE_ABSOLUTE_PATH.'/xml/ru/theme/'.WIZARD_THEME_ID.'/catalog.xml')) {
	$iblockXMLFile			= WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/theme/'.WIZARD_THEME_ID.'/catalog.xml';
	$iblockXMLFilePrices	= WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/theme/'.WIZARD_THEME_ID.'/catalog_prices.xml';
}
...
$iblockCode = "flyaway_catalog_".WIZARD_SITE_ID;
$iblockType = "catalog";
