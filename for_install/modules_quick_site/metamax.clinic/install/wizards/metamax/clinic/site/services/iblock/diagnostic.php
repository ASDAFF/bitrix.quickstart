...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/diagnostic.xml"; 
$iblockCode = "clinic_diagnostic_".WIZARD_SITE_ID; 
$iblockType = "clinic"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/diagnostic/.sub.menu_ext.php", array("DIAGNOSTIC_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/diagnostic/index.php", array("DIAGNOSTIC_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/diagnostic/section.php", array("DIAGNOSTIC_IBLOCK_ID" => $iblockID));
?>
