...
<div class="bx_catalog_list_home <? echo $templateData['TEMPLATE_CLASS']; ?>">
		...
		<div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">
			<div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
				...
				<a id="<? echo $arItemIDs['PICT']; ?>"
					...
					style="background-image: url(<? echo $arItem['DETAIL_PICTURE']['SRC']; ?>)"
					title="<? echo $strTitle; ?>">		
					<?if($arItem['LABEL']) {?>
				...
				<div class="bx_catalog_item_title">
					...
					<?
					if($arItem['PROPERTIES']['EMARKET_PREVIEW_CH']['VALUE'])
						echo $arItem['PROPERTIES']['EMARKET_PREVIEW_CH']['VALUE'];
					else
				...
				<div class="bx_catalog_item_rating">
					...
					<?if($arItem['PROPERTIES']['EMARKET_COMMENTS_COUNT']['VALUE']){?>
						<div class="bx_catalog_item_comments">
						<?=GetMessage("EMARKET_TEXT_REV")?>: <?=$arItem['PROPERTIES']['EMARKET_COMMENTS_COUNT']['VALUE']?>
						</div>
					<?}?>
						...
						<?if ($arItem['CAN_BUY']){?>
							<div class="bx_catalog_item_controls_blocktwo">
								...
								<a id="<? echo $arItemIDs['BUY_LINK']; ?>" 
									...
									rel="nofollow"></a>
								<a  id="compare_<?=$arItem['ID']?>" 
									class="compare-control-button bx_medium_2 ico2 <?if(!empty($_SESSION[$arParams['COMPARE_NAME']][$arItem['IBLOCK_ID']]['ITEMS'][$arItem['ID']])) echo 'active"';?>" 
									data-id="<?=$arItem['ID']?>"></a>
							</div>
						<?}?>
