...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		{
			$arTemplates = array("tireos_landing");
			...
			$wizard->SetVar("templateID", "tireos_landing");
		}
	}
	...
	function ShowStep()
	{
		...
		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "tireos_landing", $wizard->GetVar("siteID"));
		$defaultTemplateID = "tireos_landing";
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	...
	{
		$wizard =& $this->GetWizard();
		$wizard->solutionName = "tireos_landing";
		parent::InitStep();
		...
		if ($wizard->GetVar("templateID") == "tireos_landing")
		{
...
class PaySystem extends CWizardStep
{
	...
	function ShowStep()
	{
		...
		if (
			...
			LANGUAGE_ID == "ru" &&
			(
				COption::GetOptionString("tireos_landing", "wizard_installed", "N", $siteID) != "Y"
			...
			<div class="wizard-input-form-block">
				...
				<div>
					<div class="wizard-input-form-field wizard-input-form-field-checkbox">';
						...
						if(COption::GetOptionString("tireos_landing", "wizard_installed", "N", $siteID) != "Y")
						{
