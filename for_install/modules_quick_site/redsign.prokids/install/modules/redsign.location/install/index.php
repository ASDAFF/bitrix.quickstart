...
Class redsign_location extends CModule
{
	...
	function redsign_location()
	{
		...
		$this->MODULE_NAME = GetMessage("RSLOC_INSTALL_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("RSLOC_INSTALL_DESCRIPTION");
		$this->PARTNER_NAME = GetMessage("RSLOC_INSTALL_COPMPANY_NAME");
