$(document).ready(function(){
	$('.asd_'+sButton+'_button').live('click',function(){
		...
		if ($(this).hasClass('asd_'+sButton+'ed'))
		{
			...
			$.get('/bitrix/tools/asdaff_favorite.php', {id : id, action : 'unlike', sessid : sSessId, type : sType, key : sKey});
		}
		else
		{
			$('#asd_count_'+id).html(count+1);
			...
			$.get('/bitrix/tools/asdaff_favorite.php', {id : id, action : 'like', sessid : sSessId, type : sType, key : sKey});
		}
	});
});
