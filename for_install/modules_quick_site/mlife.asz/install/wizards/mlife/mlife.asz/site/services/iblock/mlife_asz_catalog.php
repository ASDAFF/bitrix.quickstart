...
if(WIZARD_TEMPLATE_ID=="mlife_aszsuper"){
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/.bottomshap.menu_ext.php", array("IBLOCK_TYPE" => $iblockType));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/.bottomshap.menu_ext.php", array("IBLOCK_ID" => $iblockID));
}
