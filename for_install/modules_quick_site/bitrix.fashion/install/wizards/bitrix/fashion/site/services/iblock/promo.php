...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/promo.xml";
$iblockCode = "promo_".WIZARD_SITE_ID;
$iblockType = "content";
...
if(COption::GetOptionString("fashion", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	...
	{
		CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/fashion_promo_".WIZARD_THEME_ID."/header.php", array("PROMO_IBLOCK_ID" => $arIBlock["ID"]));
	}
...
$dbProp = CIBlockProperty::GetList(array(), array('CODE' => 'products', 'IBLOCK_ID' => $iblockID));
...
//CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/sect_inc.php", array("CATALOG_COLORS_IBLOCK_ID" => $iblockID));
if(WIZARD_TEMPLATE_ID=="fashion")
	CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_index_".WIZARD_THEME_ID."/header.php", array("PROMO_IBLOCK_ID" => $iblockID));
?>