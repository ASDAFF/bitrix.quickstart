...
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/krayt/content_news.xml"; 
$iblockCode = "content_news";
$iblockType = "content"; 
...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/emarket_emarket/footer.php", array("NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/emarket_emarket/components/bitrix/catalog/catalog-template/section.php", array("NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/emarket_emarket/components/bitrix/catalog/catalog-template/sections.php", array("NEWS_IBLOCK_ID" => $iblockID));
?>