...
$MESS["AUTH_WRONG_PASS"]="Неверный логин или пароль.";
$MESS["AUTH_EMAIL"]="E-mail";
$MESS["AUTH_MESSAGE"]="Пожалуйста, авторизуйтесь:";
$MESS["AUTH_MESSAGE2"]="Если вы впервые на сайте, заполните, пожалуйста, регистрационную форму.";
?>