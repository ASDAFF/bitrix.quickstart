...
<div class="tab-pane" id="new-0">
	<div id="catalogue-tabs-carousel-01" class="carousel slide" data-ride="carousel" data-interval="0">
		<?if($itemsCount/3 > 1):?>
		<ol class="carousel-indicators">
		<?for($i = 0;$i < $itemsCount/3;$i++):?>
			<li data-target="#catalogue-tabs-carousel-02" data-slide-to="<?=$i?>"<?=($i == 0 ? ' class="active"' : '')?>></li>
		<?endfor;?>
		</ol>
		<?endif;?>
					...
					<div class="col-sm-4">
						<div class="bj-product-card">
							...
							<div class="i-relative">
								...
								<span class="bj-product-card__label__content">
								<span>
								В наличии: 1 шт. dasdsadsadsadsads </span>
								</span>
								</span>
							</div>
