...
$wizTemplateId = COption::GetOptionString("main", "wizard_template_id", "kidstore", SITE_ID);
CUtil::InitJSCore();
	...
	<div class="header_wrap">
		<div class="header_wrap_container">
			...
			<div class="header_inner" itemscope itemtype = "http://schema.org/LocalBusiness">
				<div class="site_title"><a href="<?=SITE_DIR?>" itemprop = "name"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/company_logo.php"), false);?></a></div>
                ...
                <div class="header_inner_container_one">
                    <div class="header_inner_include_aria"><span style="">
							<strong style="display: inline-block;padding-top: 7px;"><a style="text-decoration: none;color:#000;" href="<?=SITE_DIR?>about/contacts/" itemprop = "telephone"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/telephone.php"), false);?></a></strong><br />
