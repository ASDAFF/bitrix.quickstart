...
$iblockCode = "mobile_".WIZARD_SITE_ID;
$iblockType = "catalog"; 
...
//demo discount
	...
	if(!($dbDiscount->Fetch()))
	{
		if (CModule::IncludeModule("iblock"))
		{
			$dbSect = CIBlockSection::GetList(Array(), Array("IBLOCK_TYPE" => "catalog", "IBLOCK_ID"=>$iblockID, "CODE" => "samsung", "IBLOCK_SITE_ID" => WIZARD_SITE_ID));
			if ($arSect = $dbSect->Fetch())
				$childrenSectId = $arSect["ID"];
		}
		...
		$arF = Array (
			...
			"CONDITIONS" => Array (
				...
				"CHILDREN" => Array("0" => Array("CLASS_ID" => "CondIBSection", "DATA" => Array("logic" => "Equal", "value" => $childrenSectId)))
			)
		);
...
//for element edit
CUserOptions::SetOption("form", "form_element_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_CATALOG_1").'--,--NAME--#--'.GetMessage("WZD_OPTION_CATALOG_3").'--,--CODE--#--'.GetMessage("WZD_OPTION_CATALOG_4").'--,--PROPERTY_'.$arProperty["BROWSER_TITLE"].'--#--'.GetMessage("WZD_OPTION_CATALOG_35").'--,--PROPERTY_'.$arProperty["META_KEYWORDS"].'--#--'.GetMessage("WZD_OPTION_CATALOG_37").'--,--PROPERTY_'.$arProperty["META_DESCRIPTION"].'--#--'.GetMessage("WZD_OPTION_CATALOG_38").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_CATALOG_2").'--,--PROPERTY_'.$arProperty["SALELEADER"].'--#--'.GetMessage("WZD_OPTION_CATALOG_29").'--,--PROPERTY_'.$arProperty["NEWPRODUCT"].'--#--'.GetMessage("WZD_OPTION_CATALOG_11").'--,--PROPERTY_'.$arProperty["SPECIALOFFER"].'--#--'.GetMessage("WZD_OPTION_CATALOG_10").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_CATALOG_6").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_CATALOG_7").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_CATALOG_43").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_CATALOG_5").'--,--PROPERTY_'.$arProperty["MORE_PHOTO"].'--#--'.GetMessage("WZD_OPTION_CATALOG_18").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_CATALOG_39").'--,--IBLOCK_ELEMENT_PROPERTY--#--'.GetMessage("WZD_OPTION_CATALOG_32").'--,--CATALOG--#--'.GetMessage("WZD_OPTION_CATALOG_20").'--;--cedit1--#--'.GetMessage("WZD_OPTION_CATALOG_33").'--,--PROPERTY_'.$arProperty["ACCESSORIES"].'--#--'.GetMessage("WZD_OPTION_CATALOG_31").'--,--PROPERTY_'.$arProperty["SAME_GOODS"].'--#--'.GetMessage("WZD_OPTION_CATALOG_42").'--;--edit8--#--'.GetMessage("WZD_OPTION_CATALOG_34").'--,--OFFERS--#--'.GetMessage("WZD_OPTION_CATALOG_34").'--;--', ));
//for section edit
CUserOptions::SetOption("form", "form_section_".$iblockID, array ( 'tabs' => 'edit1--#--'.GetMessage("WZD_OPTION_CATALOG_21").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_CATALOG_22").'--,--IBLOCK_SECTION_ID--#--'.GetMessage("WZD_OPTION_CATALOG_23").'--,--NAME--#--'.GetMessage("WZD_OPTION_CATALOG_24").'--,--CODE--#--'.GetMessage("WZD_OPTION_CATALOG_25").'--,--UF_BROWSER_TITLE--#--'.GetMessage("WZD_OPTION_CATALOG_35").'--,--UF_KEYWORDS--#--'.GetMessage("WZD_OPTION_CATALOG_37").'--,--UF_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_CATALOG_38").'--,--SORT--#--'.GetMessage("WZD_OPTION_CATALOG_28").'--,--PICTURE--#--'.GetMessage("WZD_OPTION_CATALOG_26").'--,--DESCRIPTION--#--'.GetMessage("WZD_OPTION_CATALOG_27").'--;--edit1_csection2--#--'.GetMessage("WZD_OPTION_CATALOG_40").'--,--SECTION_PROPERTY--#--'.GetMessage("WZD_OPTION_CATALOG_41").'--;--edit4--#--'.GetMessage("WZD_OPTION_CATALOG_41").'--;--', ));
