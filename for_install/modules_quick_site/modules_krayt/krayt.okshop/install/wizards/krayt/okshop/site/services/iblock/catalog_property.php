...
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/krayt/catalog_property.xml"; 
$iblockCode = "emarket_properties";
$iblockType = "catalog"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CATALOG_P_IBLOCK_ID" => $iblockID));
?>