...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/visit.xml"; 
$iblockCode = "clinic_visit_".WIZARD_SITE_ID; 
$iblockType = "clinic"; 
...
$res = CIBlockProperty::GetList(Array(), Array("IBLOCK_ID"=>$iblockID));
while ($ob = $res->GetNext(false,false))
	$arProperties[$ob["CODE"]] = $ob["ID"];

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/visit/index.php", array("VISIT_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/visit/index.php", array("PHONE_PROPERTY_ID" => $arProperties["PHONE"]));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/visit/index.php", array("EMAIL_PROPERTY_ID" => $arProperties["EMAIL"]));
