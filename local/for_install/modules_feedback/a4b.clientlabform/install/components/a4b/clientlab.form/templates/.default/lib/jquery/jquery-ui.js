/*! _jQuery UI - v1.11.4 - 2015-03-11
 * http://_jqueryui.com
 * Includes: core.js, widget.js, mouse.js, position.js, accordion.js, autocomplete.js, button.js, datepicker.js, dialog.js, draggable.js, droppable.js, effect.js, effect-blind.js, effect-bounce.js, effect-clip.js, effect-drop.js, effect-explode.js, effect-fade.js, effect-fold.js, effect-highlight.js, effect-puff.js, effect-pulsate.js, effect-scale.js, effect-shake.js, effect-size.js, effect-slide.js, effect-transfer.js, menu.js, progressbar.js, resizable.js, selectable.js, selectmenu.js, slider.js, sortable.js, spinner.js, tabs.js, tooltip.js
 * Copyright 2015 _jQuery Foundation and other contributors; Licensed MIT */

(function(e) {
	"function" == typeof define && define.amd ? define(["_jquery"], e) : e(_jQuery)
})(function(e) {
	function t(t, s) {
	...
	}), e("<a>").outerWidth(1)._jquery || e.each(["Width", "Height"], function(t, i) {
		function s(t, i, s, a) {
	...
	e.cleanData = function(t) {
		...
		e.fn[t] = function(n) {
			...
			return a ? this.each(function() {
				...
				return "instance" === n ? (r = a, !1) : a ? e.isFunction(a[n]) && "_" !== n.charAt(0) ? (i = a[n].apply(a, o), i !== a && void 0 !== i ? (r = i && i._jquery ? r.pushStack(i.get()) : i, !1) : void 0) : e.error("no such method '" + n + "' for " + t + " widget instance") : e.error("cannot call methods on " + t + " prior to initialization; " + "attempted to call method '" + n + "'")
	...
	e(document).mouseup(function() {
		...
		function() {
			...
			_appendTo: function() {
				...
				return t && (t = t._jquery || t.nodeType ? e(t) : this.document.find(t).eq(0)), t && t[0] || (t = this.element.closest(".ui-front")), t.length || (t = this.document[0].body), t
			},
	...
	e.extend(n.prototype, {
		...
		_create: function() {
			...
			this._renderAxis = function(t) {
				var i, s, n, a;
				t = t || this.element;
				for (i in this.handles) this.handles[i].constructor === String ? this.handles[i] = this.element.children(this.handles[i]).first().show() : (this.handles[i]._jquery || this.handles[i].nodeType) && (this.handles[i] = e(this.handles[i]), this._on(this.handles[i], {
		...
		_appendTo: function() {
			var t = this.options.appendTo;
			return t && (t._jquery || t.nodeType) ? e(t) : this.document.find(t || "body").eq(0)
		},
		_destroy: function() {
	...
	e.effects = {
		...
		function(e, t) {
			...
			p.style.cssText = "background-color:rgba(1,1,1,.5)", c.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(u, function(e, t) {
				...
				parse: function(n, o, r, h) {
					...
					(n._jquery || n.nodeType) && (n = e(n).css(o), o = t);
					var d = this,
						c = e.type(n),
						p = this._rgba = [];
		...
		function() {
			...
			serialize: function(t) {
				var i = this._getItemsAs_jQuery(t && t.connected),
					s = [];
			...
			_eventHandler: function(t) {
				...
				t.preventDefault(), a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || this._trigger("beforeActivate", t, u) === !1 || (i.active = r ? !1 : this.tabs.index(a), this.active = o ? e() : a, this.xhr && this.xhr.abort(), l.length || h.length || e.error("_jQuery UI Tabs: Mismatching fragment identifier."), h.length && this.load(this.tabs.index(a), t), this._toggle(t, u))
			},
