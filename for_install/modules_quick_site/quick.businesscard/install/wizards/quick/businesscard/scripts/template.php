...
class WizardTemplate extends CWizardTemplate
{
	function GetLayout()
	{
		...
		$jQuery = $wizardPathCustom."/js/jquery-1.8.0.min.js" ;		
		$title = str_replace("#VERS#", $productVersion , $title);
		$seo = GetMessage("WIZARD_SEO");		
...
<style>.inst-title div{font-size:11px; font-style:italic; font-weight:normal; margin:7px 0 0 5px;}</style>
