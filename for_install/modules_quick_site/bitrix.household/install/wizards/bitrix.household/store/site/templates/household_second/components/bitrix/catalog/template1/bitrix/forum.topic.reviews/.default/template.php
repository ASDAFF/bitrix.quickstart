...
<div class="add_review">
	<a onClick="document.getElementById('reviews-reply-form').style.display = document.getElementById('reviews-reply-form').style.display == 'none' ? 'block' : 'none'; " href="#"><img src="<?=SITE_TEMPLATE_PATH?>/images/make_otz.png" width="139px" height="19px" alt="Добавить отзыв" /></a>
</div>
