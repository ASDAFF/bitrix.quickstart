                    ...
                    <div data-property-id-row="<?=intval(intval($arProperties["ID"]))?>">
						...
						if($arProperties['IS_EMAIL'] == 'Y'){
							...
							<div class="info_order_item_content__input_item">
								<span class="pay_info_block__input_title fonts__main_comment"><?=$arProperties["NAME"]?><?=$reqSymbol?></span>
								<input type="email" maxlength="250"
								       class="feedback-input fonts__middle_comment <?=$reqSymbol ? "required" : ""?> <?=$arProperties["CODE"] == "EMAIL" ? "emailfield" : ""?> <?=$arProperties["CODE"] == "PHONE" ? "phonefield" : ""?>"
						...
						elseif($arProperties["TYPE"] == "TEL" || $arProperties['IS_PHONE'] == 'Y')
                        {
                            ?>
							<div class="info_order_item_content__input_item">
								<span class="pay_info_block__input_title fonts__main_comment"><?=$arProperties["NAME"]?><?=$reqSymbol?></span>
								<input type="tel" maxlength="250"
								       class="feedback-input fonts__middle_comment <?=$reqSymbol ? "required" : ""?>"
								       placeholder="<?=$arProperties["PLACEHOLDER"]?><?=$reqSymbol?>"
								       size="<?=$arProperties["SIZE"]?>"
								       value="<?=$arProperties["VALUE"]?>"
								       name="<?=$arProperties["FIELD_NAME"]?>"
