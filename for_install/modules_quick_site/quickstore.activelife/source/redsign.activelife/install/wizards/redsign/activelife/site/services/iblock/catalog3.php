...
{
	$iblockCode = "activelife_catalog_".WIZARD_SITE_ID;
	//IBlock fields
	$iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
...
*/
    ...
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/index/catalog_section.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/index/section_list.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/personal/cart/index.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/personal/recommend/index.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/personal/viewed/index.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sales/bestprice/index.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sales/bestsellers/index.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
