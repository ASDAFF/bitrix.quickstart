...
class Client extends \SoapClient
{
	...
	*/
	...
	public static function getFactory($code = '')
	{
		...
		if (!self::$instances) {
			ini_set('soap.wsdl_cache_enabled', ('Y' == \COption::GetOptionString('indi.main', 'indi_soapclient_wsdl_cache_enabled', 'N') ? 1 : 0));
			ini_set('soap.wsdl_cache', intval(\COption::GetOptionInt('indi.main', 'indi_soapclient_wsdl_cache', 2)));
			ini_set('soap.wsdl_cache_ttl', intval(\COption::GetOptionInt('indi.main', 'indi_soapclient_wsdl_cache_ttl', 86400)));
			ini_set('soap.wsdl_cache_dir', \COption::GetOptionString('indi.main', 'indi_soapclient_wsdl_cache_dir', '/tmp'));
			ini_set('soap.wsdl_cache_limit', intval(\COption::GetOptionInt('indi.main', 'indi_soapclient_wsdl_cache_limit', 10)));
			ini_set('default_socket_timeout', intval(\COption::GetOptionInt('indi.main', 'indi_soapclient_socket_timeout', 60)));
		}
	...
	*/
	public function getWsdlParams($code)
	{
		...
		$optstr = \COption::GetOptionString('indi.main', 'indi_soapclients[' . $code . ']');
