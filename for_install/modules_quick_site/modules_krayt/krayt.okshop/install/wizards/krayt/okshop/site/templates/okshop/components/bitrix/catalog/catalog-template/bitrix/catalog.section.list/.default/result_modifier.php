	...
	\Bitrix\Main\Loader::includeModule('iblock'))
{
	foreach ($arResult['SECTIONS'] as $key => $arSection)
	{
		$arSelect = Array(
			...
			"CATALOG_GROUP_1",
			"CATALOG_GROUP_2",
            "PROPERTY_EMARKET_HIT",
            "PROPERTY_EMARKET_NEW",
            "PROPERTY_EMARKET_RATING",
            "MIN_PRICE"
		);
		$arFilter = Array(
		...
		$res = CIBlockElement::GetList(Array('PROPERTY_RATING' => 'DESC'), $arFilter, false, Array(), $arSelect);
