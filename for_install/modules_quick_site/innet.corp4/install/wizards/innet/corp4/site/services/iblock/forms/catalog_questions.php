...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/index.php", array('INNET_IBLOCK_ID_CATALOG_QUESTIONS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array('INNET_IBLOCK_ID_CATALOG_QUESTIONS' => $iblockID));
