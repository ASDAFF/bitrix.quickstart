...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/.catalog_inc.menu_ext.php", array("CATALOG_BRANDS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/index.php", array("CATALOG_BRANDS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/sect_inc.php", array("CATALOG_BRANDS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CATALOG_BRANDS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/.catalog.menu_ext.php", array("CATALOG_BRANDS_IBLOCK_ID" => $iblockID));

if(WIZARD_TEMPLATE_ID=="fashion_fix")
	CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/bitrix/templates/".WIZARD_TEMPLATE_ID."_index_".WIZARD_THEME_ID."/header.php", array("CATALOG_BRANDS_IBLOCK_ID" => $iblockID));
?>