...
if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "flyaway_current_".WIZARD_SITE_ID;
		$iblockType = "projects";
		...
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/projects/index.php', array('IBLOCK_ID_projects_current' => $iblockID));
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/projects/current/index.php', array('IBLOCK_ID_projects_current' => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/projects/current.xml'; 
$iblockCode = "flyaway_current_".WIZARD_SITE_ID;
$iblockType = "projects"; 
...
if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "flyaway_finished_".WIZARD_SITE_ID;
		$iblockType = "projects";
		...
		if ($arIBlock = $rsIBlock->Fetch())
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/projects/index.php', array('IBLOCK_ID_projects_finished' => $iblockID));
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/projects/finished/index.php', array('IBLOCK_ID_projects_finished' => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/projects/finished.xml'; 
$iblockCode = "flyaway_finished_".WIZARD_SITE_ID;
$iblockType = "projects"; 
...
if(COption::GetOptionString("redsign.flyaway", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "flyaway_perspective_".WIZARD_SITE_ID;
		$iblockType = "projects";
		...
		if ($arIBlock = $rsIBlock->Fetch())
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/projects/index.php', array('IBLOCK_ID_projects_perspective' => $iblockID));
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.'/projects/perspective/index.php', array('IBLOCK_ID_projects_perspective' => $iblockID));
		}
	}
	return;
}

$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH.'/xml/ru/projects/perspective.xml'; 
$iblockCode = "flyaway_perspective_".WIZARD_SITE_ID;
$iblockType = "projects"; 
