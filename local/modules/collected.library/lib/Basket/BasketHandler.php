...
namespace Collected\Basket;

use \Collected\Common\Helper;
use \Collected\Forms\Form,
    \Collected\IBlock\Element;


/**
 * Class BasketHandler
 * @package Collected\Basket
 */
class BasketHandler extends \Collected\Base\StaticInstance
{
