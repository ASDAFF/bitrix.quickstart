...
$MESS['RS.FLYAWAY.REVIEWS'] = "Отзывы";
$MESS['RS.FLYAWAY.ADD_REVIEW'] = "Оставить отзыв";
...
$MESS['POST_MSG_ERROR_COMMENT'] = 'Вы должны написать хоть что-то. ';
$MESS['USER_LOGIN_ERROR'] = 'Вы не можете отправить комментарий без имени. ';

$MESS['POST_MSG_TEXT_PLUS'] = 'Достоинства: ';
$MESS['POST_MSG_TEXT_MINUS'] = 'Недостатки: ';
$MESS['POST_MSG_TEXT_COMMENT'] = 'Комментарий: ';
$MESS['TITLE_FORM'] = 'Оставить отзыв';
$MESS['MESSAGE_LOAD_MORE'] = 'Загрузить еще';
