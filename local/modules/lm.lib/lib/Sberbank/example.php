...
<? if (!empty($arResult["ORDER"])): ?>
    ...
    //ONLINE PAY (SBERBANK)
    $sberBank = new Lm\Sberbank\PayHandler(array(
        'username' => 'USERNAME-api', //username of api
        'password' => 'PASSWORD', //password of api
        'orderId' => $arResult["ORDER"]['ID'], //created order id
        'returnUrl' => \Lm\Common\Helper::getFullUrl($APPLICATION->GetCurPageParam()), //return url (this page by default)
    ...
    //\Lm\Seo\ECommerce::get()->setIblockId(2)->load($arResult['ORDER']['ID'])->setViewContent();
