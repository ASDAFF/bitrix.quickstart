...
*/
if (!in_array($wizrdTemplateId, array("al")))
	$wizrdTemplateId = "al";
...
{
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/monop/img/logo.png", WIZARD_SITE_PATH."include/logo.png");
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/monop/img/logo_retina.png", WIZARD_SITE_PATH."include/logo_retina.png");
	___writeToAreasFile(
		WIZARD_SITE_PATH."include/company_logo.php",
		'<div class="m"><div class="p m1"><div></div></div><div class="p m2"><div></div></div></div><img src="'.WIZARD_SITE_DIR.'include/logo.png" srcset="'.WIZARD_SITE_DIR.'include/logo_retina.png 2x">'
	);
}
