...
{		
	...
	$arItem["COMMENT"]["TEXT"] =  quick_number_ending($arItem["COMMENT"]["COUNT"], GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENT1"), GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENT2"), GetMessage("QUICK_BUSINESSCARD_ARTICLES_COMMENT3"));
}
