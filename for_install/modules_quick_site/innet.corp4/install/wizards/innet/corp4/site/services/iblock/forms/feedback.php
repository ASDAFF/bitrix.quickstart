...
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('INNET_IBLOCK_ID_FEEDBACK' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "contacts/index.php", array('INNET_IBLOCK_ID_FEEDBACK' => $iblockID));
?>