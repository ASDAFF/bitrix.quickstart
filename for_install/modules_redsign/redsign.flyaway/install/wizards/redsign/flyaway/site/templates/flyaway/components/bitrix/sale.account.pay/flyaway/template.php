...
else
{
	if ($arParams['REFRESHED_COMPONENT_MODE'] === 'Y')
	{
		...
		<div class="bx-sap" id="bx-sap<?=$wrapperId?>">
			<div class="container-fluid">
							...
							<div class="col-xs-12 sale-acountpay-block">
								...
								<div class="sale-acountpay-fixedpay-container">
									<div class="sale-acountpay-fixedpay-list">
										...
										{
											?>
											<div class="sale-acountpay-fixedpay-item btn btn2">
						...
						<div>
							<div class="sale-acountpay-pp row">
								<div class="col-md-7 col-sm-8 col-xs-12 ">
									...
									{
										?>
										<div class="sale-acountpay-pp-company col-lg-2 col-sm-3 col-xs-6 <?= ($key == 0) ? 'bx-selected' :""?>">
				...
				<div class="row">
					<div class="col-xs-12">
						<a href="" class="btn btn2 js-btn btn-lg sale-account-pay-button"><?=Loc::getMessage("SAP_BUTTON")?></a>
					</div>
				</div>
			</div>
		</div>
	...
	else
	{
		...
		<form method="post" name="buyMoney" action="">
			...
			?>
			<input type="submit" class="js-btn btn2" name="button" value="<?=GetMessage("SAP_BUTTON")?>">
		</form>
		<?
	}
}
