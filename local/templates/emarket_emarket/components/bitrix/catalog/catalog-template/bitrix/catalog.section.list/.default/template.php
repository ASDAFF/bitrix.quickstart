...
} else {?><div class="<? echo $arCurView['CONT']; ?>"><h1 class="<? echo $arCurView['TITLE']; ?>"><?=GetMessage("EMARKET_CATALOG")?></h1></div><?}
...
if (0 < $arResult["SECTIONS_COUNT"]) 
{
	...
	false
						...
						<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="bx_catalog_tile_show_all"><?=GetMessage("CT_BCSL_SHOW_ALL_TEXT")?></a>
					</div>
					<?}?>
				</li>
			<?
