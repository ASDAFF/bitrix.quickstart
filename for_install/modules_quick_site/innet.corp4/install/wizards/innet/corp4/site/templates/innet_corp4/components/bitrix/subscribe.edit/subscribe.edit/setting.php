...
<tr valign="top">
	<td width="40%">
		...
		<p><?echo GetMessage("subscr_rub")?><span class="starrequired">*</span><br /><br />
		<?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
			<input id="RUB_ID" type="checkbox" name="RUB_ID[]" value="<?=$itemValue["ID"]?>"<?if($itemValue["CHECKED"]) echo " checked"?> /><label for="RUB_ID"><?=$itemValue["NAME"]?></label><br /><br />
		<?endforeach;?></p>
		<p><?echo GetMessage("subscr_fmt")?><br /><br />
...
<tfoot><tr><td colspan="2">
	<input style="float: left; margin: 20px 20px 0 0;" type="submit" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
	<input style="float: left; margin: 20px 0 0 0;" type="reset" value="<?echo GetMessage("subscr_reset")?>" name="reset" />
</td></tr></tfoot>
</table>
