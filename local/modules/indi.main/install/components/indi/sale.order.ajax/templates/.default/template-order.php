	...
	<section class="order-group payment-systems">
		<article>
			...
			if ($arResult['PAY_FROM_ACCOUNT'] || $arResult['PAY_SYSTEMS']) {
				...
				<img class="paysystems-approved" src="<?=$templateFolder?>/kaluga.kuzov-auto.ru/images/paysystems-approved.png" alt=""/>
				<?
			} else {
										...
										<div class="col-sm-4 col-md-2">
											<a class="thumbnail" href="<?=$basketItem['DETAIL_PAGE_URL']?>">
												<?if ($basketItem['THUMB']) {
													...
													?><img src="<?=$templateFolder?>/kaluga.kuzov-auto.ru/images/no-photo.png"alt="X"/><?
												}?>
											</a>
										</div>
