...
<?if($arParams["RECOMENDATION_TYPE"]=='PERSONAL'):?>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"MESS_BTN_SUBSCRIBE" => GetMessage("CP_BC_TPL_DML_SUBSCRIBE"),
		...
		"COMPONENT_TEMPLATE" => "seller_whiout_h2",
		"SHOW_FROM_SECTION" => "N",
		"SECTION_ID" => "",
		"SECTION_CODE" => "",
		"SECTION_ELEMENT_ID" => "",
