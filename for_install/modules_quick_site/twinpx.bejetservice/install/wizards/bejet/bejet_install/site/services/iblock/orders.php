...
$arFields = Array(
	...
	'IN_RSS'=>'N',
	'SORT'=>100,
	"LANG" => array ("ru" => array ( "NAME" => GetMessage("SERVICE_IBLOCK_ORDERS")))
);

$obBlocktype = new CIBlockType;

if(!CIBlockType::GetByID($iblockType)->Fetch())
...
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/index.php", array("ORDERS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT']."/developer/send.php", array("ORDERS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index.php", array("ORDERS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."developer/send.php", array("ORDERS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."_index.php", array("ORDERS_IBLOCK_ID" => $iblockID));
?>
