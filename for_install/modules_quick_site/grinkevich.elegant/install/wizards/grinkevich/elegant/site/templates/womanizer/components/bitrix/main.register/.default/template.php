...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	{
		case "PASSWORD":
			?><input type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="input_text_style" />
...
<?
		...
		default:
			...
			?><input type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" class="input_text_style" /><?
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td align="right"><br /><br /><input type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" class="orange-but" /></td>
		</tr>
	</tfoot>
</table>
<p><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>
<p style="font-weight:bold;"><span class="starrequired">*</span> &mdash; <?=GetMessage("AUTH_REQ")?></p>
