...
if(!empty($arResult["DELIVERY"]))
{
	...
	<div class="order-item">
		...
		<table class="no_border" width="100%" cellpadding="6" cellspacing="0">
		<?
		foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery)
		{
			if ($delivery_id !== 0 && intval($delivery_id) <= 0)
			{
				foreach ($arDelivery["PROFILES"] as $profile_id => $arProfile)
				{
					?>
					<tr>
						<td style="width:5% !important;"  valign="top"><input type="radio" id="ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>" name="<?=$arProfile["FIELD_NAME"]?>" value="<?=$delivery_id.":".$profile_id;?>" <?=$arProfile["CHECKED"] == "Y" ? "checked=\"checked\"" : "";?> onclick="submitForm();" /></td>
						<td  style="width:95% !important;"  valign="top">
			...
			else
			{
				?>
				<tr>
					<td valign="top" style="width:5% !important;" >
					...
					<td valign="top" style="width:95% !important;" >
