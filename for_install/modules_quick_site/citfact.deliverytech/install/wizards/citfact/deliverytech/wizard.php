...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		{
			$arTemplates = array("getfood_orange", "getfood_blue", "getfood_red", "getfood_purple", "getfood_green");
	...
	function ShowStep()
	{
		...
		$wizard->SetDefaultVar("wizTemplateID", "getfood_orange");

		$arTemplateInfo = array(
			"getfood_orange" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_GETFOOD_ORANGE"),
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/preview_orange.jpg",
				"SCREENSHOT" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/screen_orange.jpg",
			),
			"getfood_blue" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_GETFOOD_BLUE"),
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/preview_blue.jpg",
				"SCREENSHOT" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/screen_blue.jpg",
			),
			"getfood_red" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_GETFOOD_RED"),
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/preview_red.jpg",
				"SCREENSHOT" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/screen_red.jpg",
			),
			"getfood_purple" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_GETFOOD_PURPLE"),
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/preview_purple.jpg",
				"SCREENSHOT" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/screen_purple.jpg",
			),	
			"getfood_green" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_GETFOOD_GREEN"),
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/preview_green.jpg",
				"SCREENSHOT" => $wizard->GetPath()."/images/".LANGUAGE_ID."/themes/screen_green.jpg",
			),		
		);
		...
		foreach ($arTemplateOrder as $templateID)
		{
			...
			$this->content .= '<div class="inst-template-description" style="height: auto; margin-bottom: 15px;">';
			...
			if ($arTemplate["SCREENSHOT"] && $arTemplate["PREVIEW"])
				$this->content .= CFile::Show2Images($arTemplate["PREVIEW"], $arTemplate["SCREENSHOT"], 50, 50, ' class="inst-template-list-img"');
			else
				$this->content .= CFile::ShowImage($arTemplate["SCREENSHOT"], 50, 50, ' class="inst-template-list-img"', "", true);
