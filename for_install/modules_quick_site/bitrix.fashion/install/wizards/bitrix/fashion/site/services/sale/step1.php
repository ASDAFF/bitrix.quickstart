...
paysystem
*/
if(COption::GetOptionString("bitrix.tyres", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$siteStamp = "/bitrix/templates/fashion_".WIZARD_THEME_ID."/images/pechat.gif";
	}
