...
$iblockCode = "bejetstore_articles_".WIZARD_SITE_ID;
$iblockType = "bj_articles"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/journal/index.php", array("ARTICLES_IBLOCK_ID" => $iblockID));
?>