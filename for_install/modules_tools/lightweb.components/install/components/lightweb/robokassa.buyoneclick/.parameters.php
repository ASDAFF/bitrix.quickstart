...
$resEventType = $EventType->GetByID("LW_ROBOKASSA_BUYONECLICK", LANGUAGE_ID);
$arEventType = $resEventType->Fetch();
if (empty($arEventType)){ 
	$EventType->Add(array(//при отсутствии добавляем
			"LID" => LANGUAGE_ID, 
			"EVENT_NAME" =>"LW_ROBOKASSA_BUYONECLICK",
			"NAME"=> GetMessage("RK_BOC_EVENT_TYPE_NAME"),
			"DESCRIPTION"=>
				"#ORDER_ID# - ".GetMessage("RK_BOC_ORDER_ID")."\n".
				"#ORDER_SUM# - ".GetMessage("RK_BOC_ORDER_SUM")."\n".
				"#ORDER_DATE# - ".GetMessage("RK_BOC_ORDER_DATE")."\n".
				"#ORDER_PASSWORD# - ".GetMessage("RK_BOC_ORDER_PASSWORD")."\n".
				"#PRODUCT_NAME# - ".GetMessage("RK_BOC_PRODUCT_NAME")."\n".
				"#PRODUCT_ID# - ".GetMessage("RK_BOC_PRODUCT_ID")."\n".
				"#PRODUCT_DESCRIPTION# - ".GetMessage("RK_BOC_PRODUCT_DESCRIPTION")."\n".
				
				"#CUSTOMER_NAME# - ".GetMessage("RK_BOC_NAME")."\n".
				"#CUSTOMER_PHONE# - ".GetMessage("RK_BOC_PHONE")."\n".
				"#CUSTOMER_EMAIL# - ".GetMessage("RK_BOC_EMAIL")."\n".
				"#CUSTOMER_MESSAGE# - ".GetMessage("RK_BOC_MESSAGE")."\n".
				
				"#EMAIL_ADMINISTRATOR# - ".GetMessage("RK_BOC_EMAIL_ADMINISTRATOR")."\n".
				
				"#DEFAULT_EMAIL_FROM# - ".GetMessage("RK_BOC_DEFAULT_EMAIL_FROM")."\n".
				"#SITE_NAME# - ".GetMessage("RK_BOC_SITE_NAME")."\n".
				"#SERVER_NAME# - ".GetMessage("RK_BOC_SERVER_NAME")
	));
} else {
	//Пробуем получить список шаблонов почтового события
	$EventMessage = new CEventMessage;
	$arFilter = array("TYPE_ID" => "LW_ROBOKASSA_BUYONECLICK", "ACTIVE" => "Y");
...
$arFields=Array("NAME" => GetMessage("RK_BOC_NAME"),
				"PHONE" => GetMessage("RK_BOC_PHONE"), 
				"EMAIL" => GetMessage("RK_BOC_EMAIL"), 
				"MESSAGE" => GetMessage("RK_BOC_MESSAGE"));
...
$arComponentParameters = array(
	"GROUPS" => array(
		"STORAGE" => array(
			"NAME" => GetMessage("RK_BOC_GROUP_STORAGE_OPTION"),
			"SORT"	=> "100"
		),
		
		"STORAGE_PRODUCTS" => array(
			"NAME" => GetMessage("RK_BOC_GROUP_STORAGE_PRODUCTS_OPTION"),
			"SORT"	=> "150"
		),
		
		"STORAGE_ORDER" => array(
			"NAME" => GetMessage("RK_BOC_GROUP_STORAGE_ORDER_OPTION"),
			"SORT"	=> "200"
		),
		"ORDERING" => array(
			"NAME" => GetMessage("RK_BOC_GROUP_ORDERING_OPTION"),
			"SORT"	=> "300"
		),
		"NOTIFICATION" => array(
			"NAME" => GetMessage("RK_BOC_GROUP_NOTIFICATION_OPTION"),
			"SORT"	=> "400"
		),
		"SMS_RU" => array(
			"NAME" => GetMessage("RK_BOC_SMS_RU"),
			"SORT" => "500"
		),
	),
	...
	"PARAMETERS" => array(
		...
		"PAYMENT_TEST_MODE" => array(
			"PARENT" => "STORAGE",
			"NAME" => '* '.GetMessage("RK_BOC_PAYMENT_TEST_MODE"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "N",
			"VALUES" => array('Y'=>GetMessage("RK_BOC_STATE_ACTIVE"),'N'=>GetMessage("RK_BOC_STATE_DISABLED")),
			"DEFAULT" => "Y",
			"REFRESH" => "N",
			"SORT"=>"10"
		),
		...
		"PAYMENT_OPTIONS" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_PAYMENT_OPTIONS"), 
			"TYPE" => "CUSTOM",
			"PARENT" => "STORAGE",
			...
			'JS_DATA' => array(
				'LANG'=>array(
					'STORAGE_LOGIN'=>GetMessage("RK_BOC_STORAGE_LOGIN"),
					'PAYMENT_PASSWORD'=>GetMessage("RK_BOC_STORAGE_PAYMENT_PASSWORD"),
					'PAYMENT_PASSWORD_2'=>GetMessage("RK_BOC_STORAGE_PAYMENT_PASSWORD_2"),
					'HIDDEN'=>GetMessage("RK_BOC_HIDDEN"),
					'SAVE_BUTTON'=> GetMessage("RK_BOC_SAVE_BUTTON"),
					'SAVE_MESSAGE'=> (!empty($CLWOption->RK_BOC)?GetMessage("RK_BOC_SAVE_MESSAGE"):''),
					'ONSUCCESS'=>GetMessage("RK_BOC_ONSUCCESS"),
					'ONFAILURE'=>GetMessage("RK_BOC_ONFAILURE"),
				),
		...
		"IBLOCK_PRODUCTS_TYPE_ID" => array(
			...
			"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_PRODUCTS_IBLOCK_TYPE_ID"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "N",
		...
		"IBLOCK_TYPE_ID" => array(
			...
			"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_ORDER_IBLOCK_TYPE_ID"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "N",
			"VALUES" => $arIBlockTypeList,
			"REFRESH" => "Y",
		...
		"FORM_ID" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_FORM_ID"), 
			"TYPE" => "STRING",
			"DEFAULT" => time(), 
			"PARENT" => "ORDERING",
			"SORT"=>"10"
		...
		"FORM_NAME" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_FORM_NAME"),
			"TYPE" => "STRING",
			"DEFAULT" => 'Покупка прогноза',
			"PARENT" => "ORDERING",
			"SORT"=>"20"
		),
		"USED_FIELDS" => Array(
			"NAME" => GetMessage("RK_BOC_USED_FIELDS"), 
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => $arFields,
			"DEFAULT"=>"", 
		...
		"REQUIRED_FIELDS" => Array(
			"NAME" => GetMessage("RK_BOC_REQUIRED_FIELDS"), 
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => $arFields,
			"DEFAULT"=>"", 
		...
		"BUTTON_NAME" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_BUTTON_NAME"), 
			"TYPE" => "STRING",
			"DEFAULT" => GetMessage("RK_BOC_DEFAULT_BUTTON_NAME"), 
			"PARENT" => "ORDERING",
			"SORT"=>"50"
		),
		...
		"SMS_RU_STATE" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_SMS_RU_STATE"),
			"TYPE"=>"LIST",
			"MULTIPLE"=>"N",
			"VALUES" => array(
				"ACTIVE" => GetMessage("RK_BOC_STATE_ACTIVE"),
				"DISABLED" => GetMessage("RK_BOC_STATE_DISABLED"),
				"TESTING" => GetMessage("RK_BOC_SMS_RU_STATE_TESTING")
			),
			"DEFAULT"=>"DISABLED",
			"REFRESH" => "Y",
			"PARENT" => "SMS_RU",
		...
		"EMAIL_ADMINISTRATOR" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_EMAIL_ADMINISTRATOR"), 
			"TYPE" => "STRING",
		...
		"EVENT_TEMPLATES_ADMINISTRATOR" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_EMAIL_TEMPLATES_FOR_ADMINISTRATOR"), 
			"TYPE"=>"LIST", 
			"VALUES" => $arEvent,
			"DEFAULT"=>"", 
			"MULTIPLE"=>"Y", 
		...
		"EVENT_TEMPLATES_CUSTOMER" => Array(
			"NAME" => '* '.GetMessage("RK_BOC_EMAIL_TEMPLATES_FOR_CUSTOMER"), 
			"TYPE"=>"LIST", 
			"VALUES" => $arEvent,
			"DEFAULT"=>"", 
			"MULTIPLE"=>"Y", 
...
if ($arCurrentValues["IBLOCK_PRODUCTS_TYPE_ID"]){
	...
	$arComponentParameters["PARAMETERS"]["PRODUCTS_IBLOCK_ID"]=array(
		"PARENT" => "STORAGE_PRODUCTS",
		"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_PRODUCTS_IBLOCK_ID"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
...
if ($arCurrentValues["PRODUCTS_IBLOCK_ID"]){
	...
	$arComponentParameters["PARAMETERS"]["PRODUCTS_COST"]=array(
		"PARENT" => "STORAGE_PRODUCTS",
		"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_PRODUCTS_COST"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
	...
	$arComponentParameters["PARAMETERS"]["PRODUCTS_DESCRIPTION"]=array(
		"PARENT" => "STORAGE_PRODUCTS",
		"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_PRODUCTS_DESCRIPTION"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arProductPropertyList,
		"REFRESH" => "N",
...
if ($arCurrentValues["IBLOCK_TYPE_ID"]){
	...
	$arComponentParameters["PARAMETERS"]["IBLOCK_ID"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_ORDER_IBLOCK_ID"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
...
if ($arCurrentValues["IBLOCK_ID"]){
	...
	$arComponentParameters["PARAMETERS"]["PRODUCT_ID"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_ORDER_PRODUCT_ID"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
	...
	$arComponentParameters["PARAMETERS"]["ORDER_SUM"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_PROPERTY_ORDER_SUM"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
	...
	$arComponentParameters["PARAMETERS"]["PAID_PROP_NAME"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_PAID_PROP_NAME"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
	...
	$arComponentParameters["PARAMETERS"]["CUSTOMER_PROP_NAME"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_CUSTOMER_PROP_NAME"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
	...
	$arComponentParameters["PARAMETERS"]["CUSTOMER_PHONE_PROP_NAME"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_CUSTOMER_PHONE_PROP_NAME"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
	...
	$arComponentParameters["PARAMETERS"]["CUSTOMER_EMAIL_PROP_NAME"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_CUSTOMER_EMAIL_PROP_NAME"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
	...
	$arComponentParameters["PARAMETERS"]["CUSTOMER_MESSAGE_PROP_NAME"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_CUSTOMER_MESSAGE_PROP_NAME"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
	...
	$arComponentParameters["PARAMETERS"]["ORDER_PASSWORD_PROP_NAME"]=array(
		"PARENT" => "STORAGE_ORDER",
		"NAME" => '* '.GetMessage("RK_BOC_ORDER_PASSWORD_PROP_NAME"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "N",
		"VALUES" => $arPropertyList,
		"REFRESH" => "N",
...
if ($arCurrentValues["SMS_RU_STATE"] != 'DISABLED' and $arCurrentValues["SMS_RU_STATE"] != '') {
	...
	$arComponentParameters["PARAMETERS"]["SMS_RU_API_KEY"] = array(
		"NAME" => '* '.GetMessage("RK_BOC_SMS_RU_API_KEY"), 
		"TYPE" => "CUSTOM",
		"PARENT" => "SMS_RU",
		"JS_FILE" => $component_dir."/js/settings.js?v=".time(),
		...
		'JS_DATA' => array(
			'LANG'=>array(
				'HIDDEN'=>GetMessage("RK_BOC_HIDDEN"),
				'SAVE_BUTTON'=> GetMessage("RK_BOC_SAVE_BUTTON"),
				'SAVE_MESSAGE'=> (!empty($CLWOption->SMS_API_KEY)?GetMessage("RK_BOC_SAVE_MESSAGE"):''),
				'ONSUCCESS'=>GetMessage("RK_BOC_ONSUCCESS"),
				'ONFAILURE'=>GetMessage("RK_BOC_ONFAILURE"),
			),
			'EXECUTE_FILE'=>$component_dir."/save_option.php"
	...
	$arComponentParameters["PARAMETERS"]["SMS_RU_FROM"]=array(
		"NAME" => GetMessage("RK_BOC_SMS_RU_FROM"),
		"TYPE" => "STRING",
		"DEFAULT" => "LightWeb",
		"PARENT" => "SMS_RU",
		"SORT"=>"50",
	...
	$arComponentParameters["PARAMETERS"]["SMS_RU_ADMIN_NUMBER"]=array(
		"NAME" => GetMessage("RK_BOC_SMS_RU_ADMIN_NUMBER"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"PARENT" => "SMS_RU",
		"SORT"=>"60",
	...
	$arComponentParameters["PARAMETERS"]["SMS_RU_TEMPLATE_SUCCESS"]=array(
		"NAME" => GetMessage("RK_BOC_SMS_RU_TEMPLATE_SUCCESS"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("RK_BOC_SMS_RU_TEMPLATE_SUCCESS_DEFAULT"),
		"PARENT" => "SMS_RU",
		"SORT"=>"80",
	);
}
