...
<div class="row" id="blg-comment-<?=$arParams["ID"]?>">
<a name="comments"></a>
<?
		...
		//{
			...
			if($arResult["is_ajax_post"] != "Y" && $arResult["NEED_NAV"] == "Y")
			{
				...
				<?if(empty($arResult["CommentsResult"])){?>
					<div class="bj-no-comments">Нет ни одного отзыва.<br>Стань первым!</div>
				<?}else{?>
			...
			<?}?>
			<hr class="visible-xs">
			<div class="col-sm-6" id="form_comment_">
				<div id="form_c_del">
				...
				<div class="blog-comment-fields">
					...
					<div id="bxlhe_frame_LHEBlogCom" class="blog-comment-field blog-comment-field-title form-group">
						<div class="blog-comment-field">
						<div class="blog-comment-field-text"><label for="user_name"><?=GetMessage("COMMENT")?></label></div>
						<span><textarea name="comment" cols="10" rows="10" class="form-control" required></textarea></span>
						<div class="blog-clear-float"></div>
						</div>
					</div>
					...
					if(empty($arResult["User"]))
					{
						...
						<div class="blog-comment-field blog-comment-field-user">
							<div class="blog-comment-field blog-comment-field-author form-group"><div class="blog-comment-field-text"><label for="user_name"><?=GetMessage("B_B_MS_NAME")?></label><span class="blog-required-field">*</span></div><span><input class="form-control" maxlength="255" size="30" tabindex="3" type="text" name="user_name" id="user_name" value="<?=htmlspecialcharsEx($_SESSION["blog_user_name"])?>"></span></div>
							<div class="blog-comment-field-user-sep">&nbsp;</div>
							<div class="blog-comment-field blog-comment-field-email form-group"><div class="blog-comment-field-text"><label for="">E-mail</label></div><span><input class="form-control" maxlength="255" size="30" tabindex="4" type="text" name="user_email" id="user_email" value="<?=htmlspecialcharsEx($_SESSION["blog_user_email"])?>"></span></div>
							<div class="blog-clear-float"></div>
						</div>
						<?
					}
					...
					{
						?>
						<div class="blog-comment-field blog-comment-field-title form-group">
							<div class="blog-comment-field">
							<div class="blog-comment-field-text"><label for="user_name"><?=GetMessage("BPC_SUBJECT")?></label></div>
							<span><input class="form-control" size="70" type="text" name="subject" id="subject" value=""></span>
							<div class="blog-clear-float"></div>
							</div>
						</div>
						<?
					...
					{
						?>
						<div class="blog-comment-field blog-comment-field-captcha form-group">
							<div class="blog-comment-field-captcha-label">
								...
								<input class="form-control" type="text" size="30" name="captcha_word" id="captcha_word" value=""  tabindex="7">
								</div>
					...
					<div class="blog-comment-buttons">
						<input class="btn btn-default" tabindex="10" value="<?=GetMessage("B_B_MS_SEND")?>" type="submit" name="sub-post" id="post-button"<??> onclick="submitComment()"<??>>
					</div>
				</div>
