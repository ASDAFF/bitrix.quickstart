...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/students_questions.xml"; 
$iblockCode = "students_questions_".WIZARD_SITE_ID; 
$iblockCodeOriginal = "students_questions"; 
$iblockType = "services"; 
...
if($iblockID == false)
{
    ...
    if ($iblockID < 1) {
        print 'Error on create iblock "students_questions"';
        return;
    }
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/students/question/index.php", array("STUDENTS_QUESTIONS_IBLOCK_ID" => $iblockID));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/students/question/index.php", array("PROPERTY_CODES" => var_export($arrProperties, true)));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/students/question/index.php", array("PROPERTY_CODES_REQUIRED" => var_export($arrPropertiesRequired, true)));
?>
