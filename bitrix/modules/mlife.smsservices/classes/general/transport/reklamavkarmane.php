...
class CMlifeSmsTransport{
	...
	private function getConfig() {
		...
		$c = new stdClass();
		$c->login = explode(':',COption::GetOptionString("mlife.smsservices","login"));
		$c->passw = COption::GetOptionString("mlife.smsservices","passw");
		$c->sender = COption::GetOptionString("mlife.smsservices","sender");
		$c->charset = COption::GetOptionString("mlife.smsservices","charset");
		
		return $c;
		
	}
	
	protected function _getAllSender() {
	...
	protected function _sendSms ($phones, $mess, $time=0, $sender=false) {
	...
	protected function _getStatusSms($smsid,$phone=false) {
