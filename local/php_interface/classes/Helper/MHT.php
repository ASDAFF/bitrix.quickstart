...
class MHT
{
    ...
    {
        $data = array();
        self::eachCatalogIBlock(function ($iblock) use (&$data) {
            $properties = array();
            \Helper\WP::properties(array(
                'sort' => array(
                    'NAME' => 'ASC'
                ),
                'filter' => array(
    ...
    static function searchHTML($class = '', $withHipHop = true)
    {
        ...
        <div class="search_block <?= $class ?>">
            <input type="text" value="" class="search_field" name="q" placeholder="поиск по сайту"><input type="submit"
                                                                                                          value=""
                                                                                                          class="search_submit">
        </div>
        <?
    ...
    static function searchHipHopHTML()
    {
        ...
        <div class="hihop_search_block">
            <div class="wrapper">
                ...
                <div class="logo-in-search"><img src="<?= SITE_TEMPLATE_PATH ?>/images/logotype-black@2x.png"
                                                 alt="МОСХОЗТОРГ" width="195" height="50"/></div>
                <div class="field">
                    <? $APPLICATION->IncludeComponent(
                        "bitrix:search.title",
                        "mht",
                        ...
                        <div class="products">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <div class="price"><span class="js-price"></span> <span
                                                class="rub"><span>рублей</span></span></div>
                                </div>
    ...
    {
        \Bitrix\Main\Loader::IncludeModule("askaron.ibvote");
        global $USER;
        $time = 86400;
    ...
    static function vote($data)
    {
        ...
        $arParams = array(
            'SESSION_CHECK' => 'N',
            'COOKIE_CHECK' => 'Y',
            'IBLOCK_ID' => \Helper\WP::iblockByElement($ELEMENT_ID),
    ...
    public function getBasketItemsAmount($russian = false)
    {
        ...
        return $n . ' товар' . \Helper\WP::russianCountName($n, 'ов', '', 'а');
