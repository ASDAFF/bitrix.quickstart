...
<?if((!empty($_SESSION["QUICK_THEME"][SITE_ID]["MENU_TOP_SLIDER"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["MENU_TOP_SLIDER"] : COption::GetOptionString("businesscard", "QUICK_THEME_MENU_TOP_SLIDER", "Y", SITE_ID)) == "Y"):?>
	<script>
	jQuery(function(){
...
<?endif?>
<?if((!empty($_SESSION["QUICK_THEME"][SITE_ID]["SLIDER"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["SLIDER"] : COption::GetOptionString("businesscard", "QUICK_THEME_SLIDER", "standart", SITE_ID)) == "standart"):?>
	<div class="banner <?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_BG"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_BG"] : COption::GetOptionString("businesscard", "QUICK_THEME_SLIDER_BG", "gray-bg", SITE_ID))?>">
		<div class="<?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_STANDART_BOXED"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_STANDART_BOXED"] : COption::GetOptionString("businesscard", "QUICK_THEME_SLIDER_STANDART_BOXED", "slideshow", SITE_ID))?>">
			<div class="slider-banner-container slider-load-box">
				<div class="<?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_SCROLLING"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_SCROLLING"] : COption::GetOptionString("businesscard", "QUICK_THEME_SLIDER_SCROLLING", "slider-banner", SITE_ID))?>">
...
<?endif?>
<?if((!empty($_SESSION["QUICK_THEME"][SITE_ID]["SLIDER"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["SLIDER"] : COption::GetOptionString("businesscard", "QUICK_THEME_SLIDER", "standart", SITE_ID)) == "boxed"):?>
	<div class="banner <?=(!empty($_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_BG"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["SLIDER_BG"] : COption::GetOptionString("businesscard", "QUICK_THEME_SLIDER_BG", "gray-bg", SITE_ID))?>">
...
<?endif?>
<?if((!empty($_SESSION["QUICK_THEME"][SITE_ID]["MENU_TOP_SLIDER"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["MENU_TOP_SLIDER"] : COption::GetOptionString("businesscard", "QUICK_THEME_MENU_TOP_SLIDER", "Y", SITE_ID)) == "N"):?>
	<script>
		jQuery(function(){
			var	headerTopHeight = $(".header-top").outerHeight(),
