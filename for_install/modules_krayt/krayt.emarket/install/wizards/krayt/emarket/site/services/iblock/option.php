...
$iblockXMLFile = $_SERVER["DOCUMENT_ROOT"].WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/krayt/content_option.xml"; 
$iblockCode = "content_option";
$iblockType = "content"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("OPTION_IBLOCK_ID" => $iblockID));
