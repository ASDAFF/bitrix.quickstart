...
if ($COLOR_ID)
{
	...
	$arColors = array(
		...
		"STRIPPED" => "references_files/iblock/bc1/bc151359b4a19f0806bf9c3460aac240.jpg",
	);
	$sort = 0;
...
if ($BRAND_ID)
{
	...
	$arBrands = array(
		...
		"BRAND1" => "brands_files/1c6/1c6fc5f1a9a6d70f125383acca7c0306.gif",
		"BRAND2" => "brands_files/7db/7db49ffff9521c536cadf92ccf0e6a5a.gif",
