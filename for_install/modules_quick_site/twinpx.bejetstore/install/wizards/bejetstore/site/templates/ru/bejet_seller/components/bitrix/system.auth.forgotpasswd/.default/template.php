...
?>
<div class="bx_forgotpassword_page bx-auth">
	<form name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<p><b><?=GetMessage("AUTH_OR")?></b></p>
		
		<div class="form-group">
			<label><?=GetMessage("AUTH_EMAIL")?></label>
			<input type="text" name="USER_EMAIL" maxlength="255" class="input_text_style form-control">
		</div>

		<hr>
		
		<div class="form-group">
			<input type="submit" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" class="big bt_blue btn btn-default">
		</div>
