...
__IncludeLang($_SERVER["DOCUMENT_ROOT"]."/local/components/novagr.shop/catalog.element/templates/.default/lang/ru/ajax.php");
...
if ($_REQUEST['ELEMENT_ID'] > 0 && $_REQUEST['AJAX_REFRESH'] == 1) {
    ...
    if ($res=$secRes->Fetch()){
        ...
        $smileArr2 = array(
            '<img src="/include/images/smiles/laugh.gif">',
            '<img src="/include/images/smiles/lol.gif" >',
            '<img src="/include/images/smiles/smile.gif">',
            '<img src="/include/images/smiles/wink.gif">',
            '<img src="/include/images/smiles/cool.gif">',
            '<img src="/include/images/smiles/normal.gif">',
            '<img src="/include/images/smiles/redface.gif">',
            '<img src="/include/images/smiles/sad.gif">',
            '<img src="/include/images/smiles/rolleyes.gif">',
        );
