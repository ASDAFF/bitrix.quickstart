...
<div class="block">
<?$APPLICATION->IncludeComponent("bitrix:search.tags.cloud", (!empty($_SESSION["QUICK_THEME"][SITE_ID]["TAGS_VER"]) ? $_SESSION["QUICK_THEME"][SITE_ID]["TAGS_VER"] : COption::GetOptionString("businesscard", "QUICK_THEME_TAGS_VER", "articles-ver-1", SITE_ID)),
	array(
		"SORT" => "CNT",
		"PAGE_ELEMENTS" => "150",
		"PERIOD" => "",
