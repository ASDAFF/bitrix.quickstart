...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/okshop/footer.php", array("NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/okshop/components/bitrix/catalog/catalog-template/section.php", array("NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/okshop/components/bitrix/catalog/catalog-template/sections.php", array("NEWS_IBLOCK_ID" => $iblockID));
?>