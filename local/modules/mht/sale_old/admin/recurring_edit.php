	...
	<tr class="adm-detail-required-field">
		...
		<td>
			<?if ($saleModulePermissions >= "W"):?>
				...
				<input name="PRODUCT_ID" value="<?= $str_PRODUCT_ID ?>" size="5" type="text">&nbsp;<input type="button" value="..." id="cat_prod_button" onClick="window.open('sale_product_search.php?lang=<? echo LANGUAGE_ID; ?>&func_name=FillProductFields&subscribe=Y', '', 'scrollbars=yes,resizable=yes,width=800,height=500,top='+Math.floor((screen.height - 500)/2-14)+',left='+Math.floor((screen.width - 800)/2-5));">
				<script type="text/javascript">
				ModuleChange();
				</script>
			<?else:?>
