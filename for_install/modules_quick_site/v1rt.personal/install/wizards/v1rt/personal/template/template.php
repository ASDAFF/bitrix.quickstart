<?php
class V1rtSiteWizardTemplate extends CWizardTemplate
{
	function GetLayout()
	{
		...
		{
            $logoImage = '<img src="'.$wizardPathCustom.'/images/ru/logo.png" alt="" />';
		}
		...
		{
            $boxImage = '<img src="'.$wizardPathCustom.'/images/ru/box.jpg" alt="" />';
		}
...
<html>
	<head>
		...
		<style type="text/css">
            ...
            .instal-bg {
            	background: url({$wizardPathCustom}/images/ru/bg.jpg) 0 0 repeat;
            	height: 100%;
            	left: 0;
            	top: 0;
            	position: fixed;
