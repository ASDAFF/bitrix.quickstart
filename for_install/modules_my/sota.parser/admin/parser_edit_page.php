...
<? endif; ?>
    ...
    <tr>
        ...
        <td><input type="text" name="SETTINGS[page][selector]" value="<? echo $sota_SETTINGS["page"]["selector"]; ?>"
    ...
    <tr>
        ...
        <td><input type="text" name="SETTINGS[page][href]" value="<? echo $sota_SETTINGS["page"]["href"]; ?>" size="40"
                   maxlength="250"></td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        ...
        <td><input type="text" name="SETTINGS[page][name]" value="<? echo $sota_SETTINGS["page"]["name"]; ?>" size="40"
                   maxlength="250"></td>
    </tr>
    <tr>
        <td></td>
...
<? /*?><tr>
    ...
    <tr>
        ...
        <td width="60%">
            <?= SelectBoxFromArray('SETTINGS[page][uniq]', $arrUniq, $sota_SETTINGS["page"]["uniq"]); ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" size="40" name="SETTINGS[page][sleep]"
                               value="<?= $sota_SETTINGS["page"]["sleep"] ?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" size="40" name="SETTINGS[page][proxy]"
                               value="<?= $sota_SETTINGS["page"]["proxy"] ?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
