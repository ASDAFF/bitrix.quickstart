...
<div class="catalog-detail bx_catalog_list_home">
	...
	?>
		<div class="item <?echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item');?>" id="<?=$strMainID?>">
			...
			<div class="popup">
				...
				<?if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) {?>
					...
					<?if(!empty($arItem['ADDWORK'])) {?>
						<div class="bx_catalog_item_controls_blockone">
							<div class="controls-wrap">
								<div class="compare-control">
									<input id="addwork_<?=$arItem['ID']?>" 
										class="mouting-control-input" 
										type="checkbox" 
										data-id="<?=$arItem['ADDWORK']['ID']?>">
										
									<label for="addwork_<?=$arItem['ID']?>"
										   <?=$arItem['ADDWORK']['NAME']?>>Купить с монтажем + 
										   <?=$arItem['ADDWORK']['PRICE']['DISCOUNT_PRICE']?>
										<?
										if (!empty($arItem['ADDWORK']['PRICE']))
										{
											switch($arItem['ADDWORK']['PRICE']['CURRENCY']) 
											{
												case 'RUB': 
													echo 'руб.'; break;
												default: 
													echo $arItem['ADDWORK']['PRICE']['CURRENCY']; break;
											}
										}
										?>
									</label>	
						...
						?>
								...
								<div class="controls-wrap">
									...
									<div class="compare-control">	
										<input id="compare_<?=$arItem['ID']?>" 
											...
											type="checkbox" 
											<?if(!empty($_SESSION[$arParams['COMPARE_NAME']][$arItem['IBLOCK_ID']]['ITEMS'][$arItem['ID']])) echo 'checked="checked"';?>
											data-id="<?=$arItem['ID']?>">
										<label for="compare_<?=$arItem['ID']?>"><?=GetMessage('CT_BCS_TPL_MESS_BTN_COMPARE')?></label>
										<div class="load"></div>
									</div>
								</div>
							...
							<div class="bx_catalog_item_controls_blocktwo">
								...
								<a href="#" 
									...
									rel="nofollow">
									<?=GetMessage('CT_BCS_TPL_MESS_BTN_BUY_1')?>
								</a>
							</div>
							<?
						}
				...
				<?} else { //OFFERS START?>
					...
					<?if ('Y' == $arParams['PRODUCT_DISPLAY_MODE']) {//CONTROL?>
					...
					<?}else{?>
						<div class="bx_catalog_item_controls no_touch">
							<a class="bx_medium_2" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
