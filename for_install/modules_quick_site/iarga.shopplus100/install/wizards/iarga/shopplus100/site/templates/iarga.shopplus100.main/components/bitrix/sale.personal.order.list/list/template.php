					...
					<div class="order-info">
						...
						<div class="order-status-info">
							...
							<div class="order-status-links">
								...
								<?if ($val["ORDER"]["STATUS_ID"] == "A" && $val["ORDER"]["PAYED"]!="Y"):?>
									<a href="/order/pay/?ORDER_ID=<?=$val["ORDER"]['ID']?>">Оплатить заказ</a>
								<?elseif($val["ORDER"]["PAYED"]=="Y"):?>
...
<?endif?>
<?if(sizeof($arResult['ORDERS']) < 1):?>
	<h1><?=GetMessage("STPOL_NO_ORDERS")?></h1>
<?endif;?>