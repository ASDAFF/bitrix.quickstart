...
?>
	<span class="modern-page-title" style="color:#4b423c; font-size:20px;"&#205;&#205;><?=GetMessage("pages")?></span>
<?
...
?>
		<div style="position:relative; display:inline;"><span class="<?=($bFirst ? "modern-page-first " : "")?>modern-page-current"><?=$arResult["nStartPage"]?></span><div class="currentpage"><span class="<?=($bFirst ? "modern-page-first " : "")?>modern-page-current" style="padding-left:7px;"><?=$arResult["nStartPage"]?></span></div></div>
<?
