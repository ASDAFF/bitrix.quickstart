...
$template_path = $_SERVER['DOCUMENT_ROOT'].'/bitrix/templates/'.$arTemplates[0]["TEMPLATE"];

$arReplace = array();

$arReplace["SITE_ID"] = WIZARD_SITE_DIR;
...
$arReplace["DFGCORP_FEEDBACK_FORM_CALL"] = $arMess["ID"];


$arFilter["TYPE_ID"] = "DFGCORP_FEEDBACK_FORM_FULL";
$rsMess = CEventMessage::GetList($by="site_id", $order="desc", $arFilter);
$arMess = $rsMess->GetNext();
$arReplace["DFGCORP_FEEDBACK_FORM_FULL"] = $arMess["ID"];

CWizardUtil::ReplaceMacros($template_path . '/header.php', $arReplace);
CWizardUtil::ReplaceMacros($template_path . '/footer.php', $arReplace);
?>
