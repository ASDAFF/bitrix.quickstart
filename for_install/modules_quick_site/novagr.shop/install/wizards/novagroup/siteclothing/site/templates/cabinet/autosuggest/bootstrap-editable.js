...
(function ($) {
    ...
    EditableForm.prototype = {
        ...
        initButtons: function() {
         ...
         // FIXXX
            if (this.options.buttonValue != undefined) {
            					
            	$.fn.editableform.buttons = $.fn.editableform.buttons.replace('Send', this.options.buttonValue);
...
(function ($) {
    ...
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-info editable-submit">Send</button>';    
    //error classes
