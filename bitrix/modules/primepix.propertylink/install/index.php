...
Class primepix_propertylink extends CModule {

	var $MODULE_ID = 'primepix.propertylink'; 
	var $MODULE_VERSION;
	...
	public function __construct() {
		...
		$this->PARTNER_NAME        = GetMessage('primepix.propertylink_PARTNER_NAME');
		$this->PARTNER_URI         = GetMessage('primepix.propertylink_PARTNER_URI');
	}
