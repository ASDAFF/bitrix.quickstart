			...
			<div class="adm-detail-content-item-block">
				<form action="<?= $APPLICATION->GetCurPage() ?>" method="POST">
					...
					<table class="adm-detail-content-table edit-table">
						<tbody>
						<tr>
							<td colspan="2"><?= Loc::getMessage('ADMITAD_TRACKING_MASTER_STEP2_INFO'); ?></td>
						</tr>
						<tr>
							<td colspan="2">
								<div id="result" style="padding-top:10px">
									<table id="result_table" width="100%" class="internal">
										<tbody>
										<tr class="heading">
											<td class="align-left" colspan="2"><?= Loc::getMessage('ADMITAD_TRACKING_MASTER_STEP2_TITLE'); ?></td>
										</tr>
										<tr id="">
											<td style="width: 40%;"><?= Loc::getMessage('ADMITAD_TRACKING_MASTER_STEP2_CLIENT_ID'); ?></td>
											<td><input size="100" type="text" name="client_id" id="client_id" value="<?= $arResult['CLIENT_ID'] ?>"></td>
										</tr>
										<tr id="">
											<td style="width: 40%;"><?= Loc::getMessage('ADMITAD_TRACKING_MASTER_STEP2_CLIENT_SECRET'); ?></td>
											<td><input size="100" type="text" name="client_secret" id="client_secret" value="<?= $arResult['CLIENT_SECRET'] ?>"></td>
										</tr>
										<tr id="">
											<td style="width: 40%;"><?= Loc::getMessage('ADMITAD_TRACKING_MASTER_STEP2_PARAM_NAME'); ?></td>
											<td><input size="100" type="text" name="param_name" id="param_name" value="<?= $arResult['PARAM_NAME'] ?>"></td>
										</tr>
										</tbody>
									</table>
								</div>
