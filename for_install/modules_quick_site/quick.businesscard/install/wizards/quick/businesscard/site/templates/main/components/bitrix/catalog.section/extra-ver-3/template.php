...
<?endif?>
					<div class="col-md-<?=$span?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">						
						<div class="box-style-1 transparent-bg margin-clear object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="<?=($k*200)?>">
							...
							<?if(!empty($arItem["PROPERTIES"]["SHOW_BUTTON"]["VALUE"])):?><a href="<?=$arItem["PROPERTIES"]["HREF"]["VALUE"]?>"><?=$arItem["PROPERTIES"]["TEXT_BUTTON"]["VALUE"]?></a><?endif?>
						</div>					
					</div>			
<?$cell++; $k++;
