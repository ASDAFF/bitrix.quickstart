...
*************************************************************************/
$strError = "";
if(array_key_exists($arParams["ACTION_VARIABLE"], $_REQUEST) && array_key_exists($arParams["PRODUCT_ID_VARIABLE"], $_REQUEST) && !$arParams['SECTION_ID'])
{
...
if($arParams["DISPLAY_COMPARE"]=="Y" && $APPLICATION->GetProperty("CATALOG_COMPARE_LIST", false) == false && !$arParams['SECTION_ID']):
