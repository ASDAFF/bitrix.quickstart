...
//$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/ru/".WIZARD_TEMPLATE_ID."/requests.xml"; 
$iblockXMLFile = WIZARD_ABSOLUTE_PATH."/site/services/iblock/xml/ru/".WIZARD_TEMPLATE_ID."/requests.xml"; 

//$iblockCode = "requests_".WIZARD_SITE_ID; 
$iblockCode = "credit_result"; 
$iblockCodeOriginal = "cars_result"; 
$iblockType = "credit_result"; 
